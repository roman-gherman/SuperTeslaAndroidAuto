...
public abstract class n implements StringValues {
    ...
    public final boolean contains(String name) {
        ...
        return ((List) this.f5183a.get(name)) != null;
    }

    @Override // io.ktor.util.StringValues
    public final Set entries() {
        Set setEntrySet = this.f5183a.entrySet();
    ...
    public final void forEach(Function2 body) {
        ...
        for (Map.Entry entry : this.f5183a.entrySet()) {
    ...
    public final String get(String name) {
        kotlin.jvm.internal.h.f(name, "name");
        List list = (List) this.f5183a.get(name);
        if (list != null) {
    ...
    public final List getAll(String name) {
        kotlin.jvm.internal.h.f(name, "name");
        return (List) this.f5183a.get(name);
    }
    ...
    public final Set names() {
        Set setKeySet = this.f5183a.keySet();
