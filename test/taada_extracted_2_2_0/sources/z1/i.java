...
public final class i implements Set, KMutableSet {
    ...
    public final boolean add(Object obj) {
        return this.f5178a.add(this.c.invoke(obj));
    }

    @Override // java.util.Set, java.util.Collection
    public final boolean addAll(Collection elements) {
        kotlin.jvm.internal.h.f(elements, "elements");
        return this.f5178a.addAll(a(elements));
    }
    ...
    public final boolean contains(Object obj) {
        return this.f5178a.contains(this.c.invoke(obj));
    }

    @Override // java.util.Set, java.util.Collection
    public final boolean containsAll(Collection elements) {
        kotlin.jvm.internal.h.f(elements, "elements");
        return this.f5178a.containsAll(a(elements));
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ArrayList arrayListB = b(this.f5178a);
    ...
    public final boolean remove(Object obj) {
        return this.f5178a.remove(this.c.invoke(obj));
    }

    @Override // java.util.Set, java.util.Collection
    public final boolean removeAll(Collection elements) {
        kotlin.jvm.internal.h.f(elements, "elements");
        return this.f5178a.removeAll(a(elements));
    }

    @Override // java.util.Set, java.util.Collection
    public final boolean retainAll(Collection elements) {
        kotlin.jvm.internal.h.f(elements, "elements");
        return this.f5178a.retainAll(a(elements));
    }
