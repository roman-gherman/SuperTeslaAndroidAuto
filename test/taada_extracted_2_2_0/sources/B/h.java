...
public final class h implements OnCompleteListener, ClassDataFinder, NameResolver, AnnotationAndConstantLoader, Factory, OnApplyWindowInsetsListener, KeyManager, GLVEndomorphism, SelectClause0, NullabilityAnnotationStates {
    ...
    public C0738b c(C0108h proto, NameResolver nameResolver) {
        ...
        Map mapL = kotlin.collections.v.f3806a;
    ...
    public boolean d(P2.g gVar, AbstractC0162z abstractC0162z, C0105e c0105e) {
        ...
        if (i == 10) {
            ...
            if (classDescriptor != null) {
                ...
                if (!k2.i.b(classDescriptor, k2.o.f3735P)) {
                    return false;
                }
            }
            return true;
    ...
    public BigInteger[] decomposeScalar(BigInteger bigInteger) {
        ...
        BigInteger bigIntegerK2 = AbstractC0132a.k(bigInteger, c0491a.f3341f, i);
        return new BigInteger[]{bigInteger.subtract(bigIntegerK.multiply(c0491a.f3340a).add(bigIntegerK2.multiply(c0491a.c))), bigIntegerK.multiply(c0491a.b).add(bigIntegerK2.multiply(c0491a.d)).negate()};
    }
    ...
    */
    ...
    public X2.c findClassData(L2.b classId) {
        ...
        AbstractC0823e.a(((s2.e) kotlinJvmBinaryClassU).f4769a).equals(classId);
    ...
    public List loadCallableAnnotations(X2.r container, kotlin.reflect.jvm.internal.impl.protobuf.MessageLite proto, X2.a kind) {
        ...
        if (list == null) {
            list = kotlin.collections.u.f3805a;
        }
    ...
    public ClassDescriptor m(JavaClass javaClass) {
        ...
        if (outerClass != null) {
            ...
            ClassifierDescriptor contributedClassifier = unsubstitutedInnerClassesScope != null ? unsubstitutedInnerClassesScope.getContributedClassifier(javaClass.getName(), EnumC0851b.f4937h) : null;
    ...
    */
    ...
    public void q(int i, C0606g c0606g) {
        while (true) {
            ...
            if (entry == null || ((C0613n) entry.getKey()).f3872a >= i) {
                return;
            }
    ...
    public h(AbstractC0612m abstractC0612m) {
        this.f98a = 22;
        C0609j c0609j = abstractC0612m.f3871a;
        c0609j.getClass();
        Iterator it = ((D0) c0609j.f3869a.entrySet()).iterator();
        this.b = it;
        if (it.hasNext()) {
            this.c = (Map.Entry) it.next();
        }
