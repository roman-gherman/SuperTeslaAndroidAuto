...
public final class m extends kotlin.jvm.internal.i implements Function0 {
    ...
    public final Object invoke() {
        switch (this.f3723a) {
            case 0:
                return this.b.getPackage(p.f3766h).getMemberScope();
            case 1:
                return new C0656h(this.b);
            default:
                C0763B c0763b = this.b;
                v vVar = c0763b.f4533g;
                if (vVar == null) {
                ...
                while (it2.hasNext()) {
                    PackageFragmentProvider packageFragmentProvider = ((C0763B) it2.next()).f4534h;
