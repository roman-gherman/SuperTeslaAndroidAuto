...
public final class Opcodes {
    ...
    public static final int CONST_METHOD_HANDLE = 254;
    public static final int CONST_METHOD_TYPE = 255;
    ...
    public static final int INVOKE_CUSTOM = 252;
    public static final int INVOKE_CUSTOM_RANGE = 253;
    ...
    public static final int INVOKE_POLYMORPHIC = 250;
    public static final int INVOKE_POLYMORPHIC_RANGE = 251;
    ...
    public static boolean isValidShape(int i) {
        ...
        return i == -1 || (i3 = i & 255) == 0 || i3 == 255 || (i & MotionEventCompat.ACTION_POINTER_INDEX_MASK) == 0;
    }
}
