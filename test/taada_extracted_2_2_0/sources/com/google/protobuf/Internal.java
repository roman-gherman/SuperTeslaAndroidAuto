...
public final class Internal {
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public class EntryAdapter implements Map.Entry<K, V> {
            ...
            public V setValue(V v6) {
                RealValue value = this.realEntry.setValue((RealValue) MapAdapter.this.valueConverter.doBackward(v6));
                if (value == null) {
                    return null;
                }
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t6) {
            return (Converter<Integer, T>) new Converter<Integer, T>() { // from class: com.google.protobuf.Internal.MapAdapter.1
                ...
                public EnumLite doForward(Integer num) {
                    ...
                    return enumLiteFindValueByNumber == null ? t6 : enumLiteFindValueByNumber;
                }
            };
        }
        ...
        public V put(K k6, V v6) {
            RealValue realvaluePut = this.realMap.put(k6, this.valueConverter.doBackward(v6));
    ...
    public static <T extends MessageLite> T getDefaultInstance(Class<T> cls) {
        try {
            ...
            throw new RuntimeException(androidx.constraintlayout.core.motion.a.j(cls, "Failed to get default instance for "), e);
        }
    }

    public static int hashBoolean(boolean z6) {
        return z6 ? 1231 : 1237;
    }
    ...
    public static int partialHash(int i, byte[] bArr, int i3, int i4) {
    ...
    public static int hashCode(byte[] bArr, int i, int i3) {
        int iPartialHash = partialHash(i3, bArr, i, i3);
        if (iPartialHash == 0) {
            return 1;
        }
        return iPartialHash;
