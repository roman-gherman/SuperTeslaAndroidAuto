...
public final class DoubleValue extends GeneratedMessageV3 implements DoubleValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int serializedSize = this.unknownFields.getSerializedSize() + (d != 0.0d ? CodedOutputStream.computeDoubleSize(1, d) : 0);
    ...
    public int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((Internal.hashLong(Double.doubleToLongBits(getValue())) + ((((getDescriptor().hashCode() + 779) * 37) + 1) * 53)) * 29);
