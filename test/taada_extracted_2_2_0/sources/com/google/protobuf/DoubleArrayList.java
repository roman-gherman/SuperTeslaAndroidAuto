...
final class DoubleArrayList extends AbstractProtobufList<Double> implements Internal.DoubleList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public void addDouble(double d) {
        ...
        double[] dArr = this.array;
        if (i == dArr.length) {
            double[] dArr2 = new double[androidx.constraintlayout.core.motion.a.y(i, 3, 2, 1)];
    ...
    public void removeRange(int i, int i3) {
        ...
        double[] dArr = this.array;
        System.arraycopy(dArr, i3, dArr, i, this.size - i3);
        this.size -= i3 - i;
        ((AbstractList) this).modCount++;
    }
    ...
    private void addDouble(int i, double d) {
        ...
        if (i >= 0 && i <= (i3 = this.size)) {
            ...
            if (i3 < dArr.length) {
                ...
                double[] dArr2 = new double[androidx.constraintlayout.core.motion.a.y(i3, 3, 2, 1)];
                System.arraycopy(dArr, 0, dArr2, 0, i);
