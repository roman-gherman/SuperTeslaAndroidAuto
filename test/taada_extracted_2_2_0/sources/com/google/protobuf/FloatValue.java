...
public final class FloatValue extends GeneratedMessageV3 implements FloatValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        float f6 = this.value_;
        int serializedSize = this.unknownFields.getSerializedSize() + (f6 != 0.0f ? CodedOutputStream.computeFloatSize(1, f6) : 0);
    ...
    public int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((Float.floatToIntBits(getValue()) + ((((getDescriptor().hashCode() + 779) * 37) + 1) * 53)) * 29);
