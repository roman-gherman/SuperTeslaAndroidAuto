...
public final class Any extends GeneratedMessageV3 implements AnyOrBuilder {
    ...
    private static String getTypeUrl(String str, Descriptors.Descriptor descriptor) {
        if (str.endsWith("/")) {
            ...
            sbK.append(descriptor.getFullName());
            return sbK.toString();
        }
        StringBuilder sbL = b.l(str, "/");
        sbL.append(descriptor.getFullName());
        return sbL.toString();
    }
    ...
    public static <T extends Message> Any pack(T t6) {
        return newBuilder().setTypeUrl(getTypeUrl("type.googleapis.com", t6.getDescriptorForType())).setValue(t6.toByteString()).build();
    }
    ...
    public <T extends Message> T unpack(Class<T> cls) throws InvalidProtocolBufferException {
        if (this.cachedUnpackValue != null) {
            ...
            T t6 = (T) ((Message) Internal.getDefaultInstance(cls)).getParserForType().parseFrom(getValue());
            this.cachedUnpackValue = t6;
            return t6;
        }
    ...
    public static <T extends Message> Any pack(T t6, String str) {
        return newBuilder().setTypeUrl(getTypeUrl(str, t6.getDescriptorForType())).setValue(t6.toByteString()).build();
    }
