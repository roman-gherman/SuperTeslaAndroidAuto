    ...
    public static abstract class Builder<BuilderType extends Builder<BuilderType>> extends AbstractMessageLite.Builder implements Message.Builder {
        ...
        public BuilderType mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            ...
            while (true) {
                ...
                if (!MessageReflection.mergeFieldFrom(codedInputStream2, builderNewBuilder, extensionRegistryLite2, getDescriptorForType(), new MessageReflection.BuilderAdapter(this), tag)) {
                    break;
                }
        ...
        public BuilderType mergeFrom(byte[] bArr, int i, int i3) {
            return (BuilderType) super.mergeFrom(bArr, i, i3);
        }
        ...
        @Override // com.google.protobuf.AbstractMessageLite.Builder, com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public BuilderType mergeFrom(byte[] bArr, int i, int i3, ExtensionRegistryLite extensionRegistryLite) {
            return (BuilderType) super.mergeFrom(bArr, i, i3, extensionRegistryLite);
        }
