...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        public /* synthetic */ FieldType(String str, int i, JavaType javaType, int i3, AnonymousClass1 anonymousClass1) {
            this(str, i, javaType, i3);
        }
        ...
        private FieldType(String str, int i, JavaType javaType, int i3) {
    ...
    public static int makeTag(int i, int i3) {
        return (i << 3) | i3;
    }
