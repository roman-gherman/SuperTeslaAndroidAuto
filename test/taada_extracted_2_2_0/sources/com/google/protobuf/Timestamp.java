...
public final class Timestamp extends GeneratedMessageV3 implements TimestampOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        long j6 = this.seconds_;
        int iComputeInt64Size = j6 != 0 ? CodedOutputStream.computeInt64Size(1, j6) : 0;
        int i3 = this.nanos_;
        if (i3 != 0) {
    ...
    public int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((getNanos() + ((((Internal.hashLong(getSeconds()) + ((((getDescriptor().hashCode() + 779) * 37) + 1) * 53)) * 37) + 2) * 53)) * 29);
