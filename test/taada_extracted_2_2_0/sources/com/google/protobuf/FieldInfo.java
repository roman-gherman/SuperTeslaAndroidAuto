...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(java.lang.reflect.Field field, int i, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i3, boolean z6, boolean z7, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    private static void checkFieldNumber(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException(b.c(i, "fieldNumber must be positive: "));
        }
    }

    public static FieldInfo forField(java.lang.reflect.Field field, int i, FieldType fieldType, boolean z6) {
        checkFieldNumber(i);
        ...
        return new FieldInfo(field, i, fieldType, null, null, 0, false, z6, null, null, null, null, null);
    }
    ...
    public static FieldInfo forOneofMemberField(int i, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z6, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(oneofInfo, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i, fieldType, null, null, 0, false, z6, oneofInfo, cls, null, enumVerifier, null);
        }
    ...
    public static FieldInfo forProto2OptionalField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i3, boolean z6, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i3)) {
            return new FieldInfo(field, i, fieldType, null, field2, i3, false, z6, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException(b.c(i3, "presenceMask must have exactly one bit set: "));
    }

    public static FieldInfo forProto2RequiredField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i3, boolean z6, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i3)) {
            return new FieldInfo(field, i, fieldType, null, field2, i3, true, z6, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException(b.c(i3, "presenceMask must have exactly one bit set: "));
    }
