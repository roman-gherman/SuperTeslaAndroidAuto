...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public final void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        this.f2268a.add(new d(shapeAppearanceModel.e, shapeAppearanceModel.f4204h, shapeAppearanceModel.f4202f, shapeAppearanceModel.f4203g));
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (materialButton.getVisibility() != 8) {
                ...
                if (dVar2 == null) {
                    ...
                    iVarE.f4195f = new C0695a(0.0f);
                    iVarE.f4196g = new C0695a(0.0f);
                    iVarE.f4197h = new C0695a(0.0f);
                } else {
                    iVarE.e = dVar2.f2288a;
                    iVarE.f4197h = dVar2.d;
                    iVarE.f4195f = dVar2.b;
                    iVarE.f4196g = dVar2.c;
                }
