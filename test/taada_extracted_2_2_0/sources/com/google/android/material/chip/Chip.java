...
public class Chip extends AppCompatCheckBox implements ChipDrawable$Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        ...
        fVar.f3687k = typedArrayD.getDimension(1, fVar.f3687k);
        ...
        super.setOnCheckedChangeListener(new fr.sd.taada.activities.f(this, 2));
    }
    ...
    public final void c(int i) {
        ...
        if (iMax2 <= 0 && iMax <= 0) {
            ...
            if (insetDrawable2 == null) {
                int[] iArr3 = AbstractC0615a.f3957a;
                f();
                return;
            } else {
                if (insetDrawable2 != null) {
        ...
        if (this.b != null) {
            ...
            if (rect.top == i4 && rect.bottom == i4 && rect.left == i3 && rect.right == i3) {
                int[] iArr5 = AbstractC0615a.f3957a;
                f();
                return;
            }
        }
        ...
        int[] iArr6 = AbstractC0615a.f3957a;
        f();
    }
    ...
    public j getShapeAppearanceModel() {
        return this.f2329a.f4178a.f4166a;
    }
