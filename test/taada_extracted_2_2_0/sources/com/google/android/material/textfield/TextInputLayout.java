...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        ...
        if (dimension2 >= 0.0f) {
            iVarE.f4195f = new C0695a(dimension2);
        }
        if (dimension3 >= 0.0f) {
            iVarE.f4196g = new C0695a(dimension3);
        }
        if (dimension4 >= 0.0f) {
            iVarE.f4197h = new C0695a(dimension4);
        }
        this.J = iVarE.a();
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        n0.f fVar3 = new n0.f(fVar2.f4178a.f4166a);
        ...
        n0.f fVar4 = new n0.f(fVar2.f4178a.f4166a);
        fVar4.setTint(-1);
    ...
    */
    ...
    public final n0.f f(boolean z6) {
        ...
        if (eVar.f4168g == null) {
            eVar.f4168g = new Rect();
        }
        fVar.f4178a.f4168g.set(0, dimensionPixelOffset2, 0, dimensionPixelOffset2);
        fVar.invalidateSelf();
        return fVar;
    }
    ...
    public float getBoxCornerRadiusBottomEnd() {
        ...
        return zB ? this.J.f4204h.getCornerSize(rectF) : this.J.f4203g.getCornerSize(rectF);
    }

    public float getBoxCornerRadiusBottomStart() {
        boolean zB = com.google.android.material.internal.s.b(this);
        RectF rectF = this.f2608V;
        return zB ? this.J.f4203g.getCornerSize(rectF) : this.J.f4204h.getCornerSize(rectF);
    }

    public float getBoxCornerRadiusTopEnd() {
        boolean zB = com.google.android.material.internal.s.b(this);
        RectF rectF = this.f2608V;
        return zB ? this.J.e.getCornerSize(rectF) : this.J.f4202f.getCornerSize(rectF);
    }

    public float getBoxCornerRadiusTopStart() {
        boolean zB = com.google.android.material.internal.s.b(this);
        RectF rectF = this.f2608V;
        return zB ? this.J.f4202f.getCornerSize(rectF) : this.J.e.getCornerSize(rectF);
    }
    ...
    */
    ...
    public final void onRtlPropertiesChanged(int i) {
        ...
        if (z6 != this.f2600K) {
            ...
            float cornerSize3 = this.J.f4202f.getCornerSize(rectF);
            float cornerSize4 = this.J.f4204h.getCornerSize(rectF);
            float cornerSize5 = this.J.f4203g.getCornerSize(rectF);
            n0.j jVar = this.J;
            io.ktor.utils.io.jvm.javaio.q qVar = jVar.f4201a;
            ...
            jVar2.d = qVar4;
            jVar2.e = c0695a;
            jVar2.f4202f = c0695a2;
            jVar2.f4203g = c0695a4;
            jVar2.f4204h = c0695a3;
            jVar2.i = dVar;
            jVar2.f4205j = dVar2;
            jVar2.f4206k = dVar3;
            jVar2.f4207l = dVar4;
    ...
    */
    ...
    public void setBoxCornerFamily(int i) {
        ...
        n0.i.b(qVarF);
        iVarE.e = cornerSize;
        CornerSize cornerSize2 = this.J.f4202f;
        io.ktor.utils.io.jvm.javaio.q qVarF2 = k1.j.f(i);
        iVarE.b = qVarF2;
        n0.i.b(qVarF2);
        iVarE.f4195f = cornerSize2;
        CornerSize cornerSize3 = this.J.f4204h;
        io.ktor.utils.io.jvm.javaio.q qVarF3 = k1.j.f(i);
        iVarE.d = qVarF3;
        n0.i.b(qVarF3);
        iVarE.f4197h = cornerSize3;
        CornerSize cornerSize4 = this.J.f4203g;
        io.ktor.utils.io.jvm.javaio.q qVarF4 = k1.j.f(i);
        iVarE.c = qVarF4;
        n0.i.b(qVarF4);
        iVarE.f4196g = cornerSize4;
        this.J = iVarE.a();
        b();
    }
    ...
    public void setHintTextAppearance(int i) {
        ...
        ColorStateList colorStateList = fVar.f3686j;
        if (colorStateList != null) {
            bVar.f2480k = colorStateList;
        }
        float f6 = fVar.f3687k;
        if (f6 != 0.0f) {
            bVar.i = f6;
        }
        ColorStateList colorStateList2 = fVar.f3682a;
        if (colorStateList2 != null) {
            bVar.U = colorStateList2;
        }
        bVar.S = fVar.e;
        bVar.f2463T = fVar.f3683f;
        bVar.R = fVar.f3684g;
        bVar.f2464V = fVar.i;
        ...
        fVar.a();
        bVar.y = new C0571a(gVar, fVar.f3690n);
    ...
    public void setShapeAppearanceModel(n0.j jVar) {
        n0.f fVar = this.f2597D;
        if (fVar == null || fVar.f4178a.f4166a == jVar) {
            return;
        }
        this.J = jVar;
        b();
