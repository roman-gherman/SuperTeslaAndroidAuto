...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public ColorStateList getCardBackgroundColor() {
        return this.cardViewHelper.c.f4178a.c;
    }

    public ColorStateList getCardForegroundColor() {
        return this.cardViewHelper.d.f4178a.c;
    }
    ...
    public float getProgress() {
        return this.cardViewHelper.c.f4178a.i;
    }
    ...
    */
    ...
    public void setStrokeColor(ColorStateList colorStateList) {
        ...
        if (c0239c.f1734n != colorStateList) {
            ...
            f fVar = c0239c.d;
            fVar.f4178a.f4170j = c0239c.f1729h;
            fVar.invalidateSelf();
            e eVar = fVar.f4178a;
            if (eVar.d != colorStateList) {
                eVar.d = colorStateList;
