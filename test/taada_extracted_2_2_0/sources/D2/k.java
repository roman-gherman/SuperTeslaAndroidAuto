    ...
    public final Object invoke(Object obj) {
        ...
        switch (this.f256a) {
            ...
            case 1:
                ...
                HttpResponseValidator.f4065a.add(new C0641j(2, null));
                return mVar;
            case 2:
                CallableMemberDescriptor callableMemberDescriptor = (CallableMemberDescriptor) obj;
                if (callableMemberDescriptor.getKind() == EnumC0709a.f4227a) {
                    ...
                    if (C0652d.f4079j.containsKey(N2.f.g((ClassDescriptor) containingDeclaration))) {
                        z6 = true;
                    }
                }
