...
public final class J extends InputStream {
    ...
    public final ASN1BitStringParser a() throws IOException {
        ASN1Encodable aSN1EncodableL = this.f5034a.l();
        ...
        if (this.f5035f == null) {
            if (this.c) {
                ...
                if (aSN1BitStringParserA != null) {
                    this.c = false;
                    this.f5035f = aSN1BitStringParserA.getBitStream();
                }
            }
            return -1;
        }
        while (true) {
            int i = this.f5035f.read();
            if (i >= 0) {
                return i;
            }
            ...
            this.f5035f = aSN1BitStringParserA2.getBitStream();
        }
    }
    ...
    public final int read(byte[] bArr, int i, int i3) throws IOException {
        ...
        while (true) {
            int i5 = this.f5035f.read(bArr, i + i4, i3 - i4);
            if (i5 >= 0) {
                i4 += i5;
                if (i4 == i3) {
                    return i4;
