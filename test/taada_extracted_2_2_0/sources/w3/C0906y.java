...
public final class C0906y extends AbstractC0884b {
    ...
    public static byte[] p(AbstractC0884b[] abstractC0884bArr) {
        ...
        if (length == 1) {
            return abstractC0884bArr[0].f5047a;
        }
        int i = length - 1;
        int length2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            byte[] bArr = abstractC0884bArr[i3].f5047a;
            if (bArr[0] != 0) {
                throw new IllegalArgumentException("only the last nested bitstring can have padding");
            }
            length2 += bArr.length - 1;
        }
        byte[] bArr2 = abstractC0884bArr[i].f5047a;
        byte b = bArr2[0];
        byte[] bArr3 = new byte[length2 + bArr2.length];
        bArr3[0] = b;
        int i4 = 1;
        for (AbstractC0884b abstractC0884b : abstractC0884bArr) {
            byte[] bArr4 = abstractC0884b.f5047a;
    ...
    public final boolean d() {
        return this.e != null || this.f5047a.length > this.d;
    }
