...
public abstract class AbstractC0904w extends AbstractC0899q implements Iterable {
    ...
    public final boolean b(AbstractC0899q abstractC0899q) {
        if (abstractC0899q instanceof AbstractC0904w) {
            ...
            int length = this.f5076a.length;
            if (abstractC0904w.f5076a.length == length) {
                a0 a0Var = (a0) h();
                a0 a0Var2 = (a0) abstractC0904w.h();
                for (int i = 0; i < length; i++) {
                    AbstractC0899q aSN1Primitive = a0Var.f5076a[i].toASN1Primitive();
                    AbstractC0899q aSN1Primitive2 = a0Var2.f5076a[i].toASN1Primitive();
    ...
    public AbstractC0899q h() {
        int i;
        if (this.b == null) {
            ASN1Encodable[] aSN1EncodableArr = (ASN1Encodable[]) this.f5076a.clone();
            this.b = aSN1EncodableArr;
    ...
    public AbstractC0899q i() {
        k0 k0Var = new k0(this.f5076a, this.b);
        k0Var.d = -1;
        return k0Var;
    }
