...
public class C0898p {
    ...
    public final ByteArrayOutputStream f5069a;

    public C0898p() {
        this.f5069a = new ByteArrayOutputStream();
    }
    ...
    public void a(Encodable encodable) {
        try {
            this.f5069a.write(encodable.getEncoded());
        } catch (Exception e) {
    ...
    public X c() {
        return new X(this.f5069a);
    }

    public j0 d() {
        return new j0(this.f5069a);
    }

    public void h(int i) {
        ByteArrayOutputStream byteArrayOutputStream = this.f5069a;
    ...
    public C0898p(ByteArrayOutputStream byteArrayOutputStream) {
        this.f5069a = byteArrayOutputStream;
    }
}
