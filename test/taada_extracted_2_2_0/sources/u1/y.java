...
public final class y {
    ...
    public static final C0835D f4878k;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public C0832A f4879a;
    public String b;
    public int c;
    public boolean d;
    public String e;
    ...
    public y() {
        ...
        this.f4879a = protocol;
        this.b = "";
        this.c = 0;
        this.d = false;
        this.e = null;
        this.f4880f = null;
        Set set = AbstractC0837b.f4859a;
        ...
        this.f4881g = string;
        this.f4882h = new ArrayList(kotlin.collections.o.D(uVar));
        w wVarA = Z.a();
        k1.j.b(wVarA, hVar);
        this.i = wVarA;
        this.f4883j = new A2.B(wVarA);
    }

    public final void a() {
        if (this.b.length() <= 0 && !kotlin.jvm.internal.h.a(this.f4879a.f4846a, "file")) {
            C0835D c0835d = f4878k;
            this.b = c0835d.b;
            C0832A c0832a = this.f4879a;
            C0832A c0832a2 = C0832A.c;
            if (kotlin.jvm.internal.h.a(c0832a, C0832A.c)) {
                this.f4879a = c0835d.f4849a;
            }
            if (this.c == 0) {
                this.c = c0835d.c;
            }
    ...
    public final C0835D b() {
        ...
        Parameters parametersG = k1.j.g((w) this.f4883j.c);
        String strE = AbstractC0837b.e(this.f4881g, 0, 0, 15);
        String str2 = this.e;
