...
public final class C0832A {
    ...
    static {
        ...
        for (Object obj : listY) {
            linkedHashMap.put(((C0832A) obj).f4846a, obj);
        }
        d = linkedHashMap;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f4846a.equals(c0832a.f4846a) && this.b == c0832a.b;
    }

    public final int hashCode() {
        return Integer.hashCode(this.b) + (this.f4846a.hashCode() * 31);
    }

    public final String toString() {
        return "URLProtocol(name=" + this.f4846a + ", defaultPort=" + this.b + ')';
    }
}
