...
public final class f implements CoroutineScope, Closeable {
    ...
    public static final /* synthetic */ AtomicIntegerFieldUpdater f3293l = AtomicIntegerFieldUpdater.newUpdater(f.class, "closed");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final HttpClientEngine f3294a;
    ...
    public final C0793a f3295f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final q1.e f3296g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final C0793a f3297h;
    public final z1.f i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final v f3298j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final h f3299k;
    ...
    public f(HttpClientEngine engine, h hVar) {
        ...
        this.e = new q1.e(0, hVar.f3303g);
        this.f3295f = new C0793a(1, hVar.f3303g);
        q1.e eVar = new q1.e(1, hVar.f3303g);
        this.f3296g = eVar;
        this.f3297h = new C0793a(0, hVar.f3303g);
        this.i = new z1.f();
        engine.getConfig();
        this.f3298j = new v(5);
        h hVar2 = new h();
        ...
        eVar.f(q1.e.f4526p, new C0478b(this, continuation, i3));
        C0632a c0632a = G.f4038a;
        c cVar = c.d;
        hVar2.a(c0632a, cVar);
        hVar2.a(C0634c.f4050a, cVar);
        if (hVar.f3302f) {
            c block = c.b;
        ...
        if (hVar.e) {
            hVar2.a(D.f4035a, cVar);
        }
        hVar2.e = hVar.e;
        hVar2.f3302f = hVar.f3302f;
        hVar2.f3301a.putAll(hVar.f3301a);
        hVar2.b.putAll(hVar.b);
        hVar2.c.putAll(hVar.c);
        if (hVar.f3302f) {
            hVar2.a(C0631A.d, cVar);
        }
        z1.a aVar = AbstractC0642k.f4057a;
        k kVar = new k(hVar2, i);
        Logger logger = x.f4070a;
        hVar2.a(c0632a2, kVar);
        Iterator it = hVar2.f3301a.values().iterator();
        while (it.hasNext()) {
        ...
        this.f3295f.f(C0793a.f4683j, new d(this, continuation, i3));
        this.b = true;
    }
    ...
    */
    public final java.lang.Object a(q1.c r5, U1.c r6) {
        ...
        L2f:
            kotlin.reflect.l.e0(r6)
            z.e r6 = s1.AbstractC0809b.f4765a
            kotlin.reflect.jvm.internal.impl.protobuf.v r2 = r4.f3298j
            r2.d(r6)
    ...
    public final void close() throws IllegalAccessException, IOException, InvocationTargetException {
        if (f3293l.compareAndSet(this, 0, 1)) {
            Attributes attributes = (Attributes) this.i.get(y.f4071a);
