...
public final class s extends U1.c implements FlowCollector {
    ...
    public final FlowCollector f4669a;
    ...
    public s(FlowCollector flowCollector, CoroutineContext coroutineContext) {
        super(q.f4667a, S1.g.f1282a);
        this.f4669a = flowCollector;
        this.b = coroutineContext;
        this.c = ((Number) coroutineContext.fold(0, r.f4668a)).intValue();
    }
    ...
    public final Object a(Continuation continuation, Object obj) {
        ...
        if (coroutineContext != context) {
            if (coroutineContext instanceof o) {
                throw new IllegalStateException(kotlin.text.k.t("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + ((o) coroutineContext).f4666a + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
            }
        ...
        this.e = continuation;
        t tVar = u.f4671a;
        FlowCollector flowCollector = this.f4669a;
