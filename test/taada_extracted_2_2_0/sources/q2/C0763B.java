...
public final class C0763B extends AbstractC0777n implements ModuleDescriptor {
    ...
    public final PackageViewDescriptorFactory f4532f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public kotlin.reflect.jvm.internal.impl.protobuf.v f4533g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public PackageFragmentProvider f4534h;
    public final boolean i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final MemoizedFunctionToNotNull f4535j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final N1.j f4536k;
    ...
    public C0763B(L2.f moduleName, Z2.n nVar, k2.i iVar, int i) {
        ...
        this.f4532f = packageViewDescriptorFactory == null ? F.f4545a : packageViewDescriptorFactory;
        this.i = true;
        this.f4535j = nVar.createMemoizedFunction(new C0019a(this, 29));
        this.f4536k = AbstractC0132a.M(new k2.m(this, 2));
    }
    ...
    public final void f() {
        ...
        InvalidModuleNotifier invalidModuleNotifier = (InvalidModuleNotifier) getCapability(AbstractC0718j.f4247a);
    ...
    public final PackageViewDescriptor getPackage(L2.c fqName) {
        ...
        f();
        return (PackageViewDescriptor) this.f4535j.invoke(fqName);
    }
    ...
    public final Collection getSubPackagesOf(L2.c fqName, Function1 nameFilter) {
        ...
        f();
        f();
        return ((C0776m) this.f4536k.getValue()).getSubPackagesOf(fqName, nameFilter);
    }
    ...
    public final boolean shouldSeeInternalsOf(ModuleDescriptor targetModule) {
        ...
        kotlin.jvm.internal.h.c(this.f4533g);
        if (kotlin.collections.m.L(targetModule, kotlin.collections.w.f3807a)) {
            return true;
        }
