...
public final class z extends AbstractC0762A {
    ...
    public final AbstractC0762A f4649a;
    public final Z b;
    public Z c;
    public ArrayList d;
    public ArrayList e;
    ...
    public C0150m f4650f;

    public z(AbstractC0762A abstractC0762A, Z z6) {
        this.f4649a = abstractC0762A;
        this.b = z6;
    }
    ...
    */
    ...
    public final MemberScope a(W w5, b3.d dVar) {
        ...
        MemberScope memberScopeA = this.f4649a.a(w5, dVar);
        if (!this.b.f1542a.e()) {
    ...
    public final MemberScope b(b3.d dVar) {
        MemberScope memberScopeB = this.f4649a.b(dVar);
        if (!this.b.f1542a.e()) {
    ...
    public final Z d() {
        if (this.c == null) {
            ...
            if (z6.f1542a.e()) {
                ...
                List<TypeParameterDescriptor> parameters = this.f4649a.getTypeConstructor().getParameters();
    ...
    public final Annotations getAnnotations() {
        Annotations annotations = this.f4649a.getAnnotations();
        if (annotations != null) {
            return annotations;
        }
        c(19);
    ...
    public final ClassDescriptor getCompanionObjectDescriptor() {
        return this.f4649a.getCompanionObjectDescriptor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final Collection getConstructors() {
        Collection<ClassConstructorDescriptor> constructors = this.f4649a.getConstructors();
    ...
    public final DeclarationDescriptor getContainingDeclaration() {
        DeclarationDescriptor containingDeclaration = this.f4649a.getContainingDeclaration();
    ...
    public final EnumC0711c getKind() {
        EnumC0711c kind = this.f4649a.getKind();
        if (kind != null) {
            return kind;
        }
        c(25);
    ...
    public final EnumC0719k getModality() {
        EnumC0719k modality = this.f4649a.getModality();
        if (modality != null) {
            return modality;
        }
        c(26);
    ...
    public final ClassDescriptor getOriginal() {
        ClassDescriptor original = this.f4649a.getOriginal();
        if (original != null) {
            return original;
        }
        c(21);
    ...
    public final Collection getSealedSubclasses() {
        Collection<ClassDescriptor> sealedSubclasses = this.f4649a.getSealedSubclasses();
    ...
    public final MemberScope getStaticScope() {
        MemberScope staticScope = this.f4649a.getStaticScope();
        if (staticScope != null) {
            return staticScope;
        }
        c(15);
    ...
    public final TypeConstructor getTypeConstructor() {
        TypeConstructor typeConstructor = this.f4649a.getTypeConstructor();
        if (this.b.f1542a.e()) {
        ...
        if (this.f4650f == null) {
            ...
            this.f4650f = new C0150m(this, this.d, arrayList, Z2.n.e);
        }
        C0150m c0150m = this.f4650f;
        if (c0150m != null) {
            return c0150m;
        }
        c(1);
    ...
    public final MemberScope getUnsubstitutedInnerClassesScope() {
        MemberScope unsubstitutedInnerClassesScope = this.f4649a.getUnsubstitutedInnerClassesScope();
    ...
    public final MemberScope getUnsubstitutedMemberScope() {
        R2.e.i(N2.f.d(this.f4649a));
        return b(b3.c.f1699a);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final ClassConstructorDescriptor getUnsubstitutedPrimaryConstructor() {
        return this.f4649a.getUnsubstitutedPrimaryConstructor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final n2.z getValueClassRepresentation() {
        n2.z valueClassRepresentation = this.f4649a.getValueClassRepresentation();
        ...
        if (z6) {
            ...
            return new C0717i(c0717i.f4246a, f6);
        }
        if (!(valueClassRepresentation instanceof C0721m)) {
            throw new C0.x();
        }
        ArrayList<N1.e> arrayList = ((C0721m) valueClassRepresentation).f4250a;
    ...
    public final AbstractC0714f getVisibility() {
        AbstractC0714f visibility = this.f4649a.getVisibility();
        if (visibility != null) {
            return visibility;
        }
        c(27);
    ...
    public final boolean isActual() {
        return this.f4649a.isActual();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final boolean isCompanionObject() {
        return this.f4649a.isCompanionObject();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final boolean isData() {
        return this.f4649a.isData();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public final boolean isExpect() {
        return this.f4649a.isExpect();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public final boolean isExternal() {
        return this.f4649a.isExternal();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final boolean isFun() {
        return this.f4649a.isFun();
    }
    ...
    public final boolean isInner() {
        return this.f4649a.isInner();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final boolean isValue() {
        return this.f4649a.isValue();
    }
