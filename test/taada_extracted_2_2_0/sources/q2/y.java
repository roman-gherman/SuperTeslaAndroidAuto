...
public final class y extends AbstractC0777n implements PackageViewDescriptor {
    ...
    public static final /* synthetic */ KProperty[] f4646h;
    public final C0763B c;
    public final L2.c d;
    public final NotNullLazyValue e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final NotNullLazyValue f4647f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final U2.j f4648g;

    static {
        kotlin.jvm.internal.x xVar = kotlin.jvm.internal.w.f3818a;
        f4646h = new KProperty[]{xVar.f(new kotlin.jvm.internal.q(xVar.b(y.class), "fragments", "getFragments()Ljava/util/List;")), xVar.f(new kotlin.jvm.internal.q(xVar.b(y.class), "empty", "getEmpty()Z"))};
    }
    ...
    public y(C0763B c0763b, L2.c cVar, StorageManager storageManager) {
        ...
        this.f4647f = storageManager.createLazyValue(new x(this, 0));
        this.f4648g = new U2.j(storageManager, new x(this, 2));
    }
    ...
    public final List getFragments() {
        return (List) AbstractC0246d.T(this.e, f4646h[0]);
    }
    ...
    public final boolean isEmpty() {
        return ((Boolean) AbstractC0246d.T(this.f4647f, f4646h[1])).booleanValue();
    }
}
