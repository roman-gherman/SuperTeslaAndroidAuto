...
public final class m extends AbstractSet {
    ...
    public final boolean add(Object obj) {
        ...
        if (i == 0) {
            ...
            if (kotlin.jvm.internal.h.a(this.f3673a, obj)) {
                return false;
            }
            this.f3673a = new Object[]{this.f3673a, obj};
        } else if (i < 5) {
            Object obj3 = this.f3673a;
    ...
    public final boolean contains(Object obj) {
        ...
        if (i == 1) {
            return kotlin.jvm.internal.h.a(this.f3673a, obj);
        }
        if (i < 5) {
            Object obj2 = this.f3673a;
