...
public final class c extends p {
    ...
    public void afterChildren(Object obj) {
        switch (this.b) {
            case 0:
                ...
                h.f(current, "current");
                v vVar = (v) this.c;
                if (vVar.f3817a == null && ((Boolean) ((i) this.d).invoke(current)).booleanValue()) {
                    vVar.f3817a = current;
                    break;
                }
                break;
    ...
    public final boolean beforeChildren(Object obj) {
        switch (this.b) {
            ...
            default:
                ...
                v vVar = (v) this.c;
                if (zContains) {
                    vVar.f3817a = EnumC0658j.f4093a;
                } else if (C0663o.c.contains(strB0)) {
                    vVar.f3817a = EnumC0658j.b;
                } else if (C0663o.f4100a.contains(strB0)) {
                    vVar.f3817a = EnumC0658j.d;
                }
                return vVar.f3817a == null;
        }
    }
    ...
    public final Object result() {
        switch (this.b) {
            case 0:
                return (CallableMemberDescriptor) ((v) this.c).f3817a;
            case 1:
                return Boolean.valueOf(((boolean[]) this.d)[0]);
            default:
                EnumC0658j enumC0658j = (EnumC0658j) ((v) this.c).f3817a;
