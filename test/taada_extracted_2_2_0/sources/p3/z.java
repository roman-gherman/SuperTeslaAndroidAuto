...
public final class z extends AbstractC0785b implements MutableStateFlow, CancellableFlow, FusibleFlow {
    ...
    public static final AtomicReferenceFieldUpdater f4509f = AtomicReferenceFieldUpdater.newUpdater(z.class, Object.class, "_state");
    ...
    */
    ...
    public final boolean e(Object obj, Object obj2) {
        ...
        E1.h hVar;
        synchronized (this) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4509f;
            ...
            int i4 = i3 + 1;
            this.e = i4;
            AbstractC0787d[] abstractC0787dArr2 = this.f4652a;
            while (true) {
                ...
                if (c0758aArr != null) {
                    for (C0758A c0758a : c0758aArr) {
                        if (c0758a != null) {
                            while (true) {
                                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = C0758A.f4474a;
