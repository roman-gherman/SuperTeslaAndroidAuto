...
public final class c implements HttpMessageBuilder {
    ...
    public final y f4513a = new y();
    public r b = r.b;
    public final m c = new m();
    public Object d = C0810c.f4766a;
    public CompletableJob e = AbstractC0690y.b();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final z1.f f4514f = new z1.f();

    public final void a(F1.a aVar) {
        z1.f fVar = this.f4514f;
        if (aVar != null) {
            fVar.put(g.f4531a, aVar);
        } else {
            fVar.remove(g.f4531a);
        }
    }
    ...
    public final void b(c builder) {
        ...
        this.d = builder.d;
        z1.a aVar = g.f4531a;
        z1.f other = builder.f4514f;
        a((F1.a) other.getOrNull(aVar));
        y yVar = builder.f4513a;
        y yVar2 = this.f4513a;
        q.q(yVar2, yVar);
