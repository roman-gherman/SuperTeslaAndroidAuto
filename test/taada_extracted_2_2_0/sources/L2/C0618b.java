...
public final class C0618b extends AbstractC0139b {
    ...
    public final Collection a() {
        ...
        int iOrdinal = c0619c.f3966g.ordinal();
        if (iOrdinal == 0 || iOrdinal == 1) {
            listP = Z.p(C0619c.f3963l);
        } else {
            int i = c0619c.f3967h;
            if (iOrdinal == 2) {
                listP = n.y(C0619c.f3964m, new L2.b(p.f3768k, EnumC0621e.d.a(i)));
            } else {
                if (iOrdinal != 3) {
                    throw new x();
                }
                listP = n.y(C0619c.f3964m, new L2.b(p.e, EnumC0621e.e.a(i)));
            }
        }
        ModuleDescriptor containingDeclaration = c0619c.f3965f.getContainingDeclaration();
