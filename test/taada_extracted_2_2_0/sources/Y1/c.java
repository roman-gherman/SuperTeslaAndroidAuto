...
public final class c extends U1.g implements Function2 {
    ...
    public final /* synthetic */ ByteReadChannel f5131a;
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new c(this.f5131a, this.b, this.c, this.d, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        l.e0(obj);
        j jVar = io.ktor.utils.io.jvm.javaio.e.f3600a;
        ByteReadChannel byteReadChannel = this.f5131a;
        h.f(byteReadChannel, "<this>");
        return this.c.f5135a.c(new InputStreamReader(new i(null, byteReadChannel), this.b), new com.google.gson.reflect.a(this.d.b));
    }
}
