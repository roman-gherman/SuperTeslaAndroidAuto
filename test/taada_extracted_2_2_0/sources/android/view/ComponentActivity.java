...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
    ...
    public ComponentActivity() {
        ...
        this.mFullyDrawnReporter = new FullyDrawnReporter(reportFullyDrawnExecutorCreateFullyDrawnExecutor, new Function0() { // from class: androidx.activity.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f1566a.lambda$new$0();
            }
        });
        ...
        this.mActivityResultRegistry = new ActivityResultRegistry() { // from class: androidx.activity.ComponentActivity.2
            ...
            public <I, O> void onLaunch(final int i, ActivityResultContract<I, O> activityResultContract, I i3, ActivityOptionsCompat activityOptionsCompat) {
                Bundle bundle;
                final int i4;
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.2.2
                        @Override // java.lang.Runnable
                        public void run() {
                            dispatchResult(i4, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, sendIntentException));
                        }
                    });
                }
            }
    ...
    private void initViewTreeOwners() {
        C0198ViewTreeLifecycleOwner.set(getWindow().getDecorView(), this);
        C0199ViewTreeViewModelStoreOwner.set(getWindow().getDecorView(), this);
        C0218ViewTreeSavedStateRegistryOwner.set(getWindow().getDecorView(), this);
        C0166ViewTreeOnBackPressedDispatcherOwner.set(getWindow().getDecorView(), this);
        View.set(getWindow().getDecorView(), this);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ m lambda$new$0() {
        reportFullyDrawn();
        return null;
    }
    ...
    public void onActivityResult(int i, int i3, Intent intent) {
        if (this.mActivityResultRegistry.dispatchResult(i, i3, intent)) {
            return;
        }
    ...
    @Override // android.app.Activity
    @Deprecated
    public void startIntentSenderForResult(IntentSender intentSender, int i, Intent intent, int i3, int i4, int i5) throws IntentSender.SendIntentException {
