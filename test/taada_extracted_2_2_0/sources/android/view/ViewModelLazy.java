...
public final class ViewModelLazy<VM extends ViewModel> implements Lazy<VM> {
    ...
    public static final class AnonymousClass1 extends i implements Function0<CreationExtras.Empty> {
    ...
    public ViewModelLazy(KClass<VM> viewModelClass, Function0<? extends ViewModelStore> storeProducer, Function0<? extends ViewModelProvider.Factory> factoryProducer) {
        ...
        h.f(storeProducer, "storeProducer");
        h.f(factoryProducer, "factoryProducer");
    }
    ...
    public VM getValue() {
        ...
        VM vm2 = (VM) new ViewModelProvider(this.storeProducer.invoke(), this.factoryProducer.invoke(), this.extrasProducer.invoke()).get(k.H(this.viewModelClass));
        this.cached = vm2;
        return vm2;
    }

    public /* synthetic */ ViewModelLazy(KClass kClass, Function0 function0, Function0 function02, Function0 function03, int i, d dVar) {
