...
public final class LifecycleKt {
    public static final LifecycleCoroutineScope getCoroutineScope(Lifecycle lifecycle) {
        ...
        while (true) {
            ...
            d dVar = G.f4105a;
            LifecycleCoroutineScopeImpl lifecycleCoroutineScopeImpl2 = new LifecycleCoroutineScopeImpl(lifecycle, a.d(t0VarB, ((C0729d) o.f4719a).c));
    ...
    public static final Flow<Lifecycle.Event> getEventFlow(Lifecycle lifecycle) {
        ...
        d dVar = G.f4105a;
        return v.g(cVarC, ((C0729d) o.f4719a).c);
    }
}
