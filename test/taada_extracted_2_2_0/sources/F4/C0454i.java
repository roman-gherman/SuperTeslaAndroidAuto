...
public final class C0454i extends AbstractC0243a {
    public static final BigInteger i = C0455j.i;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final c4.i f3235h;

    static {
        new C0455j(ECConstants.ONE);
    }

    public C0454i() {
        super(i);
        this.f3235h = new c4.i(this, null, null, 1);
        this.b = new C0455j(ECConstants.ZERO);
        this.c = new C0455j(BigInteger.valueOf(3L));
        this.d = new BigInteger(1, h5.b.a("FFFFFFFFFFFFFFFFFFFFFFFE26F2FC170F69466A74DEFD8D"));
    ...
    public final AbstractC0246d k(SecureRandom secureRandom) {
        ...
        do {
            ...
            do {
                ...
                g5.c.r(bArr, iArr, 6);
            } while (E1.k.X(iArr, AbstractC0447b.d, 6) == 0);
            i3 = 0;
