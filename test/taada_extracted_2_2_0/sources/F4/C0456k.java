...
public final class C0456k extends AbstractC0243a {
    public static final BigInteger i = C0457l.i;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final c4.i f3237h;

    static {
        new C0457l(ECConstants.ONE);
    }

    public C0456k() {
        super(i);
        this.f3237h = new c4.i(this, null, null, 1);
        this.b = new C0457l(new BigInteger(1, h5.b.a("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.c = new C0457l(new BigInteger(1, h5.b.a("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
        this.d = new BigInteger(1, h5.b.a("FFFFFFFFFFFFFFFFFFFFFFFF99DEF836146BC9B1B4D22831"));
    ...
    public final AbstractC0246d k(SecureRandom secureRandom) {
        ...
        do {
            ...
            do {
                ...
                g5.c.r(bArr, iArr, 6);
            } while (E1.k.X(iArr, AbstractC0447b.e, 6) == 0);
            i3 = 0;
