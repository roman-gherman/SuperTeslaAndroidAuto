...
public final class C0458m extends AbstractC0243a {
    public static final BigInteger i = C0459n.i;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final c4.i f3239h;

    static {
        new C0459n(ECConstants.ONE);
    }

    public C0458m() {
        super(i);
        this.f3239h = new c4.i(this, null, null, 1);
        this.b = new C0459n(ECConstants.ZERO);
        this.c = new C0459n(BigInteger.valueOf(5L));
        this.d = new BigInteger(1, h5.b.a("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7"));
    ...
    public final AbstractC0246d k(SecureRandom secureRandom) {
        ...
        do {
            ...
            do {
                ...
                g5.c.r(bArr, iArr, 7);
            } while (E1.k.X(iArr, AbstractC0447b.f3223f, 7) == 0);
            i3 = 0;
