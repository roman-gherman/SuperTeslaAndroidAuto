...
public final class AttributionManager {
    ...
    public static final class Companion {
        ...
        public final void fetchAndDispatchAsync() {
            if (isInitialized()) {
                AbstractC0690y.g(V.f4115a, G.c, new AttributionManager$Companion$fetchAndDispatchAsync$1(null), 2);
            } else {
            ...
            synchronized (this) {
                try {
                    if (AttributionManager.instance == null) {
                        ...
                        AbstractC0690y.g(V.f4115a, G.c, new AttributionManager$Companion$initialize$1$1(tenjinAttributionService, null), 2);
                    }
                } catch (Throwable th) {
                    throw th;
                }
