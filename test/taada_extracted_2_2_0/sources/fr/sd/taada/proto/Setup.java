...
public final class Setup extends GeneratedMessageLite<Setup, Builder> implements SetupOrBuilder {
    ...
    /* JADX INFO: renamed from: fr.sd.taada.proto.Setup$1, reason: invalid class name */
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Setup, Builder> implements SetupOrBuilder {
        ...
        public Builder clearType() {
            copyOnWrite();
            ((Setup) this.instance).clearType();
            return this;
        }

        @Override // fr.sd.taada.proto.SetupOrBuilder
        public MediaCodecType getType() {
            return ((Setup) this.instance).getType();
        }

        @Override // fr.sd.taada.proto.SetupOrBuilder
        public boolean hasType() {
            return ((Setup) this.instance).hasType();
        }

        public Builder setType(MediaCodecType mediaCodecType) {
            copyOnWrite();
            ((Setup) this.instance).setType(mediaCodecType);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setType(MediaCodecType mediaCodecType) {
        mediaCodecType.getClass();
        this.bitField0_ |= 1;
        this.type_ = mediaCodecType.getNumber();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0001\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u0001\u0001Ԍ\u0000", new Object[]{"bitField0_", "type_", MediaCodecType.internalGetVerifier()});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    @Override // fr.sd.taada.proto.SetupOrBuilder
    public MediaCodecType getType() {
        MediaCodecType mediaCodecTypeForNumber = MediaCodecType.forNumber(this.type_);
