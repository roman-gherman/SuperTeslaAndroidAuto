...
public final class n extends s {
    ...
    public final void a(Matrix matrix, C0630a c0630a, int i, Canvas canvas) {
        p pVar = this.c;
        float f6 = pVar.f4217f;
        float f7 = pVar.f4218g;
        RectF rectF = new RectF(pVar.b, pVar.c, pVar.d, pVar.e);
        c0630a.getClass();
        boolean z6 = f7 < 0.0f;
        Path path = c0630a.f4025g;
        int[] iArr = C0630a.f4021k;
        if (z6) {
            iArr[0] = 0;
            iArr[1] = c0630a.f4024f;
            iArr[2] = c0630a.e;
            iArr[3] = c0630a.d;
        } else {
            path.rewind();
        ...
        if (!z6) {
            ...
            canvas.drawPath(path, c0630a.f4026h);
        }
