...
public final class l {
    ...
    public final Path f4210f = new Path();

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final t f4211g = new t();

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final float[] f4212h = new float[2];
    public final float[] i = new float[2];

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final Path f4213j = new Path();

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final Path f4214k = new Path();

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final boolean f4215l = true;
    ...
    public final void a(j jVar, float f6, RectF rectF, v vVar, Path path) {
        ...
        while (true) {
            ...
            CornerSize cornerSize = i4 != 1 ? i4 != 2 ? i4 != 3 ? jVar.f4202f : jVar.e : jVar.f4204h : jVar.f4203g;
            io.ktor.utils.io.jvm.javaio.q qVar = i4 != 1 ? i4 != 2 ? i4 != 3 ? jVar.b : jVar.f4201a : jVar.d : jVar.c;
            t tVar = tVarArr[i4];
            qVar.getClass();
        ...
        for (i = 4; i6 < i; i = 4) {
            ...
            (i6 != 1 ? i6 != 2 ? i6 != 3 ? jVar.f4205j : jVar.i : jVar.f4207l : jVar.f4206k).getClass();
            tVar7.c(fMax, 0.0f);
            Path path4 = this.f4213j;
            path4.reset();
            tVar7.b(matrixArr[i6], path4);
            if (this.f4215l && (b(path4, i6) || b(path4, i8))) {
    ...
    public final boolean b(Path path, int i) {
        ...
        path2.reset();
        this.f4209a[i].b(this.b[i], path2);
