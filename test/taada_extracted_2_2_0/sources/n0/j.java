...
public final class j {
    ...
    public io.ktor.utils.io.jvm.javaio.q f4201a = new h();
    ...
    public CornerSize f4202f = new C0695a(0.0f);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public CornerSize f4203g = new C0695a(0.0f);

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public CornerSize f4204h = new C0695a(0.0f);
    public d i = new d(0);

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public d f4205j = new d(0);

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public d f4206k = new d(0);

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public d f4207l = new d(0);
    ...
    public final boolean d(RectF rectF) {
        boolean z6 = this.f4207l.getClass().equals(d.class) && this.f4205j.getClass().equals(d.class) && this.i.getClass().equals(d.class) && this.f4206k.getClass().equals(d.class);
        float cornerSize = this.e.getCornerSize(rectF);
        return z6 && ((this.f4202f.getCornerSize(rectF) > cornerSize ? 1 : (this.f4202f.getCornerSize(rectF) == cornerSize ? 0 : -1)) == 0 && (this.f4204h.getCornerSize(rectF) > cornerSize ? 1 : (this.f4204h.getCornerSize(rectF) == cornerSize ? 0 : -1)) == 0 && (this.f4203g.getCornerSize(rectF) > cornerSize ? 1 : (this.f4203g.getCornerSize(rectF) == cornerSize ? 0 : -1)) == 0) && ((this.b instanceof h) && (this.f4201a instanceof h) && (this.c instanceof h) && (this.d instanceof h));
    }

    public final i e() {
        i iVar = new i();
        iVar.f4194a = this.f4201a;
        iVar.b = this.b;
        iVar.c = this.c;
        iVar.d = this.d;
        iVar.e = this.e;
        iVar.f4195f = this.f4202f;
        iVar.f4196g = this.f4203g;
        iVar.f4197h = this.f4204h;
        iVar.i = this.i;
        iVar.f4198j = this.f4205j;
        iVar.f4199k = this.f4206k;
        iVar.f4200l = this.f4207l;
        return iVar;
    }
}
