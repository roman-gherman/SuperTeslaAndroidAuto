...
public final class n extends AbstractC0893k {
    ...
    public n(int i, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        ...
        this.d = g5.c.c(bArr2);
        this.e = g5.c.c(bArr3);
        this.f4379f = g5.c.c(bArr4);
        this.f4381h = g5.c.c(bArr5);
        this.f4380g = -1;
    }
    ...
    public final AbstractC0899q toASN1Primitive() {
        ...
        z6.d = -1;
        c0886d.a(z6);
        c0886d.a(new H(true, 0, (ASN1Encodable) new W(this.f4381h), 1));
    ...
    public n(AbstractC0902u abstractC0902u) {
        ...
        this.c = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(1)).f5067a);
        this.d = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(2)).f5067a);
        this.e = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(3)).f5067a);
        this.f4379f = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(4)).f5067a);
        ...
        if (abstractC0902u.size() != 3) {
            ...
            this.f4381h = g5.c.c(((AbstractC0897o) AbstractC0897o.b.g(H.l(abstractC0902u.m(2)), true)).f5067a);
        }
    }
}
