...
public final class l extends AbstractC0893k {
    ...
    public l(long j6, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        ...
        this.d = g5.c.c(bArr);
        this.e = g5.c.c(bArr2);
        this.f4374f = g5.c.c(bArr3);
        this.f4375g = g5.c.c(bArr4);
        this.f4376h = g5.c.c(bArr5);
        this.c = -1L;
    }
    ...
    public final AbstractC0899q toASN1Primitive() {
        ...
        c0886d2.a(new W(this.f4374f));
        c0886d2.a(new W(this.f4375g));
        if (j6 >= 0) {
        ...
        z6.d = -1;
        c0886d.a(z6);
        c0886d.a(new H(true, 0, (ASN1Encodable) new W(this.f4376h), 1));
    ...
    public l(AbstractC0902u abstractC0902u) {
        ...
        this.d = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(1)).f5067a);
        this.e = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(2)).f5067a);
        this.f4374f = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(3)).f5067a);
        this.f4375g = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(4)).f5067a);
        ...
        if (abstractC0902u.size() != 3) {
            ...
            this.f4376h = g5.c.c(((AbstractC0897o) AbstractC0897o.b.g(H.l(abstractC0902u.m(2)), true)).f5067a);
        }
    }
}
