...
public final class h extends AbstractC0893k {
    ...
    public static h b(AbstractC0902u abstractC0902u) {
        ...
        hVar.b = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(1)).f5067a);
        hVar.c = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(2)).f5067a);
        if (abstractC0902uL.size() == 4) {
            ...
            if (aSN1EncodableM instanceof i) {
                ...
                iVar = new i();
                iVar.f4370a = g5.c.c(AbstractC0897o.j(abstractC0902uL2.m(0)).f5067a);
                iVar.b = g5.c.c(AbstractC0897o.j(abstractC0902uL2.m(1)).f5067a);
            }
            hVar.d = iVar;
        }
        return hVar;
    ...
    public final AbstractC0899q toASN1Primitive() {
        ...
        c0886d.a(new C0891i(this.f4369a));
        c0886d.a(new W(this.b));
        c0886d.a(new W(this.c));
        i iVar = this.d;
        if (iVar != null) {
            byte[] bArrC = g5.c.c(iVar.f4370a);
