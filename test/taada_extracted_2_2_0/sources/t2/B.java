...
public final class B extends A implements JavaMethod {
    ...
    public final JavaAnnotationArgument getAnnotationParameterDefaultValue() {
        Object defaultValue = this.f4794a.getDefaultValue();
    ...
    public final JavaType getReturnType() {
        Type genericReturnType = this.f4794a.getGenericReturnType();
    ...
    public final List getTypeParameters() {
        TypeVariable<Method>[] typeParameters = this.f4794a.getTypeParameters();
