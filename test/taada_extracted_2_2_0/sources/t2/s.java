...
public final class s extends w implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaClass {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof s) {
            return kotlin.jvm.internal.h.a(this.f4817a, ((s) obj).f4817a);
        }
        return false;
    }
    ...
    public final Collection getConstructors() {
        Constructor<?>[] declaredConstructors = this.f4817a.getDeclaredConstructors();
        kotlin.jvm.internal.h.e(declaredConstructors, "klass.declaredConstructors");
        return k3.m.F(k3.m.D(k3.m.x(kotlin.collections.j.u(declaredConstructors), k.f4809a), l.f4810a));
    }
    ...
    public final Collection getFields() {
        Field[] declaredFields = this.f4817a.getDeclaredFields();
        kotlin.jvm.internal.h.e(declaredFields, "klass.declaredFields");
        return k3.m.F(k3.m.D(k3.m.x(kotlin.collections.j.u(declaredFields), m.f4811a), n.f4812a));
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public final L2.c getFqName() {
        return AbstractC0823e.a(this.f4817a).b();
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public final Collection getInnerClassNames() {
        Class<?>[] declaredClasses = this.f4817a.getDeclaredClasses();
        kotlin.jvm.internal.h.e(declaredClasses, "klass.declaredClasses");
        return k3.m.F(k3.m.E(k3.m.x(kotlin.collections.j.u(declaredClasses), o.f4813a), p.f4814a));
    }
    ...
    public final Collection getMethods() {
        Method[] declaredMethods = this.f4817a.getDeclaredMethods();
        kotlin.jvm.internal.h.e(declaredMethods, "klass.declaredMethods");
        return k3.m.F(k3.m.D(k3.m.w(kotlin.collections.j.u(declaredMethods), new q(this, 0)), r.f4816a));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectJavaModifierListOwner
    public final int getModifiers() {
        return this.f4817a.getModifiers();
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaNamedElement
    public final L2.f getName() {
        return L2.f.e(this.f4817a.getSimpleName());
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public final JavaClass getOuterClass() {
        Class<?> declaringClass = this.f4817a.getDeclaringClass();
    ...
    public final List getTypeParameters() {
        TypeVariable[] typeParameters = this.f4817a.getTypeParameters();
    ...
    public final AbstractC0708K getVisibility() {
        int modifiers = this.f4817a.getModifiers();
    ...
    public final boolean isAbstract() {
        return Modifier.isAbstract(this.f4817a.getModifiers());
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public final boolean isAnnotationType() {
        return this.f4817a.isAnnotation();
    }
    ...
    public final boolean isEnum() {
        return this.f4817a.isEnum();
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaModifierListOwner
    public final boolean isFinal() {
        return Modifier.isFinal(this.f4817a.getModifiers());
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public final boolean isInterface() {
        return this.f4817a.isInterface();
    }
    ...
    public final boolean isStatic() {
        return Modifier.isStatic(this.f4817a.getModifiers());
    }
    ...
    public final List getAnnotations() {
        Annotation[] declaredAnnotations;
        Class cls = this.f4817a;
        return (cls == null || (declaredAnnotations = cls.getDeclaredAnnotations()) == null) ? kotlin.collections.u.f3805a : Z.l(declaredAnnotations);
    }
}
