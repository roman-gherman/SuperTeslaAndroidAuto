...
public abstract class AbstractC0718j {
    ...
    public static final C0720l f4247a = new C0720l("InvalidModuleNotifier");
    ...
    public static final List c(ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        ...
        w predicate = w.f4261a;
        kotlin.jvm.internal.h.f(sequenceDrop, "<this>");
        kotlin.jvm.internal.h.f(predicate, "predicate");
        List listF = k3.m.F(k3.m.z(k3.m.w(new k3.j(sequenceDrop, predicate), x.f4262a), y.f4263a));
        ...
        if (parameters == null) {
            parameters = kotlin.collections.u.f3805a;
        }
    ...
    */
    ...
    public static final ClassDescriptor f(ModuleDescriptor moduleDescriptor, L2.b classId, C0.t notFoundClasses) {
        ...
        return classDescriptorD != null ? classDescriptorD : notFoundClasses.g(classId, k3.m.F(k3.m.D(k3.m.B(classId, C0715g.f4244a), C0716h.f4245a)));
    }
    ...
    public static final ClassDescriptor j(C0763B c0763b, L2.c fqName) {
        ...
        EnumC0851b enumC0851b = EnumC0851b.f4934a;
