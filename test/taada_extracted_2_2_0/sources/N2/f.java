...
public abstract class f {
    ...
    public static boolean k(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor != null) {
            return n(declarationDescriptor, EnumC0711c.f4229a) && declarationDescriptor.getName().equals(L2.h.f964a);
        }
        a(34);
        throw null;
    }
    ...
    public static boolean l(DeclarationDescriptor declarationDescriptor) {
        return n(declarationDescriptor, EnumC0711c.f4230f) && ((ClassDescriptor) declarationDescriptor).isCompanionObject();
    }
    ...
    public static boolean o(DeclarationDescriptor declarationDescriptor) {
        ...
        while (declarationDescriptor != null) {
            if (k(declarationDescriptor) || ((declarationDescriptor instanceof DeclarationDescriptorWithVisibility) && ((DeclarationDescriptorWithVisibility) declarationDescriptor).getVisibility() == AbstractC0713e.f4234f)) {
                return true;
            }
            declarationDescriptor = declarationDescriptor.getContainingDeclaration();
        }
    ...
    public static boolean q(DeclarationDescriptor declarationDescriptor) {
        return (n(declarationDescriptor, EnumC0711c.f4229a) || n(declarationDescriptor, EnumC0711c.b)) && ((ClassDescriptor) declarationDescriptor).getModality() == EnumC0719k.b;
    }
