...
public abstract class q {
    ...
    public static L i(AbstractC0765b abstractC0765b) {
        ...
        List list = Collections.EMPTY_LIST;
        return lR.l(null, null, list, list, Collections.singletonList(s3), abstractC0765b.getDefaultType(), EnumC0719k.f4248a, AbstractC0713e.e);
    }
    ...
    public static L j(AbstractC0765b abstractC0765b) {
        ...
        Annotations.Companion.getClass();
        L lR = L.r(abstractC0765b, k2.p.f3763a, EnumC0709a.d, abstractC0765b.getSource());
        List list = Collections.EMPTY_LIST;
        return lR.l(null, null, list, list, list, R2.e.e(abstractC0765b).g(abstractC0765b.getDefaultType()), EnumC0719k.f4248a, AbstractC0713e.e);
    }
    ...
    public static J l(PropertyDescriptor propertyDescriptor, Annotations annotations, boolean z6, SourceElement sourceElement) {
        ...
        if (sourceElement != null) {
            return new J(propertyDescriptor, annotations, propertyDescriptor.getModality(), propertyDescriptor.getVisibility(), z6, false, false, EnumC0709a.f4227a, null, sourceElement);
        }
        a(19);
        throw null;
    }
    ...
    public static K m(PropertyDescriptor propertyDescriptor, Annotations annotations, Annotations annotations2, boolean z6, AbstractC0714f abstractC0714f, SourceElement sourceElement) {
        ...
        K k6 = new K(propertyDescriptor, annotations, propertyDescriptor.getModality(), abstractC0714f, z6, false, false, EnumC0709a.f4227a, null, sourceElement);
        k6.f4573m = K.h(k6, propertyDescriptor.getType(), annotations2);
        return k6;
    }
