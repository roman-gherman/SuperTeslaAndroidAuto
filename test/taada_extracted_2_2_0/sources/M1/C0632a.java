    ...
    public final void install(Object obj, g1.f scope) throws E1.c {
        ...
        switch (this.f4048a) {
            case 0:
                ...
                scope.f3297h.f(C0793a.i, new g1.d(i, continuation));
                return;
            case 1:
                C0639h plugin = (C0639h) obj;
                kotlin.jvm.internal.h.f(plugin, "plugin");
                kotlin.jvm.internal.h.f(scope, "scope");
                scope.e.f(q1.e.f4518g, new C0638g(plugin, null));
                return;
            case 2:
                v plugin2 = (v) obj;
                kotlin.jvm.internal.h.f(plugin2, "plugin");
                kotlin.jvm.internal.h.f(scope, "scope");
                scope.e.f(q1.e.f4518g, new C0478b(plugin2, continuation, i5));
                E1.h hVar3 = new E1.h("BeforeReceive", 0);
                C0793a c0793a = scope.f3295f;
                c0793a.getClass();
                E1.h reference2 = C0793a.f4683j;
                ...
                C0632a c0632a = L.b;
                ((L) y.a(scope)).f4043a.add(new C0478b(plugin2, continuation, i));
                return;
            case 3:
                C0631A plugin3 = (C0631A) obj;
                kotlin.jvm.internal.h.f(plugin3, "plugin");
                kotlin.jvm.internal.h.f(scope, "scope");
                scope.e.f(q1.e.f4520j, new z(plugin3, continuation, i4));
                scope.f3295f.f(C0793a.f4685l, new z(plugin3, continuation, i5));
                return;
            case 4:
                D plugin4 = (D) obj;
                ...
                kotlin.jvm.internal.h.f(scope, "scope");
                C0632a c0632a2 = L.b;
                ((L) y.a(scope)).f4043a.add(new j1.d(plugin4, scope, continuation, i5));
                return;
            case 5:
                kotlin.jvm.internal.h.f((G) obj, "plugin");
                kotlin.jvm.internal.h.f(scope, "scope");
                scope.e.f(q1.e.f4518g, new F(scope, null));
                return;
            default:
                L plugin5 = (L) obj;
                kotlin.jvm.internal.h.f(plugin5, "plugin");
                kotlin.jvm.internal.h.f(scope, "scope");
                scope.e.f(q1.e.f4521k, new j1.d(plugin5, scope, continuation, i3));
                return;
        }
    }
    ...
    public final Object prepare(Function1 block) {
        switch (this.f4048a) {
            ...
            case 2:
                ...
                s sVar = new s();
                block.invoke(sVar);
                return new v(kotlin.collections.m.e0(sVar.f4065a), kotlin.collections.m.e0(sVar.b), sVar.c);
            case 3:
                kotlin.jvm.internal.h.f(block, "block");
                B2.d dVar = new B2.d();
                block.invoke(dVar);
