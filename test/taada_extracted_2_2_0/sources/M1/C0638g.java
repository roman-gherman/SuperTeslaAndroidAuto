...
public final class C0638g extends U1.g implements Function3 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        E1.f fVar = this.f4053a;
        String string = ((q1.c) fVar.f289a).f4513a.toString();
        C0637f c0637f = new C0637f();
        q1.c cVar = (q1.c) fVar.f289a;
        u1.m mVar = cVar.c;
        u1.m mVar2 = c0637f.f4052a;
        io.ktor.utils.io.jvm.javaio.q.b(mVar2, mVar);
        this.b.f4054a.invoke(c0637f);
        C0835D c0835dB = c0637f.b.b();
        C0632a c0632a = C0639h.b;
        u1.y yVar = cVar.f4513a;
        boolean zA = kotlin.jvm.internal.h.a(yVar.f4879a, C0832A.c);
        C0832A c0832a = c0835dB.f4849a;
        if (zA) {
        ...
        if (yVar.b.length() <= 0) {
            ...
            io.ktor.utils.io.internal.t.o(yVar2, (String) c0835dB.f4853j.getValue());
            yVar2.e = (String) c0835dB.f4855l.getValue();
            yVar2.f4880f = (String) c0835dB.f4856m.getValue();
            u1.w wVarA = Z.a();
            wVarA.appendAll(b0.y((String) c0835dB.f4854k.getValue()));
            yVar2.i = wVarA;
            yVar2.f4883j = new A2.B(wVarA);
            String str2 = (String) c0835dB.f4857n.getValue();
            kotlin.jvm.internal.h.f(str2, "<set-?>");
            yVar2.f4881g = str2;
            yVar2.d = c0835dB.f4852h;
            C0832A c0832a2 = yVar.f4879a;
            kotlin.jvm.internal.h.f(c0832a2, "<set-?>");
            yVar2.f4879a = c0832a2;
            int i3 = yVar.c;
            if (i3 != 0) {
                yVar2.c = i3;
            }
            List list = yVar2.f4882h;
            List list2 = yVar.f4882h;
            if (!list2.isEmpty()) {
        ...
        for (z1.a aVar : fVar2.getAllKeys()) {
            if (!cVar.f4514f.contains(aVar)) {
                cVar.f4514f.put(aVar, fVar2.get(aVar));
            }
        }
        cVar.c.clear();
        cVar.c.appendAll(new u1.n((Map) mVar2.f4280a));
        Logger logger = AbstractC0640i.f4055a;
        StringBuilder sbM = B2.b.m("Applied DefaultRequest to ", string, ". New url: ");
        sbM.append(cVar.f4513a);
