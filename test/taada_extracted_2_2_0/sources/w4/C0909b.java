...
public final class C0909b extends j implements LMSContextBasedSigner {
    ...
    public final void c(int i) {
        ...
        int i5 = fVar.b;
        q qVar = new q(bArr, bArr2, io.ktor.utils.io.jvm.javaio.q.f(i5, fVar.f5085f));
        qVar.d = i3;
        qVar.e = -2;
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.b == c0909b.b && this.c == c0909b.c && this.f5080f == c0909b.f5080f && this.f5081g == c0909b.f5081g && this.d.equals(c0909b.d)) {
    ...
    public final i generateLMSContext() {
        ...
        synchronized (this) {
            try {
                ...
                iVarGenerateLMSContext.f5090g = oVarArr;
        ...
        iVarGenerateLMSContext2.f5090g = oVarArr;
    ...
    public final synchronized byte[] getEncoded() {
        ...
        try {
            ...
            c0898p.h((int) (j7 >>> 32));
            c0898p.h((int) j7);
            c0898p.f5069a.write(this.c ? 1 : 0);
