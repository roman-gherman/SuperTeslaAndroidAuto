...
public final class l extends j implements LMSContextBasedSigner {
    ...
    public static final k f5093l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final k[] f5094m;
    public final byte[] b;
    public final p c;
    public final f d;
    public final int e;
    ...
    public final WeakHashMap f5096g;
    ...
    public l(l lVar, int i, int i3) {
        ...
        this.f5097h = 1 << pVar.c;
        this.f5096g = lVar.f5096g;
        this.i = io.ktor.utils.io.jvm.javaio.q.f(pVar.b, pVar.d);
        this.f5099k = lVar.f5099k;
    }
    ...
    public final byte[] a(int i) {
        ...
        int i5 = i - i3;
        byte[] bArrC2 = g5.c.c(this.f5095f);
        f fVar = this.d;
    ...
    public final byte[] b(int i) {
        if (i < this.f5097h) {
            return c(i < 129 ? f5094m[i] : new k(i));
        }
        return a(i);
    }
    ...
    public final byte[] c(k kVar) {
        synchronized (this.f5096g) {
            try {
                byte[] bArr = (byte[]) this.f5096g.get(kVar);
                if (bArr != null) {
                    return bArr;
                }
                byte[] bArrA = a(kVar.f5092a);
                this.f5096g.put(kVar, bArrA);
                return bArrA;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final boolean equals(Object obj) {
        ...
        l lVar = (l) obj;
        if (this.f5098j != lVar.f5098j || this.e != lVar.e || !Arrays.equals(this.b, lVar.b)) {
            return false;
        }
        p pVar = lVar.c;
        p pVar2 = this.c;
        ...
        if (fVar2 == null ? fVar == null : fVar2.equals(fVar)) {
            return Arrays.equals(this.f5095f, lVar.f5095f);
        }
        return false;
    }
    ...
    public final m f() {
        ...
        synchronized (this) {
            try {
                if (this.f5099k == null) {
                    this.f5099k = new m(this.c, this.d, c(f5093l), this.b);
                }
                mVar = this.f5099k;
            } catch (Throwable th) {
                throw th;
    ...
    */
    public final w4.i generateLMSContext() {
        /*
            ...
            int r1 = r11.d()
            monitor-enter(r11)
            int r2 = r11.f5098j     // Catch: java.lang.Throwable -> L81
            ...
            byte[] r6 = r11.f5095f     // Catch: java.lang.Throwable -> L81
            r5.<init>(r3, r4, r2, r6)     // Catch: java.lang.Throwable -> L81
            monitor-enter(r11)     // Catch: java.lang.Throwable -> L81
            int r2 = r11.f5098j     // Catch: java.lang.Throwable -> L83
            r3 = 1
            int r2 = r2 + r3
            r11.f5098j = r2     // Catch: java.lang.Throwable -> L83
    ...
    public final byte[] getEncoded() {
        ...
        c0898p.h(this.d.f5084a);
        c0898p.b(this.b);
        c0898p.h(this.f5098j);
        c0898p.h(this.e);
        byte[] bArr = this.f5095f;
    ...
    public final int hashCode() {
        int iK = (g5.c.k(this.b) + (this.f5098j * 31)) * 31;
        p pVar = this.c;
        int iHashCode = (iK + (pVar != null ? pVar.hashCode() : 0)) * 31;
        f fVar = this.d;
        return g5.c.k(this.f5095f) + ((((iHashCode + (fVar != null ? fVar.hashCode() : 0)) * 31) + this.e) * 31);
    }
    ...
    public l(p pVar, f fVar, int i, byte[] bArr, int i3, byte[] bArr2) {
        ...
        this.b = g5.c.c(bArr);
        this.e = i3;
        this.f5095f = g5.c.c(bArr2);
        this.f5097h = 1 << (pVar.c + 1);
        this.f5096g = new WeakHashMap();
        this.i = io.ktor.utils.io.jvm.javaio.q.f(pVar.b, pVar.d);
    }
}
