...
public final class C0513p extends kotlin.jvm.internal.i implements Function0 {
    ...
    public final /* synthetic */ CallableMemberDescriptor f3426a;
    public final /* synthetic */ int b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0513p(CallableMemberDescriptor callableMemberDescriptor, int i) {
        super(0);
        this.f3426a = callableMemberDescriptor;
        this.b = i;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        ValueParameterDescriptor valueParameterDescriptor = this.f3426a.getValueParameters().get(this.b);
