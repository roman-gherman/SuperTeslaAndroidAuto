...
public abstract class v0 {
    ...
    public static final L2.b f3436a = L2.b.j(new L2.c("java.lang.Void"));
    ...
    public static s0 b(PropertyDescriptor possiblyOverriddenProperty) {
        ...
        if (original instanceof kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.n) {
            ...
            if (fVar != null) {
                return new C0509l(original, h3, fVar, nVar.f3923B, nVar.C);
            }
            ...
            return new C0508k(method, b != null ? b.f4794a : null);
        }
    ...
    public static s0 c(FunctionDescriptor possiblySubstitutedFunction) {
        ...
        if (original instanceof y2.e) {
            ...
            if (b != null && (method = b.f4794a) != null) {
        ...
        if (!(original instanceof C0931a)) {
            if ((original.getName().equals(k2.p.c) && N2.q.n(original)) || ((original.getName().equals(k2.p.f3763a) && N2.q.n(original)) || (kotlin.jvm.internal.h.a(original.getName(), C0649a.d) && original.getValueParameters().isEmpty()))) {
                return a(original);
            }
        ...
        if (javaElement2 instanceof t2.v) {
            return new C0503f(((t2.v) javaElement2).f4819a);
        }
        if (javaElement2 instanceof t2.s) {
            t2.s sVar = (t2.s) javaElement2;
            if (sVar.f4817a.isAnnotation()) {
                return new C0502e(sVar.f4817a);
            }
        }
