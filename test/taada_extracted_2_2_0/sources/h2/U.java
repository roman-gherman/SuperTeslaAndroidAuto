...
public final class U implements KParameter {
    ...
    public static final /* synthetic */ KProperty[] f3383f;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final AbstractC0514q f3384a;
    public final int b;
    ...
    static {
        ...
        f3383f = new KProperty[]{xVar.f(new kotlin.jvm.internal.q(xVar.b(U.class), "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/ParameterDescriptor;")), xVar.f(new kotlin.jvm.internal.q(xVar.b(U.class), "annotations", "getAnnotations()Ljava/util/List;"))};
    }
    ...
    public final boolean equals(Object obj) {
        ...
        U u = (U) obj;
        if (kotlin.jvm.internal.h.a(this.f3384a, u.f3384a)) {
            return this.b == u.b;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Integer.hashCode(this.b) + (this.f3384a.hashCode() * 31);
    }
    ...
    public final String toString() {
        ...
        sb.append(" of ");
        CallableMemberDescriptor callableMemberDescriptorE = this.f3384a.e();
