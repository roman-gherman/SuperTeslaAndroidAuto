...
public class t0 extends kotlin.jvm.internal.x {
    ...
    public final KDeclarationContainer c(Class jClass, String str) {
        B.h hVar = AbstractC0500c.f3399a;
    ...
    public final String g(FunctionBase functionBase) {
        ...
        if (metadata != null) {
            ...
            if (strArrD1 != null) {
                ...
                f6 = new F(C0501d.b, (SimpleFunctionDescriptor) x0.f(cls, c0125z, gVarG, new I2.f(b0Var), fVar, C0481c.f3304a));
            }
        }
        ...
        kotlin.collections.m.U(valueParameters, sb, ", ", "(", ")", C0499b.f3396l, 48);
        sb.append(" -> ");
    ...
    public final KType i(KClass kClass) {
        ...
        if (obj == null) {
            n0 n0VarC = AbstractC0246d.C(AbstractC0500c.a(jClass), arguments, false, kotlin.collections.u.f3805a);
