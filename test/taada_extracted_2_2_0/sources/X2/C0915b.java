...
public class C0915b implements AnnotationDescriptor, PossiblyExternalAnnotationDescriptor {
    ...
    public static final /* synthetic */ KProperty[] f5111f;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final L2.c f5112a;
    ...
    static {
        x xVar = w.f3818a;
        f5111f = new KProperty[]{xVar.f(new q(xVar.b(C0915b.class), "type", "getType()Lorg/jetbrains/kotlin/types/SimpleType;"))};
    }
    ...
    public C0915b(C0946f c, JavaAnnotation javaAnnotation, L2.c fqName) {
        ...
        if (javaAnnotation != null) {
            NO_SOURCE = c0941a.f5188j.source(javaAnnotation);
        } else {
            NO_SOURCE = SourceElement.NO_SOURCE;
            kotlin.jvm.internal.h.e(NO_SOURCE, "NO_SOURCE");
        }
        this.b = NO_SOURCE;
        this.c = c0941a.f5184a.createLazyValue(new y(14, c, this));
    ...
    public final AbstractC0162z getType() {
        return (F) AbstractC0246d.T(this.c, f5111f[0]);
    }
