...
public final class C0922i extends C0915b {
    ...
    public static final /* synthetic */ KProperty[] f5120h;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final NotNullLazyValue f5121g;

    static {
        x xVar = w.f3818a;
        f5120h = new KProperty[]{xVar.f(new q(xVar.b(C0922i.class), "allValueArguments", "getAllValueArguments()Ljava/util/Map;"))};
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0922i(JavaAnnotation annotation, C0946f c) {
        super(c, annotation, o.f3761w);
        kotlin.jvm.internal.h.f(annotation, "annotation");
        kotlin.jvm.internal.h.f(c, "c");
        this.f5121g = c.f5204a.f5184a.createLazyValue(new C0866A(this, 1));
    }
    ...
    public final Map getAllValueArguments() {
        return (Map) AbstractC0246d.T(this.f5121g, f5120h[0]);
    }
}
