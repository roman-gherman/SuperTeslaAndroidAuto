...
public class k implements Semaphore {
    ...
    public static final AtomicIntegerFieldUpdater f4951f = AtomicIntegerFieldUpdater.newUpdater(k.class, "_availablePermits");
    ...
    public final boolean a(Waiter waiter) {
        ...
        i iVar = i.f4949a;
        long j6 = andIncrement / ((long) l.f4954f);
        loop0: while (true) {
        ...
        int i = (int) (andIncrement % ((long) l.f4954f));
        ...
        while (!atomicReferenceArray.compareAndSet(i, null, waiter)) {
            if (atomicReferenceArray.get(i) != null) {
                ...
                if (z6) {
                    ((CancellableContinuation) waiter).resume(mVar3, this.f4952a);
                    return true;
                }
    ...
    */
    public final java.lang.Object acquire(kotlin.coroutines.Continuation r5) {
        /*
            r4 = this;
        L0:
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r0 = v3.k.f4951f
        ...
        L1c:
            ...
            if (r1 > r2) goto L1c
            if (r1 <= 0) goto L2a
            t2.q r0 = r4.f4952a     // Catch: java.lang.Throwable -> L31
    ...
    public final int getAvailablePermits() {
        return Math.max(f4951f.get(this), 0);
    }
    ...
    */
    ...
    public final boolean tryAcquire() {
        int i;
        while (true) {
            AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f4951f;
