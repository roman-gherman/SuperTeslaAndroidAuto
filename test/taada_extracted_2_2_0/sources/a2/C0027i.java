...
public final class C0027i extends AbstractC0139b {
    ...
    public C0027i(C0029k c0029k) {
        super(c0029k.f41j.f5204a.f5184a);
        this.e = c0029k;
        this.d = c0029k.f41j.f5204a.f5184a.createLazyValue(new C0026h(c0029k, 0));
    }
    ...
    */
    ...
    public final SupertypeLoopChecker d() {
        switch (this.c) {
            case 0:
                return ((C0029k) this.e).f41j.f5204a.f5191m;
            default:
                return n2.v.b;
        }
    }
    ...
    public C0027i(kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.g gVar) {
        super(gVar.f3900l.f1433a.f1418a);
        this.e = gVar;
        this.d = gVar.f3900l.f1433a.f1418a.createLazyValue(new kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.f(gVar, 0));
    }
}
