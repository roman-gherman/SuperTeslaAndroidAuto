    ...
    public final Object invoke() {
        switch (this.f33a) {
            ...
            default:
                ...
                ClassDescriptor classDescriptorB = C0653e.b(fqName, c0946f.f5204a.f5193o.d);
                if (classDescriptorB == null) {
                    JavaClass javaClassResolve = javaAnnotation.resolve();
                    C0941a c0941a = c0946f.f5204a;
                    classDescriptorB = javaClassResolve != null ? c0941a.f5189k.resolveClass(javaClassResolve) : null;
                    if (classDescriptorB == null) {
                        classDescriptorB = AbstractC0718j.f(c0941a.f5193o, L2.b.j(fqName), c0941a.d.c().f1424l);
                    }
                }
