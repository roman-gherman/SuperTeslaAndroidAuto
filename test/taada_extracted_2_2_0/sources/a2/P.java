...
public final class P extends AbstractC0766c {
    ...
    public P(C0946f c0946f, JavaTypeParameter javaTypeParameter, int i, DeclarationDescriptorNonRoot declarationDescriptorNonRoot) {
        ...
        super(c0941a.f5184a, declarationDescriptorNonRoot, new C0944d(c0946f, javaTypeParameter, false), javaTypeParameter.getName(), d0.INVARIANT, false, i, SourceElement.NO_SOURCE, c0941a.f5191m);
        this.f25k = c0946f;
    ...
    public final List g(List list) {
        ...
        D2.s sVar2 = c0946f.f5204a.f5195r;
        sVar2.getClass();
        ...
        while (it.hasNext()) {
            ...
            if (b0.d(abstractC0162zA, predicate, null)) {
                ...
                sVar = sVar2;
                abstractC0162zA = sVar.a(new D2.u(this, false, c0946f, EnumC0868b.TYPE_PARAMETER_BOUNDS, false), abstractC0162zA, kotlin.collections.u.f3805a, null, false);
    ...
    public final List i() {
        ...
        C0946f c0946f = this.f25k;
        if (zIsEmpty) {
            a3.F fE = c0946f.f5204a.f5193o.d.e();
            kotlin.jvm.internal.h.e(fE, "c.module.builtIns.anyType");
            return Z.p(a3.C.a(fE, c0946f.f5204a.f5193o.d.n()));
        }
