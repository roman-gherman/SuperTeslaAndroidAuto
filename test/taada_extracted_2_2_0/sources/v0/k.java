    ...
    public Serialization serializeKey(com.google.crypto.tink.b bVar, com.google.crypto.tink.n nVar) throws GeneralSecurityException {
        switch (this.f4913a) {
            case 1:
                ...
                iV.p();
                J.u((J) iV.b, c0379nC);
                return C0.r.a("type.googleapis.com/google.crypto.tink.AesGcmKey", ((J) iV.build()).toByteString(), EnumC0046d1.SYMMETRIC, l.a(iVar.f4911a.d), iVar.c);
            case 5:
                m mVar = (m) bVar;
                M mV = N.v();
                B.g gVar = mVar.b;
                ...
                mV.p();
                N.u((N) mV.b, c0379nC2);
                return C0.r.a("type.googleapis.com/google.crypto.tink.AesGcmSivKey", ((N) mV.build()).toByteString(), EnumC0046d1.SYMMETRIC, o.a(mVar.f4915a.b), mVar.c);
            case 9:
                p pVar = (p) bVar;
                G0.V v6 = W.v();
                B.g gVar2 = pVar.b;
                ...
                v6.p();
                W.u((W) v6.b, c0379nC3);
                return C0.r.a("type.googleapis.com/google.crypto.tink.ChaCha20Poly1305Key", ((W) v6.build()).toByteString(), EnumC0046d1.SYMMETRIC, r.a(pVar.f4918a.f4919a), pVar.c);
            default:
                t tVar = (t) bVar;
                L1 l1V = M1.v();
                B.g gVar3 = tVar.b;
                ...
                return C0.r.a("type.googleapis.com/google.crypto.tink.XChaCha20Poly1305Key", ((M1) l1V.build()).toByteString(), EnumC0046d1.SYMMETRIC, v.a(tVar.f4922a.f4923a), tVar.c);
        }
    }
