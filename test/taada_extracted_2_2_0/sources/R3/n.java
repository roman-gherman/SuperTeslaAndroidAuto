...
public final class n {
    ...
    public static final AtomicLongFieldUpdater f4716f = AtomicLongFieldUpdater.newUpdater(n.class, "_state");

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final E1.h f4717g = new E1.h("REMOVE_FROZEN", 9);
    ...
    public final int a(Runnable runnable) {
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = f4716f;
            ...
            if (!this.b && atomicReferenceArray.get(i3 & i4) != null) {
                ...
                while ((atomicLongFieldUpdater.get(nVarC) & 1152921504606846976L) != 0) {
                    ...
                    if ((obj instanceof m) && ((m) obj).f4715a == i3) {
    ...
    public final n c() {
        ...
        while (true) {
            ...
            n nVar3 = new n(nVar.f4718a * 2, nVar.b);
            int i = (int) (1073741823 & j6);
            int i3 = (int) ((1152921503533105152L & j6) >> 30);
            while (true) {
                int i4 = nVar.c;
    ...
    */
    public final java.lang.Object d() {
        /*
            ...
            r1 = r30
        L2:
            java.util.concurrent.atomic.AtomicLongFieldUpdater r0 = r3.n.f4716f
            long r2 = r0.get(r1)
