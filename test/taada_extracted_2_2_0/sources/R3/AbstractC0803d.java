...
public abstract class AbstractC0803d {
    ...
    public static final AtomicReferenceFieldUpdater f4704a = AtomicReferenceFieldUpdater.newUpdater(AbstractC0803d.class, Object.class, "_next");
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if (abstractC0803d != null) {
                f4704a.set(abstractC0803d, abstractC0803dB2);
            }
