...
public final class i extends AbstractC0684s implements Delay {
    ...
    public static final AtomicIntegerFieldUpdater f4711f = AtomicIntegerFieldUpdater.newUpdater(i.class, "runningWorkers");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final AbstractC0684s f4712a;
    public final int b;
    ...
    public i(AbstractC0684s abstractC0684s, int i) {
        this.f4712a = abstractC0684s;
        this.b = i;
        Delay delay = abstractC0684s instanceof Delay ? (Delay) abstractC0684s : null;
        this.c = delay == null ? AbstractC0664A.f4102a : delay;
        this.d = new l();
        this.e = new Object();
    }
    ...
    public final Runnable a() {
        while (true) {
            ...
            synchronized (this.e) {
                AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f4711f;
    ...
    public final void dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        Runnable runnableA;
        this.d.a(runnable);
        if (f4711f.get(this) >= this.b || !b() || (runnableA = a()) == null) {
            return;
        }
        this.f4712a.dispatch(this, new B.o(4, this, runnableA));
    }
    ...
    public final void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        this.f4712a.dispatchYield(this, new B.o(4, this, runnableA));
    }
