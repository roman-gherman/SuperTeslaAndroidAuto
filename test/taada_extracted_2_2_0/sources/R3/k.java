...
public class k {
    ...
    public static final AtomicReferenceFieldUpdater f4713a = AtomicReferenceFieldUpdater.newUpdater(k.class, Object.class, "_next");
    ...
    */
    public final r3.k a() {
        ...
        La:
            r4 = r2
        Lb:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = r3.k.f4713a
    ...
    public final k d() {
        ...
        if (rVar != null && (kVar = rVar.f4720a) != null) {
            return kVar;
        }
