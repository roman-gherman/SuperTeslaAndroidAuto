...
public class l {
    ...
    public static final AtomicReferenceFieldUpdater f4714a = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_cur");
    ...
    public final int c() {
        n nVar = (n) f4714a.get(this);
        nVar.getClass();
        long j6 = n.f4716f.get(nVar);
