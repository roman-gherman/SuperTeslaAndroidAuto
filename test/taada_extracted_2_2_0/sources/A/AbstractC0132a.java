...
public abstract class AbstractC0132a implements Predicate {
    ...
    */
    ...
    public static final boolean b0(AbstractC0162z abstractC0162z) {
        ...
        if (declarationDescriptor != null && N2.i.b(declarationDescriptor) && !e.g((ClassDescriptor) declarationDescriptor).equals(p.f3765g)) {
            return true;
        }
    ...
    public static H3.d r(Q3.a aVar) throws IOException {
        ...
        if (aVar instanceof org.bouncycastle.pqc.crypto.slhdsa.g) {
            ...
            h5.c cVar2 = gVar.c;
            return new H3.d(new H3.a((C0896n) I4.c.f804N.get((org.bouncycastle.pqc.crypto.slhdsa.e) gVar.b)), c.e(cVar2.f3461a, cVar2.b));
        }
        if (aVar instanceof org.bouncycastle.pqc.crypto.sphincsplus.g) {
            ...
            h5.c cVar3 = gVar2.c;
            return new H3.d(new H3.a((C0896n) I4.c.f819r.get((org.bouncycastle.pqc.crypto.sphincsplus.e) gVar2.b)), c.e(cVar3.f3461a, cVar3.b));
        }
