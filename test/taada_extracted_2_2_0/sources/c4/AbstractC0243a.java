...
public abstract class AbstractC0243a {
    ...
    public AbstractC0243a(int i, int i3, int i4, int i5) {
        ...
        h4.d dVar = AbstractC0523a.f3455a;
        if (iArr[0] != 0) {
        ...
        this(new C0525c(AbstractC0523a.f3455a, new C0524b(iArr)));
    ...
    */
    public AbstractC0243a(java.math.BigInteger r5) {
        /*
            ...
            r0 = 1
            r4.f1779g = r0
            h4.d r0 = h4.AbstractC0523a.f3455a
            int r0 = r5.bitLength()
            int r1 = r5.signum()
            if (r1 <= 0) goto L40
            r1 = 2
            ...
            r2 = 3
            if (r0 >= r2) goto L36
            java.math.BigInteger r0 = g5.b.f3344a
            int r0 = r5.bitLength()
            r3 = 31
            if (r0 > r3) goto L2e
            int r0 = r5.intValue()
        ...
        L28:
            ...
            goto L3c
        L2b:
            h4.d r5 = h4.AbstractC0523a.f3455a
            goto L3c
        L2e:
