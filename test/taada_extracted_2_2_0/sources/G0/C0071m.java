...
public final class C0071m extends com.google.crypto.tink.shaded.protobuf.O implements AesCtrHmacStreamingKeyFormatOrBuilder {
    ...
    public final int getKeySize() {
        return ((C0074n) this.b).getKeySize();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingKeyFormatOrBuilder
    public final C0080p getParams() {
        return ((C0074n) this.b).getParams();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingKeyFormatOrBuilder
    public final int getVersion() {
        return ((C0074n) this.b).getVersion();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingKeyFormatOrBuilder
    public final boolean hasParams() {
        return ((C0074n) this.b).hasParams();
    }
