...
public final class p1 extends com.google.crypto.tink.shaded.protobuf.O implements KeysetInfo$KeyInfoOrBuilder {
    ...
    public final int getKeyId() {
        return ((q1) this.b).getKeyId();
    }

    @Override // com.google.crypto.tink.proto.KeysetInfo$KeyInfoOrBuilder
    public final A1 getOutputPrefixType() {
        return ((q1) this.b).getOutputPrefixType();
    }

    @Override // com.google.crypto.tink.proto.KeysetInfo$KeyInfoOrBuilder
    public final int getOutputPrefixTypeValue() {
        return ((q1) this.b).getOutputPrefixTypeValue();
    }

    @Override // com.google.crypto.tink.proto.KeysetInfo$KeyInfoOrBuilder
    public final EnumC0052f1 getStatus() {
        return ((q1) this.b).getStatus();
    }

    @Override // com.google.crypto.tink.proto.KeysetInfo$KeyInfoOrBuilder
    public final int getStatusValue() {
        return ((q1) this.b).getStatusValue();
    }

    @Override // com.google.crypto.tink.proto.KeysetInfo$KeyInfoOrBuilder
    public final String getTypeUrl() {
        return ((q1) this.b).getTypeUrl();
    }

    @Override // com.google.crypto.tink.proto.KeysetInfo$KeyInfoOrBuilder
    public final AbstractC0381o getTypeUrlBytes() {
        return ((q1) this.b).getTypeUrlBytes();
    }
