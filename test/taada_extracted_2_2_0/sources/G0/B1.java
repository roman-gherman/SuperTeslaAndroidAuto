...
public final class B1 extends com.google.crypto.tink.shaded.protobuf.O implements RegistryConfigOrBuilder {
    ...
    public final String getConfigName() {
        return ((C1) this.b).getConfigName();
    }

    @Override // com.google.crypto.tink.proto.RegistryConfigOrBuilder
    public final AbstractC0381o getConfigNameBytes() {
        return ((C1) this.b).getConfigNameBytes();
    }
    ...
    public final C0064j1 getEntry(int i) {
        return ((C1) this.b).getEntry(i);
    }

    @Override // com.google.crypto.tink.proto.RegistryConfigOrBuilder
    public final int getEntryCount() {
        return ((C1) this.b).getEntryCount();
    }

    @Override // com.google.crypto.tink.proto.RegistryConfigOrBuilder
    public final List getEntryList() {
        return Collections.unmodifiableList(((C1) this.b).getEntryList());
    }
