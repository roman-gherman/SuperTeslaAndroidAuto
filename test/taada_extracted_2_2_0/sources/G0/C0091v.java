...
public final class C0091v extends com.google.crypto.tink.shaded.protobuf.Q implements AesCtrParamsOrBuilder {
    private static final C0091v DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile Parser<C0091v> PARSER;
    private int ivSize_;

    static {
        C0091v c0091v = new C0091v();
        DEFAULT_INSTANCE = c0091v;
        com.google.crypto.tink.shaded.protobuf.Q.q(C0091v.class, c0091v);
    }

    public static void t(C0091v c0091v) {
        c0091v.ivSize_ = 16;
    }

    public static C0091v u() {
        return DEFAULT_INSTANCE;
    }

    public static C0089u v() {
        return (C0089u) DEFAULT_INSTANCE.d();
    }
    ...
    public final Object e(int i) {
        ...
        switch (f.s.b(i)) {
            ...
            case 3:
                return new C0091v();
            case 4:
                return new C0089u(DEFAULT_INSTANCE);
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                Parser<C0091v> parser = PARSER;
                if (parser != null) {
                    return parser;
                }
                synchronized (C0091v.class) {
                    try {
                        p5 = PARSER;
                        if (p5 == null) {
