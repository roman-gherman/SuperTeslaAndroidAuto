...
public final class C0077o extends com.google.crypto.tink.shaded.protobuf.O implements AesCtrHmacStreamingParamsOrBuilder {
    ...
    public final int getCiphertextSegmentSize() {
        return ((C0080p) this.b).getCiphertextSegmentSize();
    }
    ...
    public final int getDerivedKeySize() {
        return ((C0080p) this.b).getDerivedKeySize();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingParamsOrBuilder
    public final EnumC0086s0 getHkdfHashType() {
        return ((C0080p) this.b).getHkdfHashType();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingParamsOrBuilder
    public final int getHkdfHashTypeValue() {
        return ((C0080p) this.b).getHkdfHashTypeValue();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingParamsOrBuilder
    public final A0 getHmacParams() {
        return ((C0080p) this.b).getHmacParams();
    }

    @Override // com.google.crypto.tink.proto.AesCtrHmacStreamingParamsOrBuilder
    public final boolean hasHmacParams() {
        return ((C0080p) this.b).hasHmacParams();
    }
