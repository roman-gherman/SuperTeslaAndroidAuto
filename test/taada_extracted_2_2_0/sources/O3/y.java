...
public final class y extends n {
    ...
    public final EnumC0743a f4357k;

    public y(int i, EnumC0743a enumC0743a) {
        super(i);
        this.f4357k = enumC0743a;
        if (enumC0743a != EnumC0743a.f4321a) {
            if (i < 1) {
                throw new IllegalArgumentException(B2.b.d(i, "Buffered channel capacity must be at least 1, but ", " was specified").toString());
            }
        } else {
            throw new IllegalArgumentException(("This implementation does not support suspension for senders, use " + kotlin.jvm.internal.w.f3818a.b(n.class).getSimpleName() + " instead").toString());
        }
    }
    ...
    */
    ...
    public final boolean r() {
        return this.f4357k == EnumC0743a.b;
    }
