...
public final class w extends r3.u {
    ...
    public final AtomicReferenceArray f4356f;

    public w(long j6, w wVar, n nVar, int i) {
        super(j6, wVar, i);
        this.e = nVar;
        this.f4356f = new AtomicReferenceArray(p.b * 2);
    }
    ...
    */
    public final void g(int r5, kotlin.coroutines.CoroutineContext r6) {
        ...
        L7:
            ...
            int r5 = r5 - r6
        La:
            java.util.concurrent.atomic.AtomicReferenceArray r6 = r4.f4356f
            int r1 = r5 * 2
            r6.get(r1)
        L11:
    ...
    public final boolean j(int i, Object obj, Object obj2) {
        AtomicReferenceArray atomicReferenceArray = this.f4356f;
        int i3 = (i * 2) + 1;
    ...
    public final void m(int i, Object obj) {
        this.f4356f.lazySet(i * 2, obj);
    }

    public final void n(int i, E1.h hVar) {
        this.f4356f.set((i * 2) + 1, hVar);
    }
}
