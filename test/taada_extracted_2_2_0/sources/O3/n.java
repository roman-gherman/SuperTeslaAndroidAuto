...
public class n implements Channel {
    ...
    public static final AtomicReferenceFieldUpdater f4333f = AtomicReferenceFieldUpdater.newUpdater(n.class, Object.class, "sendSegment");

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final AtomicReferenceFieldUpdater f4334g = AtomicReferenceFieldUpdater.newUpdater(n.class, Object.class, "receiveSegment");

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final AtomicReferenceFieldUpdater f4335h = AtomicReferenceFieldUpdater.newUpdater(n.class, Object.class, "bufferEndSegment");
    ...
    public static final AtomicReferenceFieldUpdater f4336j = AtomicReferenceFieldUpdater.newUpdater(n.class, Object.class, "closeHandler");
    ...
    public static final w a(n nVar, long j6, w wVar) {
        ...
        loop0: while (true) {
            ...
            if (!AbstractC0800a.e(objB)) {
                ...
                while (true) {
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4333f;
    ...
    public static final void c(n nVar, SelectInstance selectInstance) {
        ...
        selectInstance.selectInRegistrationPhase(p.f4345l);
    }
    ...
    public static final int d(n nVar, w wVar, int i3, Object obj, long j6, Object obj2, boolean z6) {
        ...
        if (objK == null) {
            ...
            E1.h hVar = p.f4344k;
            if (wVar.f4356f.getAndSet((i3 * 2) + 1, hVar) == hVar) {
                return 5;
            }
            wVar.l(i3, true);
            return 5;
    ...
    */
    public static java.lang.Object v(o3.n r13, kotlin.coroutines.Continuation r14) {
        ...
        L14:
            ...
            goto L12
        L1a:
            java.lang.Object r14 = r6.f4331a
            T1.a r0 = T1.a.f1304a
            int r1 = r6.c
            r2 = 1
            if (r1 == 0) goto L35
            ...
            o3.v r14 = (o3.v) r14
            java.lang.Object r13 = r14.f4355a
            return r13
        L2d:
        ...
        L35:
            kotlin.reflect.l.e0(r14)
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r14 = o3.n.f4334g
        ...
        L6e:
            ...
            r1 = r7
            E1.h r14 = o3.p.f4346m
            if (r13 == r14) goto La0
            E1.h r14 = o3.p.f4348o
            if (r13 != r14) goto L8d
            long r13 = r1.n()
    ...
    public final Object B(w wVar, int i3, long j6, Object obj) {
        Object objK = wVar.k(i3);
        AtomicReferenceArray atomicReferenceArray = wVar.f4356f;
        ...
        while (true) {
            ...
            if (objK2 == null || objK2 == p.e) {
                ...
                if (objK2 != p.d) {
                    E1.h hVar = p.f4343j;
                    if (objK2 != hVar && objK2 != p.f4342h) {
                        if (objK2 == p.f4345l) {
                            i();
                            return p.f4348o;
                        }
                        if (objK2 != p.f4341g && wVar.j(i3, objK2, p.f4340f)) {
                            boolean z6 = objK2 instanceof E;
                            if (z6) {
                                objK2 = ((E) objK2).f4320a;
                            }
                            if (A(objK2)) {
                                wVar.n(i3, p.i);
                                i();
    ...
    public final boolean e(long j6) {
        return j6 < d.get(this) || j6 < c.get(this) + ((long) this.f4337a);
    }
    ...
    public final boolean f(Throwable th, boolean z6) {
        ...
        if (z7) {
            loop3: while (true) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f4336j;
                obj = atomicReferenceFieldUpdater2.get(this);
                E1.h hVar2 = obj == null ? p.q : p.f4350r;
    ...
    */
    ...
    public final SelectClause1 getOnReceive() {
        C0745c c0745c = C0745c.f4323a;
        kotlin.jvm.internal.z.d(3, c0745c);
        C0746d c0746d = C0746d.f4324a;
    ...
    public final void h(long j6) {
        w wVar = (w) f4334g.get(this);
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = c;
            long j7 = atomicLongFieldUpdater.get(this);
            if (j6 < Math.max(((long) this.f4337a) + j7, d.get(this))) {
                return;
            }
            if (atomicLongFieldUpdater.compareAndSet(this, j7, 1 + j7)) {
                ...
                w wVar2 = wVar;
                if (B(wVar2, i3, j7, null) != p.f4348o || j7 < n()) {
                    wVar2.a();
                }
                wVar = wVar2;
            }
    ...
    */
    ...
    public final void invokeOnClose(Function1 function1) {
        ...
        do {
            atomicReferenceFieldUpdater = f4336j;
    ...
    public final w j(long j6, w wVar) {
        ...
        loop0: while (true) {
            ...
            if (!AbstractC0800a.e(objB)) {
                r3.u uVarC = AbstractC0800a.c(objB);
                while (true) {
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4334g;
        ...
        if (AbstractC0800a.e(objB)) {
            ...
            if (!zS && j6 <= d.get(this) / ((long) p.b)) {
                while (true) {
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f4335h;
            ...
            if (wVarJ.c == j7 || (wVarJ = j(j7, wVarJ)) != null) {
                ...
                while (true) {
                    ...
                    if (objK == null || objK == p.e) {
                        ...
                        if (objK != p.f4343j && objK != p.f4345l && objK != p.i && objK != p.f4342h) {
                            if (objK == p.f4341g) {
                                return true;
                            }
                            if (objK != p.f4340f && j6 == atomicLongFieldUpdater.get(this)) {
                                return true;
                            }
                        }
                    }
    ...
    public final Object poll() throws Throwable {
        ...
        if ((objMo105tryReceivePtdJZtk instanceof t) && (th = ((t) objMo105tryReceivePtdJZtk).f4354a) != null) {
            throw th;
        }
    ...
    */
    public final void t(long r5, o3.w r7) {
        ...
        L20:
            ...
            goto L11
        L22:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = o3.n.f4335h
    ...
    */
    public java.lang.Object mo106trySendJP2dKIU(java.lang.Object r17) {
        ...
        L22:
            E1.h r6 = o3.p.f4343j
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r1 = o3.n.f4333f
    ...
    */
    ...
    public void x(SelectInstance selectInstance, Object obj) {
        ...
        while (true) {
            ...
            if (iD == 2) {
                if (zQ) {
                    wVar2.h();
                    selectInstance2.selectInRegistrationPhase(p.f4345l);
                    return;
                } else {
                    Waiter waiter = selectInstance2 instanceof Waiter ? (Waiter) selectInstance2 : null;
                    if (waiter != null) {
    ...
    public final void y(Waiter waiter, boolean z6) {
        ...
        if (waiter instanceof C0742C) {
            ((C0742C) waiter).f4318a.resumeWith(new v(new t(k())));
            return;
        }
        if (!(waiter instanceof C0744b)) {
            if (waiter instanceof SelectInstance) {
                ((SelectInstance) waiter).trySelect(this, p.f4345l);
                return;
            } else {
    ...
    public final boolean z(Object obj, Object obj2) {
        ...
        if (obj instanceof C0742C) {
            ...
            return p.a(((C0742C) obj).f4318a, new v(obj2), null);
        }
