    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void flushBase64() throws IOException {
            ...
            if (i > 0) {
                ...
                ((FilterOutputStream) this).out.write(Base64.encode3to4(this.f4435b4, this.buffer, i, this.options));
                this.position = 0;
            }
        }
        ...
        public void write(int i) throws IOException {
            ...
            if (!this.encode) {
                ...
                if (i4 >= this.bufferLength) {
                    ((FilterOutputStream) this).out.write(this.f4435b4, 0, Base64.decode4to3(bArr, 0, this.f4435b4, 0, this.options));
                    this.position = 0;
                    return;
                }
                return;
            ...
            if (i6 >= i7) {
                ((FilterOutputStream) this).out.write(Base64.encode3to4(this.f4435b4, bArr2, i7, this.options));
