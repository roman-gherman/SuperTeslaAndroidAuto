...
public final class C0815b extends B4.a {
    ...
    public C0815b(C0814a c0814a, byte[] bArr, C0816c c0816c) {
        ...
        int i6 = (i * i5) + 128;
        this.f4775f = g5.c.h(bArr, 128, i6);
        int i7 = (i5 * i3) + i6;
        this.f4776g = g5.c.h(bArr, i6, i7);
        this.f4777h = g5.c.h(bArr, i7, (i3 * TypedValues.CycleType.TYPE_PATH_ROTATE) + i7);
        if (c0816c != null) {
    ...
    public final byte[] getEncoded() {
        return g5.c.f(new byte[][]{this.c, this.d, this.e, this.f4775f, this.f4776g, this.f4777h});
    }
    ...
    public C0815b(C0814a c0814a, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[] bArr7) {
        ...
        this.d = g5.c.c(bArr2);
        this.e = g5.c.c(bArr3);
        this.f4775f = g5.c.c(bArr4);
        this.f4776g = g5.c.c(bArr5);
        this.f4777h = g5.c.c(bArr6);
        this.i = g5.c.c(bArr7);
    }
}
