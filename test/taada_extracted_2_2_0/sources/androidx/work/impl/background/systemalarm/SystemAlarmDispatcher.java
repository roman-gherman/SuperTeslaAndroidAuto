...
public class SystemAlarmDispatcher implements ExecutionListener {
    ...
    public void onExecuted(WorkGenerationalId workGenerationalId, boolean z6) {
        this.mTaskExecutor.getMainThreadExecutor().execute(new AddRunnable(this, CommandHandler.createExecutionCompletedIntent(this.mContext, workGenerationalId, z6), 0));
    }
