...
public class Schedulers {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$registerRescheduling$1(Executor executor, List list, Configuration configuration, WorkDatabase workDatabase, WorkGenerationalId workGenerationalId, boolean z6) {
        executor.execute(new d(list, workGenerationalId, configuration, workDatabase, 0));
    }
    ...
    public static void registerRescheduling(final List<Scheduler> list, Processor processor, final Executor executor, final WorkDatabase workDatabase, final Configuration configuration) {
        processor.addExecutionListener(new ExecutionListener() { // from class: androidx.work.impl.c
            ...
            public final void onExecuted(WorkGenerationalId workGenerationalId, boolean z6) {
                Schedulers.lambda$registerRescheduling$1(executor, list, configuration, workDatabase, workGenerationalId, z6);
            }
        });
    }
