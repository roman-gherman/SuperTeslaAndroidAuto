...
interface CardViewImpl {
    ...
    void initialize(CardViewDelegate cardViewDelegate, Context context, ColorStateList colorStateList, float f6, float f7, float f8);
    ...
    void setElevation(CardViewDelegate cardViewDelegate, float f6);

    void setMaxElevation(CardViewDelegate cardViewDelegate, float f6);

    void setRadius(CardViewDelegate cardViewDelegate, float f6);
