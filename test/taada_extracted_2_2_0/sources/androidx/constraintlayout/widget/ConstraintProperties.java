...
public class ConstraintProperties {
    ...
    public ConstraintProperties addToHorizontalChain(int i, int i3) {
    ...
    public ConstraintProperties addToHorizontalChainRTL(int i, int i3) {
    ...
    public ConstraintProperties addToVerticalChain(int i, int i3) {
    ...
    public ConstraintProperties center(int i, int i3, int i4, int i5, int i6, int i7, float f6) {
        if (i4 < 0) {
    ...
    public ConstraintProperties centerHorizontally(int i, int i3, int i4, int i5, int i6, int i7, float f6) {
        connect(1, i, i3, i4);
        connect(2, i5, i6, i7);
        this.mParams.horizontalBias = f6;
        return this;
    ...
    public ConstraintProperties centerHorizontallyRtl(int i, int i3, int i4, int i5, int i6, int i7, float f6) {
        connect(6, i, i3, i4);
        connect(7, i5, i6, i7);
        this.mParams.horizontalBias = f6;
        return this;
    ...
    public ConstraintProperties centerVertically(int i, int i3, int i4, int i5, int i6, int i7, float f6) {
        connect(3, i, i3, i4);
        connect(4, i5, i6, i7);
        this.mParams.verticalBias = f6;
        return this;
    ...
    public ConstraintProperties connect(int i, int i3, int i4, int i5) {
        switch (i) {
            case 1:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(b.h(new StringBuilder("Left to "), sideToString(i4), " undefined"));
                    }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(b.h(new StringBuilder("right to "), sideToString(i4), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(b.h(sb, sideToString(i4), " unknown"));
        }
    }
    ...
    public ConstraintProperties goneMargin(int i, int i3) {
        switch (i) {
            case 1:
    ...
    public ConstraintProperties margin(int i, int i3) {
        switch (i) {
            case 1:
