...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        private boolean isSimilarSpec(int i, int i3, int i4) {
            if (i == i3) {
                return true;
            }
        ...
        public void captureLayoutInfo(int i, int i3, int i4, int i5, int i6, int i7) {
            this.paddingTop = i4;
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i7 == 1) {
                ...
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, constraintWidget.getHorizontalMargin() + i6, -1);
            } else if (i7 != 4) {
                iMakeMeasureSpec = 0;
            } else {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i6, -2);
                ...
                if (i8 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i8 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    boolean z7 = view.getMeasuredHeight() == constraintWidget.getHeight();
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z6 || ((z6 && z7) || (view instanceof Placeholder) || constraintWidget.isResolvedHorizontally())) {
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), BasicMeasure.EXACTLY);
                    }
                }
            }
            int i9 = iArr[dimensionBehaviour2.ordinal()];
            if (i9 == 1) {
                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i4, BasicMeasure.EXACTLY);
            } else if (i9 == 2) {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i5, -2);
            } else if (i9 == 3) {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, constraintWidget.getVerticalMargin() + i5, -1);
            } else if (i9 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i5, -2);
                ...
                if (i10 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i10 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    boolean z9 = view.getMeasuredWidth() == constraintWidget.getWidth();
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z8 || ((z8 && z9) || (view instanceof Placeholder) || constraintWidget.isResolvedVertically())) {
            ...
            if (i11 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i11 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z10 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z11 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                iMax2 = 0;
                i = -1;
                baseline = 0;
                iMax = 0;
    ...
    private void init(AttributeSet attributeSet, int i, int i3) {
        this.mLayoutWidget.setCompanionWidget(this);
        this.mLayoutWidget.setMeasurer(this.mMeasurer);
        this.mChildrenByIds.put(getId(), this);
        this.mConstraintSet = null;
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_Layout, i, i3);
    ...
    */
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    ...
                    if (strArrSplit.length == 4) {
                        ...
                        float f6 = i7;
                        float f7 = i8;
                        float f8 = i7 + ((int) ((i6 / 1080.0f) * width));
                        canvas.drawLine(f6, f7, f8, f7, paint);
                        float f9 = i8 + ((int) ((Integer.parseInt(strArrSplit[3]) / 1920.0f) * height));
    ...
    public void onMeasure(int i, int i3) {
        ...
        resolveMeasuredDimension(i, i3, this.mLayoutWidget.getWidth(), this.mLayoutWidget.getHeight(), this.mLayoutWidget.isWidthMeasuredTooSmall(), this.mLayoutWidget.isHeightMeasuredTooSmall());
    }
    ...
    public void resolveMeasuredDimension(int i, int i3, int i4, int i5, boolean z6, boolean z7) {
        Measurer measurer = this.mMeasurer;
        int i6 = measurer.paddingHeight;
        int iResolveSizeAndState = View.resolveSizeAndState(i4 + measurer.paddingWidth, i, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i, int i3, int i4) {
        int i5;
        ...
        this.mMeasurer.captureLayoutInfo(i3, i4, iMax, iMax2, paddingWidth, i6);
        ...
        if (iMax3 > 0 || iMax4 > 0) {
            ...
            constraintWidgetContainer.measure(i, mode, i7, mode2, i8, this.mLastMeasureWidth, this.mLastMeasureHeight, i5, iMax);
        }
        iMax3 = Math.max(0, getPaddingLeft());
        i5 = iMax3;
        int i72 = size - paddingWidth;
        int i82 = size2 - i6;
        setSelfDimensionBehaviour(constraintWidgetContainer, mode, i72, mode2, i82);
        constraintWidgetContainer.measure(i, mode, i72, mode2, i82, this.mLastMeasureWidth, this.mLastMeasureHeight, i5, iMax);
    }
    ...
    */
    ...
    public void setState(int i, int i3, int i4) {
        ConstraintLayoutStates constraintLayoutStates = this.mConstraintLayoutSpec;
        if (constraintLayoutStates != null) {
            constraintLayoutStates.updateConstraints(i, i3, i4);
        }
    }
    ...
    public ConstraintLayout(Context context, AttributeSet attributeSet, int i, int i3) {
