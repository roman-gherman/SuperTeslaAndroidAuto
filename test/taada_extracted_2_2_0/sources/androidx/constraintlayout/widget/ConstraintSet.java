...
public class ConstraintSet {
        ...
        public static class Delta {
            ...
            public void printDelta(String str) {
                ...
                for (int i9 = 0; i9 < this.mCountBoolean; i9++) {
                    ...
                    boolean z6 = this.mValueBoolean[i9];
                }
            }
    ...
    public class WriteXmlEngine {
        ...
        private void writeBaseDimension(String str, int i, int i3) throws IOException {
            if (i != i3) {
                if (i == -2) {
        ...
        private void writeBoolen(String str, boolean z6, boolean z7) throws IOException {
            if (z6 != z7) {
                this.writer.write(SPACE + str + "=\"" + z6 + "dp\"");
            }
        }

        private void writeDimension(String str, int i, int i3) throws IOException {
            if (i != i3) {
                this.writer.write(SPACE + str + "=\"" + i + "dp\"");
            }
        }

        private void writeEnum(String str, int i, String[] strArr, int i3) throws IOException {
            if (i != i3) {
                Writer writer = this.writer;
                StringBuilder sbM = b.m(SPACE, str, "=\"");
                sbM.append(strArr[i]);
                sbM.append("\"");
        ...
        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return b.h(new StringBuilder("@+id/"), this.idMap.get(Integer.valueOf(i)), "");
            }
            if (i == 0) {
        ...
        public void writeCircle(int i, float f6, int i3) throws IOException {
            if (i == -1) {
                return;
            }
            ...
            this.writer.write(", " + f6);
            this.writer.write(i3 + "]");
        }

        public void writeConstraint(String str, int i, String str2, int i3, int i4) throws IOException {
            if (i == -1) {
                return;
            }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z6) {
        ...
        populateConstraint(context, constraint, typedArrayObtainStyledAttributes, z6);
        typedArrayObtainStyledAttributes.recycle();
        return constraint;
    }
    ...
    public static String getDebugName(int i) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(JavaConstant.Dynamic.DEFAULT_NAME) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int lookupID(TypedArray typedArray, int i, int i3) {
    ...
    */
    ...
    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray, boolean z6) {
        if (z6) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i, float f6) {
        if (i == 19) {
    ...
    public void addToHorizontalChain(int i, int i3, int i4) {
        connect(i, 1, i3, i3 == 0 ? 1 : 2, 0);
        connect(i, 2, i4, i4 == 0 ? 2 : 1, 0);
        if (i3 != 0) {
            connect(i3, 2, i, 1, 0);
        }
        if (i4 != 0) {
    ...
    public void addToHorizontalChainRTL(int i, int i3, int i4) {
        connect(i, 6, i3, i3 == 0 ? 6 : 7, 0);
        connect(i, 7, i4, i4 == 0 ? 7 : 6, 0);
        if (i3 != 0) {
            connect(i3, 7, i, 6, 0);
        }
        if (i4 != 0) {
    ...
    public void addToVerticalChain(int i, int i3, int i4) {
        connect(i, 3, i3, i3 == 0 ? 3 : 4, 0);
        connect(i, 4, i4, i4 == 0 ? 4 : 3, 0);
        if (i3 != 0) {
            connect(i3, 4, i, 3, 0);
        }
        if (i4 != 0) {
    ...
    public void center(int i, int i3, int i4, int i5, int i6, int i7, int i8, float f6) {
        if (i5 < 0) {
        ...
        if (i4 == 1 || i4 == 2) {
            connect(i, 1, i3, i4, i5);
            connect(i, 2, i6, i7, i8);
        ...
        if (i4 == 6 || i4 == 7) {
            connect(i, 6, i3, i4, i5);
            connect(i, 7, i6, i7, i8);
        ...
        connect(i, 3, i3, i4, i5);
        connect(i, 4, i6, i7, i8);
    ...
    public void centerHorizontally(int i, int i3, int i4, int i5, int i6, int i7, int i8, float f6) {
        connect(i, 1, i3, i4, i5);
        connect(i, 2, i6, i7, i8);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        if (constraint != null) {
    ...
    public void centerHorizontallyRtl(int i, int i3, int i4, int i5, int i6, int i7, int i8, float f6) {
        connect(i, 6, i3, i4, i5);
        connect(i, 7, i6, i7, i8);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        if (constraint != null) {
    ...
    public void centerVertically(int i, int i3, int i4, int i5, int i6, int i7, int i8, float f6) {
        connect(i, 3, i3, i4, i5);
        connect(i, 4, i6, i7, i8);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        if (constraint != null) {
    ...
    public void connect(int i, int i3, int i4, int i5, int i6) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i))) {
            this.mConstraints.put(Integer.valueOf(i), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
        ...
        switch (i3) {
            case 1:
                if (i5 == 1) {
                    ...
                    if (i5 != 2) {
                        throw new IllegalArgumentException(b.h(new StringBuilder("Left to "), sideToString(i5), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i5 == 1) {
                    ...
                    if (i5 != 2) {
                        throw new IllegalArgumentException(b.h(new StringBuilder("right to "), sideToString(i5), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(b.h(sb, sideToString(i5), " unknown"));
        }
    }

    public void constrainCircle(int i, int i3, int i4, float f6) {
    ...
    public void constrainDefaultHeight(int i, int i3) {
        get(i).layout.heightDefault = i3;
    }

    public void constrainDefaultWidth(int i, int i3) {
        get(i).layout.widthDefault = i3;
    }

    public void constrainHeight(int i, int i3) {
        get(i).layout.mHeight = i3;
    }

    public void constrainMaxHeight(int i, int i3) {
        get(i).layout.heightMax = i3;
    }

    public void constrainMaxWidth(int i, int i3) {
        get(i).layout.widthMax = i3;
    }

    public void constrainMinHeight(int i, int i3) {
        get(i).layout.heightMin = i3;
    }

    public void constrainMinWidth(int i, int i3) {
        get(i).layout.widthMin = i3;
    }

    public void constrainPercentHeight(int i, float f6) {
        get(i).layout.heightPercent = f6;
    }

    public void constrainPercentWidth(int i, float f6) {
        get(i).layout.widthPercent = f6;
    }

    public void constrainWidth(int i, int i3) {
        get(i).layout.mWidth = i3;
    }

    public void constrainedHeight(int i, boolean z6) {
        get(i).layout.constrainedHeight = z6;
    }

    public void constrainedWidth(int i, boolean z6) {
        get(i).layout.constrainedWidth = z6;
    }

    public void create(int i, int i3) {
        Layout layout = get(i).layout;
        layout.mIsGuideline = true;
        layout.orientation = i3;
    }

    public void createBarrier(int i, int i3, int i4, int... iArr) {
        Layout layout = get(i).layout;
        layout.mHelperType = 1;
    ...
    public void createHorizontalChain(int i, int i3, int i4, int i5, int[] iArr, float[] fArr, int i6) {
        createHorizontalChain(i, i3, i4, i5, iArr, fArr, i6, 1, 2);
    }

    public void createHorizontalChainRtl(int i, int i3, int i4, int i5, int[] iArr, float[] fArr, int i6) {
        createHorizontalChain(i, i3, i4, i5, iArr, fArr, i6, 6, 7);
    }

    public void createVerticalChain(int i, int i3, int i4, int i5, int[] iArr, float[] fArr, int i6) {
        if (iArr.length < 2) {
    ...
    */
    ...
    public void setAlpha(int i, float f6) {
        get(i).propertySet.alpha = f6;
    }

    public void setApplyElevation(int i, boolean z6) {
        get(i).transform.applyElevation = z6;
    }

    public void setBarrierType(int i, int i3) {
        get(i).layout.mHelperType = i3;
    }

    public void setColorValue(int i, String str, int i3) {
        get(i).setColorValue(str, i3);
    }
    ...
    public void setEditorAbsoluteX(int i, int i3) {
        get(i).layout.editorAbsoluteX = i3;
    }

    public void setEditorAbsoluteY(int i, int i3) {
        get(i).layout.editorAbsoluteY = i3;
    }

    public void setElevation(int i, float f6) {
        get(i).transform.elevation = f6;
        get(i).transform.applyElevation = true;
    }

    public void setFloatValue(int i, String str, float f6) {
        get(i).setFloatValue(str, f6);
    }
    ...
    public void setGoneMargin(int i, int i3, int i4) {
    ...
    public void setGuidelineBegin(int i, int i3) {
        get(i).layout.guideBegin = i3;
        get(i).layout.guideEnd = -1;
        get(i).layout.guidePercent = -1.0f;
    }

    public void setGuidelineEnd(int i, int i3) {
        get(i).layout.guideEnd = i3;
        get(i).layout.guideBegin = -1;
        get(i).layout.guidePercent = -1.0f;
    }

    public void setGuidelinePercent(int i, float f6) {
        get(i).layout.guidePercent = f6;
        get(i).layout.guideEnd = -1;
        get(i).layout.guideBegin = -1;
    }

    public void setHorizontalBias(int i, float f6) {
        get(i).layout.horizontalBias = f6;
    }

    public void setHorizontalChainStyle(int i, int i3) {
        get(i).layout.horizontalChainStyle = i3;
    }

    public void setHorizontalWeight(int i, float f6) {
        get(i).layout.horizontalWeight = f6;
    }

    public void setIntValue(int i, String str, int i3) {
        get(i).setIntValue(str, i3);
    }

    public void setLayoutWrapBehavior(int i, int i3) {
        if (i3 < 0 || i3 > 3) {
            return;
        }
        get(i).layout.mWrapBehavior = i3;
    }

    public void setMargin(int i, int i3, int i4) {
        Constraint constraint = get(i);
        switch (i3) {
            case 1:
    ...
    public void setRotation(int i, float f6) {
        get(i).transform.rotation = f6;
    }

    public void setRotationX(int i, float f6) {
        get(i).transform.rotationX = f6;
    }

    public void setRotationY(int i, float f6) {
        get(i).transform.rotationY = f6;
    }

    public void setScaleX(int i, float f6) {
        get(i).transform.scaleX = f6;
    }

    public void setScaleY(int i, float f6) {
        get(i).transform.scaleY = f6;
    }
    ...
    public void setTransformPivot(int i, float f6, float f7) {
        Transform transform = get(i).transform;
        transform.transformPivotY = f7;
        transform.transformPivotX = f6;
    }

    public void setTransformPivotX(int i, float f6) {
        get(i).transform.transformPivotX = f6;
    }

    public void setTransformPivotY(int i, float f6) {
        get(i).transform.transformPivotY = f6;
    }

    public void setTranslation(int i, float f6, float f7) {
        Transform transform = get(i).transform;
        transform.translationX = f6;
        transform.translationY = f7;
    }

    public void setTranslationX(int i, float f6) {
        get(i).transform.translationX = f6;
    }

    public void setTranslationY(int i, float f6) {
        get(i).transform.translationY = f6;
    }

    public void setTranslationZ(int i, float f6) {
        get(i).transform.translationZ = f6;
    }
    ...
    public void setVerticalBias(int i, float f6) {
        get(i).layout.verticalBias = f6;
    }

    public void setVerticalChainStyle(int i, int i3) {
        get(i).layout.verticalChainStyle = i3;
    }

    public void setVerticalWeight(int i, float f6) {
        get(i).layout.verticalWeight = f6;
    }

    public void setVisibility(int i, int i3) {
        get(i).propertySet.visibility = i3;
    }

    public void setVisibilityMode(int i, int i3) {
        get(i).propertySet.mVisibilityMode = i3;
    }
    ...
    private void createHorizontalChain(int i, int i3, int i4, int i5, int[] iArr, float[] fArr, int i6, int i7, int i8) {
        if (iArr.length < 2) {
            throw new IllegalArgumentException("must have 2 or more widgets in a chain");
        }
        if (fArr != null && fArr.length != iArr.length) {
    ...
    public void clear(int i, int i3) {
        Constraint constraint;
        if (!this.mConstraints.containsKey(Integer.valueOf(i)) || (constraint = this.mConstraints.get(Integer.valueOf(i))) == null) {
            return;
        }
    ...
    public class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i, int i3, float f6, int i4, int i5, boolean z6) throws IOException {
            if (i != 0) {
                if (i == -2) {
            ...
            if (i5 == -1 && i4 == -1) {
                ...
                this.writer.write(SPACE + str + ": '" + f6 + "%',\n");
                return;
            }
            if (i3 == 0) {
            ...
            this.writer.write(SPACE + str + ": {'" + f6 + "'% ," + i4 + ", " + i5 + "}\n");
        }

        private void writeGuideline(int i, int i3, int i4, float f6) {
        }

        public String getName(int i) {
            if (this.idMap.containsKey(Integer.valueOf(i))) {
                return b.h(new StringBuilder("'"), this.idMap.get(Integer.valueOf(i)), "'");
            }
            if (i == 0) {
                return "'parent'";
            }
    ...
    public void centerHorizontally(int i, int i3) {
        if (i3 == 0) {
            center(i, 0, 1, 0, 0, 2, 0, 0.5f);
        } else {
            center(i, i3, 2, 0, i3, 1, 0, 0.5f);
        }
    }

    public void centerHorizontallyRtl(int i, int i3) {
        if (i3 == 0) {
            center(i, 0, 6, 0, 0, 7, 0, 0.5f);
        } else {
            center(i, i3, 7, 0, i3, 6, 0, 0.5f);
        }
    }

    public void centerVertically(int i, int i3) {
        if (i3 == 0) {
            center(i, 0, 3, 0, 0, 4, 0, 0.5f);
        } else {
            center(i, i3, 4, 0, i3, 3, 0, 0.5f);
        }
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i, int i3) {
        if (i == 6) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i, boolean z6) {
        if (i == 44) {
    ...
    public void connect(int i, int i3, int i4, int i5) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i))) {
            this.mConstraints.put(Integer.valueOf(i), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
