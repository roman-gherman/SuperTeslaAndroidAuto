...
public class WidgetGroup {
    ...
    private int solverMeasure(LinearSystem linearSystem, ArrayList<ConstraintWidget> arrayList, int i) {
        ...
        for (int i4 = 0; i4 < arrayList.size(); i4++) {
            this.results.add(new MeasureResult(arrayList.get(i4), linearSystem, i));
        }
        if (i == 0) {
    ...
    public String toString() {
        ...
        sb.append(" [");
        String strG = b.g(sb, "] <", this.id);
        for (ConstraintWidget constraintWidget : this.widgets) {
            StringBuilder sbL = b.l(strG, " ");
            sbL.append(constraintWidget.getDebugName());
            strG = sbL.toString();
        }
        return b.e(strG, " >");
    }
