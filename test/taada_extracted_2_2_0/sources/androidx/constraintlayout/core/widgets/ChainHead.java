...
public class ChainHead {
    ...
    public ChainHead(ConstraintWidget constraintWidget, int i, boolean z6) {
            ...
            if (constraintWidget.getVisibility() != 8) {
                ...
                if (dimensionBehaviourArr[i5] == dimensionBehaviour2) {
                    ...
                    if (i6 == 0 || i6 == 3 || i6 == 2) {
                        ...
                        float f6 = constraintWidget.mWeight[i5];
                        if (f6 > 0.0f) {
    ...
    private static boolean isMatchConstraintEqualityCandidate(ConstraintWidget constraintWidget, int i) {
        ...
        int i3 = constraintWidget.mResolvedMatchConstraintDefault[i];
        return i3 == 0 || i3 == 3;
    }
