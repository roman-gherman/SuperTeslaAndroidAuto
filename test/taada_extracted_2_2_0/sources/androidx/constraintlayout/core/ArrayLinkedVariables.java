...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        String string = "";
        for (int i3 = 0; i != -1 && i3 < this.currentSize; i3++) {
            StringBuilder sbK = b.k(b.e(string, " -> "));
            sbK.append(this.mArrayValues[i]);
            sbK.append(" : ");
            StringBuilder sbK2 = b.k(sbK.toString());
            sbK2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
