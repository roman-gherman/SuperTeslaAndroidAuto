...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo68clone = transition.mo68clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo68clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo68clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo68clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo68clone = transition.mo68clone();
        sceneChangeSetup(viewGroup, transitionMo68clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo68clone);
    }
