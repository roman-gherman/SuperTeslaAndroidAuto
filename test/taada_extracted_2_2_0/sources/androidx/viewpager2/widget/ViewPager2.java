...
public final class ViewPager2 extends ViewGroup {
    ...
    public boolean fakeDragBy(float f6) {
        return this.mFakeDragger.fakeDragBy(f6);
    }
    ...
    public void onLayout(boolean z6, int i, int i3, int i4, int i5) {
        ...
        this.mTmpContainerRect.right = (i4 - i) - getPaddingRight();
    ...
    public void requestTransform() {
        ...
        float f6 = (float) (relativeScrollPosition - ((double) i));
        this.mPageTransformerAdapter.onPageScrolled(i, f6, Math.round(getPageSize() * f6));
    }
    ...
    public void setCurrentItemInternal(int i, boolean z6) {
        ...
        this.mScrollEventAdapter.notifyProgrammaticScroll(iMin, z6);
        if (!z6) {
    ...
    public ViewPager2(Context context, AttributeSet attributeSet, int i, int i3) {
