...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.g
            ...
            public final void onContextAvailable(Context context) {
                this.f1640a.lambda$init$3(context);
            }
        });
    }
    ...
    @Deprecated
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intentSender, int i, Intent intent, int i3, int i4, int i5, Bundle bundle) {
        if (i == -1) {
            ActivityCompat.startIntentSenderForResult(this, intentSender, i, intent, i3, i4, i5, bundle);
        } else {
            fragment.startIntentSenderForResult(intentSender, i, intent, i3, i4, i5, bundle);
        }
    }
