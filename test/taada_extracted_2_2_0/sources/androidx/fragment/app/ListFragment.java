...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j6) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, i, j6);
        }
    };
    ...
    public void onListItemClick(ListView listView, View view, int i, long j6) {
    }
    ...
    public void setListShown(boolean z6) {
        setListShown(z6, true);
    }

    public void setListShownNoAnimation(boolean z6) {
        setListShown(z6, false);
    }
    ...
    private void setListShown(boolean z6, boolean z7) {
        ensureList();
