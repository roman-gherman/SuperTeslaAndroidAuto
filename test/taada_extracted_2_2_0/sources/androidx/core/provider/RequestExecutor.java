...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(String str, int i, int i3) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, 1, i3, TimeUnit.MILLISECONDS, new LinkedBlockingDeque(), new DefaultThreadFactory(str, i));
