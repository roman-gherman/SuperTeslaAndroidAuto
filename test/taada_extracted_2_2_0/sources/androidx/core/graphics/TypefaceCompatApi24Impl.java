...
class TypefaceCompatApi24Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, ByteBuffer byteBuffer, int i, int i3, boolean z6) {
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, byteBuffer, Integer.valueOf(i), null, Integer.valueOf(i3), Boolean.valueOf(z6))).booleanValue();
    ...
    public Typeface createWeightStyle(Context context, Typeface typeface, int i, boolean z6) {
        ...
        try {
            typefaceCreateWeightStyle = WeightTypefaceApi21.createWeightStyle(typeface, i, z6);
