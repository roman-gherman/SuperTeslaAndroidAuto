...
public final class PathKt {
    ...
    public static final Iterable<PathSegment> flatten(Path path, float f6) {
        return PathUtils.flatten(path, f6);
    }

    public static /* synthetic */ Iterable flatten$default(Path path, float f6, int i, Object obj) {
        if ((i & 1) != 0) {
            f6 = 0.5f;
        }
