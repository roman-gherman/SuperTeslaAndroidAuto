...
public final class Insets {
    ...
    public static class Api29Impl {
        ...
        public static android.graphics.Insets of(int i, int i3, int i4, int i5) {
            return android.graphics.Insets.of(i, i3, i4, i5);
        }
    }

    private Insets(int i, int i3, int i4, int i5) {
        this.left = i;
        this.top = i3;
        this.right = i4;
        this.bottom = i5;
    ...
    public static Insets of(int i, int i3, int i4, int i5) {
        return (i == 0 && i3 == 0 && i4 == 0 && i5 == 0) ? NONE : new Insets(i, i3, i4, i5);
    }
