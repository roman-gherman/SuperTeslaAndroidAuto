...
public final class PermissionChecker {
    ...
    public static int checkPermission(Context context, String str, int i, int i3, String str2) {
        if (context.checkPermission(str, i, i3) == -1) {
            return -1;
        }
        ...
        return ((Process.myUid() != i3 || !ObjectsCompat.equals(context.getPackageName(), str2)) ? AppOpsManagerCompat.noteProxyOpNoThrow(context, strPermissionToOp, str2) : AppOpsManagerCompat.checkOrNoteProxyOp(context, i3, strPermissionToOp, str2)) == 0 ? 0 : -2;
    }
