...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        private static void withinStyle(StringBuilder sb, CharSequence charSequence, int i, int i3) {
            while (i < i3) {
    ...
    public static void configureMenuItem(Menu menu, int i, IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(B2.b.d(i, "Could not find menu item with id ", " in the supplied menu"));
    }
}
