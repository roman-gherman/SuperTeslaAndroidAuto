...
public abstract class JobIntentService extends Service {
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbJ = B2.b.j(i, "Given job ID ", " is different than previous ");
                sbJ.append(this.mJobId);
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z6, int i) {
