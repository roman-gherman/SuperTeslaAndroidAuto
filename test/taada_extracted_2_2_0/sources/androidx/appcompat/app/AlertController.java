...
class AlertController {
    ...
    public static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        public CheckedItemAdapter(Context context, int i, int i3, CharSequence[] charSequenceArr) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i3) {
        ...
        ViewCompat.setScrollIndicators(view, i, i3);
