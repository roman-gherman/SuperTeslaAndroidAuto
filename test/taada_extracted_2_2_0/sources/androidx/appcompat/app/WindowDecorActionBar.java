...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public void dispatchMenuVisibilityChanged(boolean z6) {
        ...
        for (int i = 0; i < size; i++) {
            this.mMenuVisibilityListeners.get(i).onMenuVisibilityChanged(z6);
        }
    }
    ...
    public void doHide(boolean z6) {
        ...
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompatTranslationY = ViewCompat.animate(this.mContainerView).translationY(f6);
    ...
    public void setElevation(float f6) {
        ViewCompat.setElevation(this.mContainerView, f6);
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setDisplayOptions(int i, int i3) {
        int displayOptions = this.mDecorToolbar.getDisplayOptions();
        if ((i3 & 4) != 0) {
            this.mDisplayHomeAsUpSet = true;
        }
        this.mDecorToolbar.setDisplayOptions((i & i3) | ((~i3) & displayOptions));
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int i, boolean z6) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i, z6);
        configureTab(tab, i);
        if (z6) {
            selectTab(tab);
        }
