...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbJ = B2.b.j(iconResource, "Invalid icon resource ", " for ");
            sbJ.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, sbJ.toString());
            return null;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Error closing icon stream for " + uri, e6);
                }
            }
        } catch (FileNotFoundException e7) {
            Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e7.getMessage());
            return null;
        }
        Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e7.getMessage());
        return null;
