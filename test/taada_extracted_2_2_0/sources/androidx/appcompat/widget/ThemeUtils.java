...
public class ThemeUtils {
    ...
    public static ColorStateList createDisabledStateList(int i, int i3) {
        return new ColorStateList(new int[][]{DISABLED_STATE_SET, EMPTY_STATE_SET}, new int[]{i3, i});
    }
    ...
    public static int getThemeAttrColor(Context context, int i, float f6) {
        return ColorUtils.setAlphaComponent(getThemeAttrColor(context, i), Math.round(Color.alpha(r0) * f6));
    }
}
