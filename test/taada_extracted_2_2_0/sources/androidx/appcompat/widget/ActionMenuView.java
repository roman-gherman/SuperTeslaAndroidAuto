...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public static class LayoutParams extends LinearLayoutCompat.LayoutParams {
        ...
        public LayoutParams(int i, int i3, boolean z6) {
            super(i, i3);
    ...
    */
    ...
    private void onMeasureExactFormat(int i, int i3) {
        int i4;
        int i5;
        long j6;
        int i6;
        ...
        while (i14 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int iMeasureChildForCells = measureChildForCells(childAt, i13, layoutParams.isOverflowButton ? 1 : i11, childMeasureSpec, paddingBottom);
            ...
            while (i26 < childCount) {
                ...
                if ((j8 & j9) == 0) {
                    ...
                    if (!z13 || !layoutParams3.preventEdgeOffset) {
                        ...
                        z6 = true;
                        i7 = i26;
                        childAt2.setPadding(i28 + i4, 0, i28, 0);
                    } else {
                        i7 = i26;
                        z6 = true;
                    }
        ...
        i5 = iMax;
        j6 = 1;
        boolean z14 = !z8 && i15 == 1;
        if (i11 <= 0 || j7 == 0 || (i11 >= i15 - 1 && !z14 && iMax2 <= 1)) {
            i6 = 0;
        } else {
            ...
            if (z14) {
                ...
                if ((j7 & ((long) (1 << i29))) != 0 && !((LayoutParams) getChildAt(i29).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i30 = fBitCount > 0.0f ? (int) ((i11 * i4) / fBitCount) : i6;
        ...
        if (z11) {
            for (int i32 = i6; i32 < childCount; i32++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i4) + layoutParams5.extraPixels, BasicMeasure.EXACTLY), childMeasureSpec);
                }
            }
        }
        setMeasuredDimension(i9, mode != 1073741824 ? i5 : i19);
    }
