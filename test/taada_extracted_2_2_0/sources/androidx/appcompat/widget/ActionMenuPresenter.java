...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z6 || i7 + i6 > i4)) {
            i4--;
        }
        int i9 = i4 - i6;
        ...
        while (i11 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (r03.mStrictWidthLimit) {
                    iMeasureChildForCells -= ActionMenuView.measureChildForCells(itemView, i, iMeasureChildForCells, iMakeMeasureSpec, r32);
                } else {
                ...
                boolean z8 = (i9 > 0 || z7) && i5 > 0 && (!r03.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z9 = z8;
                i3 = size;
                if (z8) {
                    ...
                    z8 = z10 & (!r03.mStrictWidthLimit ? i5 + i12 <= 0 : i5 < 0);
                }
                if (z8 && groupId2 != 0) {
    ...
    public void setWidthLimit(int i, boolean z6) {
        this.mWidthLimit = i;
