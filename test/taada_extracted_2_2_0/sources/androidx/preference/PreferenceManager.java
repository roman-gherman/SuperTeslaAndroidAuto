...
public class PreferenceManager {
    ...
    public static void setDefaultValues(Context context, int i, boolean z6) {
        setDefaultValues(context, getDefaultSharedPreferencesName(context), getDefaultSharedPreferencesMode(), i, z6);
    }

    private void setNoCommit(boolean z6) {
        SharedPreferences.Editor editor;
        if (!z6 && (editor = this.mEditor) != null) {
            editor.apply();
        }
        this.mNoCommit = z6;
    }
    ...
    public static void setDefaultValues(Context context, String str, int i, int i3, boolean z6) {
