...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public class AnonymousClass1 implements ThreadUtil.MainThreadCallback<T> {
        ...
        public void removeTile(int i, int i3) {
            sendMessage(SyncQueueItem.obtainMessage(3, i, i3));
        }

        @Override // androidx.recyclerview.widget.ThreadUtil.MainThreadCallback
        public void updateItemCount(int i, int i3) {
            sendMessage(SyncQueueItem.obtainMessage(1, i, i3));
        }
    }
    ...
    public class AnonymousClass2 implements ThreadUtil.BackgroundCallback<T> {
        ...
        @Override // androidx.recyclerview.widget.ThreadUtil.BackgroundCallback
        public void updateRange(int i, int i3, int i4, int i5, int i6) {
            sendMessageAtFrontOfQueue(SyncQueueItem.obtainMessage(2, i, i3, i4, i5, i6, null));
        }
    }
    ...
    public static class SyncQueueItem {
        ...
        public static SyncQueueItem obtainMessage(int i, int i3, int i4, int i5, int i6, int i7, Object obj) {
            SyncQueueItem syncQueueItem;
        ...
        public static SyncQueueItem obtainMessage(int i, int i3, int i4) {
            return obtainMessage(i, i3, i4, 0, 0, 0, null);
        }

        public static SyncQueueItem obtainMessage(int i, int i3, Object obj) {
            return obtainMessage(i, i3, 0, 0, 0, 0, obj);
        }
    }
}
