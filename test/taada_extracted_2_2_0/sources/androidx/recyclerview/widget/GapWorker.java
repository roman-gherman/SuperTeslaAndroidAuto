...
final class GapWorker implements Runnable {
    ...
    public static class LayoutPrefetchRegistryImpl implements RecyclerView.LayoutManager.LayoutPrefetchRegistry {
        ...
        public void addPosition(int i, int i3) {
            if (i < 0) {
        ...
        public void setPrefetchVector(int i, int i3) {
            this.mPrefetchDx = i;
            this.mPrefetchDy = i3;
        }
    }
    ...
    private void prefetchInnerRecyclerViewWithDeadline(RecyclerView recyclerView, long j6) {
        ...
        if (layoutPrefetchRegistryImpl.mCount != 0) {
            try {
                ...
                for (int i = 0; i < layoutPrefetchRegistryImpl.mCount * 2; i += 2) {
                    prefetchPositionWithDeadline(recyclerView, layoutPrefetchRegistryImpl.mPrefetchArray[i], j6);
                }
            } finally {
    ...
    private RecyclerView.ViewHolder prefetchPositionWithDeadline(RecyclerView recyclerView, int i, long j6) {
        ...
        try {
            ...
            RecyclerView.ViewHolder viewHolderTryGetViewHolderForPositionByDeadline = recycler.tryGetViewHolderForPositionByDeadline(i, false, j6);
    ...
    public void postFromTraversal(RecyclerView recyclerView, int i, int i3) {
        if (recyclerView.isAttachedToWindow() && this.mPostTimeNs == 0) {
            this.mPostTimeNs = recyclerView.getNanoTime();
            recyclerView.post(this);
        }
        recyclerView.mPrefetchRegistry.setPrefetchVector(i, i3);
    }
