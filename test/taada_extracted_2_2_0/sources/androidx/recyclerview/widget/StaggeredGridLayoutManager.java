...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private boolean checkSpanForGap(Span span) {
        if (this.mShouldReverseLayout) {
            if (span.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
                return !span.getLayoutParams((View) a.g(1, span.mViews)).mFullSpan;
            }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromStart(int i) {
        ...
        fullSpanItem.mGapPerSpan = new int[this.mSpanCount];
        for (int i3 = 0; i3 < this.mSpanCount; i3++) {
            fullSpanItem.mGapPerSpan[i3] = this.mSpans[i3].getStartLine(i) - i;
        }
        return fullSpanItem;
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i = staggeredGridLayoutManager.mLayoutState.mInfinite ? layoutState.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
        ...
        while (layoutState.hasMore(state) && (r03.mLayoutState.mInfinite || !r03.mRemainingSpans.isEmpty())) {
            View next = layoutState.next(recycler);
            LayoutParams layoutParams = (LayoutParams) next.getLayoutParams();
            int viewLayoutPosition = layoutParams.getViewLayoutPosition();
            int span = r03.mLazySpanLookup.getSpan(viewLayoutPosition);
            ?? r52 = span == -1 ? 1 : r8;
            if (r52 != 0) {
                nextSpan = layoutParams.mFullSpan ? r03.mSpans[r8] : r03.getNextSpan(layoutState);
                r03.mLazySpanLookup.setSpan(viewLayoutPosition, nextSpan);
            } else {
                nextSpan = r03.mSpans[span];
            }
            Span span2 = nextSpan;
            ...
            r03.measureChildWithDecorationsAndMargin(next, layoutParams, r8);
            if (layoutState.mLayoutDirection == 1) {
                decoratedMeasurement = layoutParams.mFullSpan ? r03.getMaxEnd(endAfterPadding) : span2.getEndLine(endAfterPadding);
                minStart = r03.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement;
                if (r52 != 0 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromEnd = r03.createFullSpanItemFromEnd(decoratedMeasurement);
                    fullSpanItemCreateFullSpanItemFromEnd.mGapDir = -1;
                    fullSpanItemCreateFullSpanItemFromEnd.mPosition = viewLayoutPosition;
                    r03.mLazySpanLookup.addFullSpanItem(fullSpanItemCreateFullSpanItemFromEnd);
                }
            } else {
                minStart = layoutParams.mFullSpan ? r03.getMinStart(endAfterPadding) : span2.getStartLine(endAfterPadding);
                decoratedMeasurement = minStart - r03.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (r52 != 0 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromStart = r03.createFullSpanItemFromStart(minStart);
                    fullSpanItemCreateFullSpanItemFromStart.mGapDir = 1;
                    fullSpanItemCreateFullSpanItemFromStart.mPosition = viewLayoutPosition;
                    r03.mLazySpanLookup.addFullSpanItem(fullSpanItemCreateFullSpanItemFromStart);
                }
            }
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (r52 != 0) {
                    r03.mLaidOutInvalidFullSpan = true;
                } else {
                    if (!(layoutState.mLayoutDirection == 1 ? r03.areAllEndsEqual() : r03.areAllStartsEqual())) {
                        LazySpanLookup.FullSpanItem fullSpanItem = r03.mLazySpanLookup.getFullSpanItem(viewLayoutPosition);
            ...
            r03.attachViewToSpans(next, layoutParams, layoutState);
            if (r03.isLayoutRTL() && r03.mOrientation == 1) {
                decoratedMeasurement2 = layoutParams.mFullSpan ? r03.mSecondaryOrientation.getEndAfterPadding() : r03.mSecondaryOrientation.getEndAfterPadding() - (((r03.mSpanCount - 1) - span2.mIndex) * r03.mSizePerSpan);
                startAfterPadding = decoratedMeasurement2 - r03.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding = layoutParams.mFullSpan ? r03.mSecondaryOrientation.getStartAfterPadding() : r03.mSecondaryOrientation.getStartAfterPadding() + (span2.mIndex * r03.mSizePerSpan);
                decoratedMeasurement2 = r03.mSecondaryOrientation.getDecoratedMeasurement(next) + startAfterPadding;
            }
            int i3 = decoratedMeasurement2;
            int i4 = startAfterPadding;
            if (r03.mOrientation == 1) {
                r03.layoutDecoratedWithMargins(next, i4, decoratedMeasurement, i3, minStart);
                r02 = this;
            } else {
                r03.layoutDecoratedWithMargins(next, decoratedMeasurement, i4, minStart, i3);
                r02 = r03;
            }
            if (layoutParams.mFullSpan) {
                r02.updateAllRemainingSpans(r02.mLayoutState.mLayoutDirection, i);
            } else {
                r02.updateRemainingSpans(span2, r02.mLayoutState.mLayoutDirection, i);
            }
            r02.recycle(recycler, r02.mLayoutState);
            if (r02.mLayoutState.mStopInFocusable && next.hasFocusable()) {
                if (layoutParams.mFullSpan) {
                    r02.mRemainingSpans.clear();
                } else {
                    r02.mRemainingSpans.set(span2.mIndex, false);
                }
            }
            z6 = true;
            r8 = 0;
        ...
        if (!z6) {
            r03.recycle(recycler, r03.mLayoutState);
        }
        int startAfterPadding2 = r03.mLayoutState.mLayoutDirection == -1 ? r03.mPrimaryOrientation.getStartAfterPadding() - r03.getMinStart(r03.mPrimaryOrientation.getStartAfterPadding()) : r03.getMaxEnd(r03.mPrimaryOrientation.getEndAfterPadding()) - r03.mPrimaryOrientation.getEndAfterPadding();
    ...
    private int getMaxStart(int i) {
        ...
        for (int i3 = 1; i3 < this.mSpanCount; i3++) {
            int startLine2 = this.mSpans[i3].getStartLine(i);
    ...
    */
    ...
    private void updateAllRemainingSpans(int i, int i3) {
        for (int i4 = 0; i4 < this.mSpanCount; i4++) {
            if (!this.mSpans[i4].mViews.isEmpty()) {
                updateRemainingSpans(this.mSpans[i4], i, i3);
            }
        }
    }
    ...
    private void updateRemainingSpans(Span span, int i, int i3) {
    ...
    private int updateSpecWithExtra(int i, int i3, int i4) {
        int mode;
    ...
    public boolean checkForGaps() {
        ...
        LazySpanLookup.FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, i3, i, true);
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i5 = this.mSpanCount - 1; i5 >= 0; i5--) {
                if (i5 != span.mIndex) {
                    View viewFindViewByPosition2 = findViewByPosition(z7 ? this.mSpans[i5].findFirstPartiallyVisibleItemPosition() : this.mSpans[i5].findLastPartiallyVisibleItemPosition());
            ...
            for (int i6 = 0; i6 < this.mSpanCount; i6++) {
                View viewFindViewByPosition3 = findViewByPosition(z7 ? this.mSpans[i6].findFirstPartiallyVisibleItemPosition() : this.mSpans[i6].findLastPartiallyVisibleItemPosition());
    ...
    public void setMeasuredDimension(Rect rect, int i, int i3) {
        ...
        if (this.mOrientation == 1) {
            ...
            iChooseSize2 = RecyclerView.LayoutManager.chooseSize(i3, (this.mSizePerSpan * this.mSpanCount) + paddingBottom, getMinimumHeight());
        }
    ...
    */
    ...
    public class Span {
        ...
        public void cacheReferenceLineAndClear(boolean z6, int i) {
        ...
        public void calculateCachedEnd() {
            ...
            View view = (View) a.g(1, this.mViews);
            LayoutParams layoutParams = getLayoutParams(view);
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i, int i3, boolean z6, boolean z7, boolean z8) {
        ...
        public int findOnePartiallyVisibleChild(int i, int i3, boolean z6) {
            return findOnePartiallyOrCompletelyVisibleChild(i, i3, false, false, z6);
        }

        public int findOneVisibleChild(int i, int i3, boolean z6) {
            return findOnePartiallyOrCompletelyVisibleChild(i, i3, z6, true, false);
        }
        ...
        public View getFocusableViewAfter(int i, int i3) {
            View view = null;
            if (i3 != -1) {
    ...
    public static class LazySpanLookup {
        ...
        private void offsetFullSpansForAddition(int i, int i3) {
        ...
        private void offsetFullSpansForRemoval(int i, int i3) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return;
            }
        ...
        public FullSpanItem getFirstFullSpanItemInRange(int i, int i3, int i4, boolean z6) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return null;
            }
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (i6 >= i && (i4 == 0 || fullSpanItem.mGapDir == i4 || (z6 && fullSpanItem.mHasUnwantedGapAfter))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        public void offsetForAddition(int i, int i3) {
            int[] iArr = this.mData;
            if (iArr == null || i >= iArr.length) {
                return;
            }
            ...
            offsetFullSpansForAddition(i, i3);
        }

        public void offsetForRemoval(int i, int i3) {
            int[] iArr = this.mData;
            if (iArr == null || i >= iArr.length) {
                return;
            }
            ...
            offsetFullSpansForRemoval(i, i3);
        }
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i, int i3, boolean z6) {
        boolean zShouldMeasureChild;
        calculateItemDecorationsForChild(view, this.mTmpRect);
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i4 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
        Rect rect = this.mTmpRect;
        int iUpdateSpecWithExtra = updateSpecWithExtra(i, i4 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
