...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i, int i3) {
            return i == this.mCachedBitmap.getWidth() && i3 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i, int i3) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i, i3)) {
                this.mCachedBitmap = Bitmap.createBitmap(i, i3, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i, int i3) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i, i3, null);
        }
    ...
    public static int applyAlpha(int i, float f6) {
        return (i & ViewCompat.MEASURED_SIZE_MASK) | (((int) (Color.alpha(i) * f6)) << 24);
    }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                StringBuilder sbK = b.k(string);
                sbK.append(pathDataNodeArr[i].mType);
                sbK.append(":");
                string = sbK.toString();
                for (float f6 : pathDataNodeArr[i].mParams) {
                    StringBuilder sbK2 = b.k(string);
                    sbK2.append(f6);
                    sbK2.append(",");
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i, int i3, ColorFilter colorFilter) {
            VGroup vGroup2 = vGroup;
            vGroup2.mStackedMatrix.set(matrix);
            vGroup2.mStackedMatrix.preConcat(vGroup2.mLocalMatrix);
            canvas.save();
            int i4 = 0;
            while (i4 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i4);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i, i3, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i, i3, colorFilter);
                }
                i4++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i3, ColorFilter colorFilter) {
            float f6 = i / this.mViewportWidth;
            float f7 = i3 / this.mViewportHeight;
        ...
        public void draw(Canvas canvas, int i, int i3, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i, i3, colorFilter);
        }
