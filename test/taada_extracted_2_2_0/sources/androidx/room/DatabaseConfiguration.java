...
public class DatabaseConfiguration {
    ...
    public DatabaseConfiguration(Context context, String str, SupportSQLiteOpenHelper.Factory sqliteOpenHelperFactory, RoomDatabase.MigrationContainer migrationContainer, List<? extends RoomDatabase.Callback> list, boolean z6, RoomDatabase.JournalMode journalMode, Executor queryExecutor, Executor transactionExecutor, boolean z7, boolean z8, boolean z9, Set<Integer> set, String str2, File file, Callable<InputStream> callable, RoomDatabase.PrepackagedDatabaseCallback prepackagedDatabaseCallback, List<? extends Object> typeConverters) {
        this(context, str, sqliteOpenHelperFactory, migrationContainer, list, z6, journalMode, queryExecutor, transactionExecutor, z7 ? new Intent(context, (Class<?>) MultiInstanceInvalidationService.class) : null, z8, z9, set, str2, file, callable, prepackagedDatabaseCallback, typeConverters, u.f3805a);
        h.f(context, "context");
        h.f(sqliteOpenHelperFactory, "sqliteOpenHelperFactory");
        h.f(migrationContainer, "migrationContainer");
        h.f(journalMode, "journalMode");
