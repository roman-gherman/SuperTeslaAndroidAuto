...
public abstract class q {
    ...
    public static o3.n a(int i, EnumC0743a enumC0743a, int i3) {
        ...
        int i4 = i3 & 2;
        EnumC0743a enumC0743a2 = EnumC0743a.f4321a;
        if (i4 != 0) {
    ...
    */
    public static final java.lang.Object g(java.util.ArrayList r5, io.ktor.utils.io.ByteReadChannel r6, F1.a r7, java.nio.charset.Charset r8, U1.c r9) throws A.a {
        ...
        L18:
            ...
            if (r2 != r4) goto L2c
            F1.a r7 = r0.b
            io.ktor.utils.io.ByteReadChannel r6 = r0.f5109a
    ...
    public static final void q(u1.y yVar, u1.y url) {
        ...
        yVar.b = str;
        yVar.c = url.c;
        List list = url.f4882h;
        kotlin.jvm.internal.h.f(list, "<set-?>");
        yVar.f4882h = list;
        yVar.e = url.e;
        yVar.f4880f = url.f4880f;
        w wVarA = Z.a();
        b(wVarA, url.i);
        yVar.i = wVarA;
        yVar.f4883j = new B(wVarA);
        String str2 = url.f4881g;
