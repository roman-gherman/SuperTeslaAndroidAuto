...
public final class b implements Continuation {
    ...
    public final CoroutineContext f3596a;
    public final /* synthetic */ c b;

    public b(c cVar) {
        this.b = cVar;
        Job job = cVar.f3598a;
        this.f3596a = job != null ? o.f3611a.plus(job) : o.f3611a;
    }
    ...
    public final void resumeWith(Object obj) {
        ...
        do {
            ...
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = c.f3597f;
            while (true) {
        ...
        if ((obj instanceof N1.g) && !(N1.h.a(obj) instanceof CancellationException) && (job = this.b.f3598a) != null) {
