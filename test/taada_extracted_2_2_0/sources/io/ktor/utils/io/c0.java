...
public final class c0 implements ReaderJob, WriterJob, Job {
    ...
    public final ChildHandle attachChild(ChildJob child) {
        ...
        return this.f3563a.attachChild(child);
    }
    ...
    public final void cancel(CancellationException cancellationException) throws IllegalAccessException, InvocationTargetException {
        this.f3563a.cancel(cancellationException);
    }

    @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
    public final Object fold(Object obj, Function2 operation) {
        kotlin.jvm.internal.h.f(operation, "operation");
        return kotlin.coroutines.a.a(this.f3563a, obj, operation);
    }

    @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
    public final CoroutineContext.Element get(CoroutineContext.Key key) {
        kotlin.jvm.internal.h.f(key, "key");
        return kotlin.coroutines.a.b(this.f3563a, key);
    }

    @Override // kotlinx.coroutines.Job
    public final CancellationException getCancellationException() {
        return this.f3563a.getCancellationException();
    }
    ...
    public final Sequence getChildren() {
        return this.f3563a.getChildren();
    }
    ...
    public final SelectClause0 getOnJoin() {
        return this.f3563a.getOnJoin();
    }

    @Override // kotlinx.coroutines.Job
    public final Job getParent() {
        return this.f3563a.getParent();
    }

    @Override // kotlinx.coroutines.Job
    public final DisposableHandle invokeOnCompletion(boolean z6, boolean z7, Function1 handler) {
        kotlin.jvm.internal.h.f(handler, "handler");
        return this.f3563a.invokeOnCompletion(z6, z7, handler);
    }
    ...
    public final boolean isCancelled() {
        return this.f3563a.isCancelled();
    }

    @Override // kotlinx.coroutines.Job
    public final boolean isCompleted() {
        return this.f3563a.isCompleted();
    }

    @Override // kotlinx.coroutines.Job
    public final Object join(Continuation continuation) {
        return this.f3563a.join(continuation);
    }

    @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
    public final CoroutineContext minusKey(CoroutineContext.Key key) {
        kotlin.jvm.internal.h.f(key, "key");
        return kotlin.coroutines.a.c(this.f3563a, key);
    }
    ...
    public final DisposableHandle invokeOnCompletion(Function1 handler) {
        kotlin.jvm.internal.h.f(handler, "handler");
        return this.f3563a.invokeOnCompletion(false, true, handler);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public final CoroutineContext plus(CoroutineContext context) {
        kotlin.jvm.internal.h.f(context, "context");
        return kotlin.coroutines.a.d(this.f3563a, context);
    }

    @Override // kotlinx.coroutines.Job
    public final /* synthetic */ void cancel() throws IllegalAccessException, InvocationTargetException {
        this.f3563a.cancel((CancellationException) null);
    }
}
