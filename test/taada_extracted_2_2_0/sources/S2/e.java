...
public final class e implements KotlinJvmBinaryClass {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof e) {
            return kotlin.jvm.internal.h.a(this.f4769a, ((e) obj).f4769a);
        }
        return false;
    }
    ...
    public final L2.b getClassId() {
        return AbstractC0823e.a(this.f4769a);
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.kotlin.KotlinJvmBinaryClass
    public final String getLocation() {
        return r.A(this.f4769a.getName(), TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH, ClassPathElement.SEPARATOR_CHAR).concat(".class");
    }
