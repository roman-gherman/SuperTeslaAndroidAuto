    ...
    public Serialization serializeKey(com.google.crypto.tink.b bVar, com.google.crypto.tink.n nVar) throws GeneralSecurityException {
        switch (this.f225a) {
            ...
            default:
                ...
                return C0.r.a("type.googleapis.com/google.crypto.tink.AesEaxKey", ((C0095x) c0093wW.build()).toByteString(), EnumC0046d1.SYMMETRIC, v0.h.b(eVar.f4897a.d), eVar.c);
        }
    }
    ...
    public Serialization serializeParameters(com.google.crypto.tink.i iVar) {
        switch (this.f225a) {
            ...
            case 25:
                ...
                c0097yV.p();
                C0099z.u((C0099z) c0097yV.b, gVar2.f4909a);
