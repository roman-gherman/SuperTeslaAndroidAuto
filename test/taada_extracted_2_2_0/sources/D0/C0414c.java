...
public final class C0414c extends f implements Drawable.Callback, TextDrawableHelper$TextDrawableDelegate {
    ...
    public C0414c(Context context, AttributeSet attributeSet) {
        ...
        this.f3075C0 = true;
        int[] iArr2 = AbstractC0615a.f3957a;
        f3070G0.setTint(-1);
    }
    ...
    public final void D(float f6) {
        if (this.f3071A != f6) {
            this.f3071A = f6;
            i iVarE = this.f4178a.f4166a.e();
            iVarE.e = new C0695a(f6);
            iVarE.f4195f = new C0695a(f6);
            iVarE.f4196g = new C0695a(f6);
            iVarE.f4197h = new C0695a(f6);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f3078E0) {
            ...
            e eVar = this.f4178a;
            this.f4189r.a(eVar.f4166a, eVar.i, rectF2, this.q, path);
            d(canvas2, paint, path, this.f4178a.f4166a, f());
        } else {
            canvas2.drawRoundRect(rectF, u(), u(), paint);
        }
        if (U()) {
    ...
    public final boolean isStateful() {
        ...
        if (fVar == null || (colorStateList = fVar.f3686j) == null || !colorStateList.isStateful()) {
    ...
    public final boolean y(int[] iArr, int[] iArr2) {
        ...
        if ((this.f3105n0 != iCompositeColors) | (this.f4178a.c == null)) {
        ...
        k0.f fVar = this.f3102k0.f2504f;
        int colorForState3 = (fVar == null || (colorStateList = fVar.f3686j) == null) ? 0 : colorStateList.getColorForState(iArr, this.f3107q0);
        ...
        int[] iArr4 = AbstractC0615a.f3957a;
        if (w(this.f3083M)) {
