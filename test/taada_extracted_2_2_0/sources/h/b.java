...
public final class b implements ServiceConnection {
    ...
    public final PlayReferrerAttributionService$getReferrerFromPlayStore$2$1 f3348a;
    ...
    public b(c cVar, PlayReferrerAttributionService$getReferrerFromPlayStore$2$1 playReferrerAttributionService$getReferrerFromPlayStore$2$1) {
        this.b = cVar;
        this.f3348a = playReferrerAttributionService$getReferrerFromPlayStore$2$1;
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        int i = AbstractBinderC0861b.f4957a;
        if (iBinder == null) {
            c0860a = null;
        } else {
