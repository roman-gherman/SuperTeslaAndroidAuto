...
public final class C0661m implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public static final /* synthetic */ KProperty[] f4096g;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final C0763B f4097a;
    ...
    public final NotNullLazyValue f4098f;
    ...
    public C0661m(C0763B c0763b, Z2.n nVar, C0022d c0022d) {
        ...
        c0775l.e(U2.m.f1338a, kotlin.collections.w.f3807a, null);
        ...
        this.f4098f = nVar.createLazyValue(new C0660l(this, 1));
    }

    public final C0029k a(ClassDescriptor classDescriptor) {
        L2.f fVar = k2.i.f3710f;
        if (k2.i.b(classDescriptor, k2.o.f3743a) || !k2.i.I(classDescriptor)) {
            return null;
        }
        ...
        ClassDescriptor classDescriptorJ = AbstractC0718j.j(b().f4090a, bVarF.b());
    ...
    public final C0656h b() {
        return (C0656h) AbstractC0246d.T(this.b, f4096g[0]);
    }
    ...
    public final Collection getConstructors(ClassDescriptor classDescriptor) {
        ...
        if (kind == enumC0711c) {
            ...
            if (c0029kA != null && (classDescriptorB = C0653e.b(R2.e.g(c0029kA), C0650b.f4073g)) != null) {
                ...
                for (ClassConstructorDescriptor classConstructorDescriptor2 : arrayList) {
                    ...
                    if (!C0663o.f4101f.contains(C5.f.b0(c0029kA, E1.k.o(classConstructorDescriptor2, 3)))) {
                        copyBuilderNewCopyBuilder.setAdditionalAnnotations((Annotations) AbstractC0246d.T(this.f4098f, f4096g[2]));
                    }
    ...
    */
    ...
    public final Collection getFunctionsNames(ClassDescriptor classDescriptor) {
        ...
        kotlin.jvm.internal.h.f(classDescriptor, "classDescriptor");
        b().getClass();
        kotlin.collections.w wVar = kotlin.collections.w.f3807a;
        C0029k c0029kA = a(classDescriptor);
    ...
    public final Collection getSupertypes(ClassDescriptor classDescriptor) {
        ...
        kotlin.jvm.internal.h.f(classDescriptor, "classDescriptor");
        L2.e eVarH = R2.e.h(classDescriptor);
        LinkedHashSet linkedHashSet = C0663o.f4100a;
        L2.e eVar = k2.o.f3748g;
        boolean z6 = eVarH.equals(eVar) || k2.o.f3746c0.get(eVarH) != null;
        F f6 = this.c;
        if (z6) {
            F cloneableType = (F) AbstractC0246d.T(this.d, f4096g[1]);
            kotlin.jvm.internal.h.e(cloneableType, "cloneableType");
            return kotlin.collections.n.y(cloneableType, f6);
        }
        if (!eVarH.equals(eVar) && k2.o.f3746c0.get(eVarH) == null) {
            String str = C0652d.f4075a;
            L2.b bVarF = C0652d.f(eVarH);
            if (bVarF == null) {
        ...
        return zIsAssignableFrom ? Z.p(f6) : u.f3805a;
    }
    ...
    public final boolean isFunctionAvailable(ClassDescriptor classDescriptor, SimpleFunctionDescriptor functionDescriptor) {
        ...
        C0029k c0029kA = a(classDescriptor);
        if (c0029kA == null || !functionDescriptor.getAnnotations().hasAnnotation(AbstractC0757b.f4473a)) {
            return true;
        }
        b().getClass();
        ...
        Collection contributedFunctions = rVarE.getContributedFunctions(name, EnumC0851b.f4934a);
