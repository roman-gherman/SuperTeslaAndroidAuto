...
public final class C0653e implements DFS$Neighbors {
    ...
    public static ClassDescriptor b(L2.c cVar, k2.i builtIns) {
        ...
        String str = C0652d.f4075a;
        L2.b bVar = (L2.b) C0652d.f4078h.get(cVar.i());
        if (bVar != null) {
    ...
    public Iterable getNeighbors(Object obj) {
        KProperty[] kPropertyArr = C0661m.f4096g;
