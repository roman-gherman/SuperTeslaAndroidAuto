...
public final class s extends n implements DescriptorRendererOptions {
    ...
    */
    public static n2.EnumC0719k j(kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor r6) {
        ...
        L41:
            ...
            n2.d r2 = n2.AbstractC0713e.f4233a
    ...
    public final void B(StringBuilder sb, CallableMemberDescriptor callableMemberDescriptor) {
        if (N2.f.s(callableMemberDescriptor) && callableMemberDescriptor.getModality() == EnumC0719k.f4248a) {
            return;
        }
        x xVar = this.d;
    ...
    public final void F(StringBuilder sb, AbstractC0162z abstractC0162z) {
        ...
        if (c0VarF instanceof a3.F) {
            ...
            sb.append("(");
            if (!b0.u(f6) || f6.getAnnotations().findAnnotation(k2.o.f3756p) == null || f6.a().size() > 1) {
                int i = 0;
    ...
    */
    ...
    public final boolean V(AbstractC0714f abstractC0714f, StringBuilder sb) {
        ...
        if (((Boolean) xVar.f1103n.getValue(xVar, kPropertyArr[12])).booleanValue()) {
            abstractC0714f = AbstractC0713e.g(((C0712d) abstractC0714f).f4232a.c());
        }
        if (!((Boolean) xVar.f1104o.getValue(xVar, kPropertyArr[13])).booleanValue() && abstractC0714f.equals(AbstractC0713e.f4238k)) {
            return false;
        }
        sb.append(w(((C0712d) abstractC0714f).f4232a.b()));
        sb.append(" ");
        return true;
    }
    ...
    public final void m(StringBuilder sb, Annotated annotated, EnumC0739c enumC0739c) {
        if (e().contains(t.ANNOTATIONS)) {
            ...
            for (AnnotationDescriptor annotationDescriptor : annotated.getAnnotations()) {
                if (!kotlin.collections.m.L(annotationDescriptor.getFqName(), excludedTypeAnnotationClasses) && !kotlin.jvm.internal.h.a(annotationDescriptor.getFqName(), k2.o.f3757r) && (function1 == null || ((Boolean) function1.invoke(annotationDescriptor)).booleanValue())) {
    ...
    */
    ...
    public final String t(String lowerRendered, String upperRendered, k2.i iVar) {
        ...
        String strV = kotlin.text.i.V(d().renderClassifier(iVar.i(k2.o.f3726B), this), "Collection");
    ...
    public final void x(StringBuilder sb, CallableMemberDescriptor callableMemberDescriptor) {
        if (e().contains(t.MEMBER_KIND) && i() && callableMemberDescriptor.getKind() != EnumC0709a.f4227a) {
            sb.append("/*");
