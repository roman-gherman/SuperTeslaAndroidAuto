...
public class C0672f extends F implements CancellableContinuation, CoroutineStackFrame, Waiter {
    ...
    public static final AtomicIntegerFieldUpdater f4124f = AtomicIntegerFieldUpdater.newUpdater(C0672f.class, "_decisionAndIndex");

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final AtomicReferenceFieldUpdater f4125g = AtomicReferenceFieldUpdater.newUpdater(C0672f.class, Object.class, "_state");

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final AtomicReferenceFieldUpdater f4126h = AtomicReferenceFieldUpdater.newUpdater(C0672f.class, Object.class, "_parentHandle");
    ...
    public final void a(Object obj, CancellationException cancellationException) {
        ...
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4125g;
    ...
    public final Object d(Object obj) {
        return obj instanceof C0676j ? ((C0676j) obj).f4133a : obj;
    }

    @Override // m3.F
    public final Object f() {
        return f4125g.get(this);
    }
    ...
    public final void i(r3.u uVar, Throwable th) {
        ...
        int i = f4124f.get(this) & 536870911;
        if (i == 536870911) {
    ...
    public final void invokeOnCancellation(r3.u uVar, int i) {
        ...
        int i3;
        do {
            atomicIntegerFieldUpdater = f4124f;
    ...
    public final boolean isActive() {
        return f4125g.get(this) instanceof NotCompleted;
    }

    @Override // kotlinx.coroutines.CancellableContinuation
    public final boolean isCancelled() {
        return f4125g.get(this) instanceof C0673g;
    }
    ...
    public final void j() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4126h;
    ...
    public final Object m() {
        ...
        do {
            ...
            if (i3 != 0) {
                ...
                Object obj = f4125g.get(this);
                if (obj instanceof C0677k) {
                    throw ((C0677k) obj).f4134a;
                }
                int i4 = this.c;
                if (i4 == 1 || i4 == 2) {
        ...
        if (((DisposableHandle) f4126h.get(this)) == null) {
            n();
        }
        if (zP) {
            s();
    ...
    public final DisposableHandle n() {
        ...
        do {
            atomicReferenceFieldUpdater = f4126h;
    ...
    public final boolean p() {
        ...
        return r3.h.f4708h.get((r3.h) continuation) != null;
    }
