...
public final class j implements Annotations {
    ...
    public final Annotations f4293a;
    public final X b;

    public j(Annotations annotations, X x) {
        this.f4293a = annotations;
        this.b = x;
    }
    ...
    public final AnnotationDescriptor findAnnotation(L2.c fqName) {
        ...
        if (((Boolean) this.b.invoke(fqName)).booleanValue()) {
            return this.f4293a.findAnnotation(fqName);
        }
        return null;
    }
    ...
    public final boolean hasAnnotation(L2.c fqName) {
        kotlin.jvm.internal.h.f(fqName, "fqName");
        if (((Boolean) this.b.invoke(fqName)).booleanValue()) {
            return this.f4293a.hasAnnotation(fqName);
        }
        return false;
    }
    ...
    public final boolean isEmpty() {
        Annotations annotations = this.f4293a;
    ...
    public final Iterator<AnnotationDescriptor> iterator() {
        ...
        for (AnnotationDescriptor annotationDescriptor : this.f4293a) {
