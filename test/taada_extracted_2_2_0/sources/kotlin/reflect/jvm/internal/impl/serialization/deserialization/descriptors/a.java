...
public class a implements Annotations {
    ...
    public final NotNullLazyValue f3887a;
    ...
    public a(StorageManager storageManager, Function0 function0) {
        ...
        this.f3887a = storageManager.createLazyValue(function0);
    }
    ...
    public boolean isEmpty() {
        return ((List) AbstractC0246d.T(this.f3887a, b[0])).isEmpty();
    }

    @Override // java.lang.Iterable
    public final Iterator<AnnotationDescriptor> iterator() {
        return ((List) AbstractC0246d.T(this.f3887a, b[0])).iterator();
    }
}
