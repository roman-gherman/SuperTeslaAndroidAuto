...
public final class s extends AbstractList implements RandomAccess, LazyStringList {
    ...
    public final void add(int i, Object obj) {
        this.f3876a.add(i, (String) obj);
        ((AbstractList) this).modCount++;
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
    public final boolean addAll(Collection collection) {
        return addAll(this.f3876a.size(), collection);
    }
    ...
    public final Object remove(int i) {
        Object objRemove = this.f3876a.remove(i);
        ((AbstractList) this).modCount++;
    ...
    public final Object set(int i, Object obj) {
        Object obj2 = this.f3876a.set(i, (String) obj);
    ...
    public s(LazyStringList lazyStringList) {
        this.f3876a = new ArrayList(lazyStringList.size());
    ...
    public final boolean addAll(int i, Collection collection) {
        ...
        boolean zAddAll = this.f3876a.addAll(i, collection);
        ((AbstractList) this).modCount++;
        return zAddAll;
    }
    ...
    public final void add(AbstractC0604e abstractC0604e) {
        this.f3876a.add(abstractC0604e);
        ((AbstractList) this).modCount++;
    }
}
