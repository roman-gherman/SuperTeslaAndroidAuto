...
public final class o extends L implements DeserializedCallableMemberDescriptor {
    ...
    public final NameResolver f3925F;

    /* JADX INFO: renamed from: G, reason: collision with root package name */
    public final I2.f f3926G;
    public final I2.g H;
    public final E2.g I;
    ...
    public final v i(L2.f name, DeclarationDescriptor newOwner, FunctionDescriptor functionDescriptor, SourceElement sourceElement, Annotations annotations, EnumC0709a kind) {
        ...
        o oVar = new o(newOwner, simpleFunctionDescriptor, annotations, name, kind, this.E, this.f3925F, this.f3926G, this.H, this.I, sourceElement);
        oVar.f4643w = this.f4643w;
        return oVar;
    }
}
