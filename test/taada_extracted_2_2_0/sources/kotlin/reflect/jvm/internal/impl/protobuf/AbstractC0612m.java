...
public abstract class AbstractC0612m extends p implements GeneratedMessageLite$ExtendableMessageOrBuilder {
    ...
    public final C0609j f3871a;

    public AbstractC0612m() {
        this.f3871a = new C0609j();
    }
    ...
    public final boolean e(o oVar) {
        h(oVar);
        C0609j c0609j = this.f3871a;
        c0609j.getClass();
        C0613n c0613n = oVar.d;
        if (c0613n.c) {
            throw new IllegalArgumentException("hasField() can only be called on non-repeated fields.");
        }
        return c0609j.f3869a.get(c0613n) != null;
    }
    ...
    */
    ...
    public final void h(o oVar) {
        if (oVar.f3873a != getDefaultInstanceForType()) {
