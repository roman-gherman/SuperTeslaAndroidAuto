...
public final class E implements Comparable, Map.Entry {
    ...
    public final Comparable f3845a;
    public Object b;
    public final /* synthetic */ A c;

    public E(A a6, Comparable comparable, Object obj) {
        this.c = a6;
        this.f3845a = comparable;
        this.b = obj;
    }

    @Override // java.lang.Comparable
    public final int compareTo(Object obj) {
        return this.f3845a.compareTo(((E) obj).f3845a);
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof Map.Entry) {
                ...
                Comparable comparable = this.f3845a;
    ...
    public final String toString() {
        String strValueOf = String.valueOf(this.f3845a);
