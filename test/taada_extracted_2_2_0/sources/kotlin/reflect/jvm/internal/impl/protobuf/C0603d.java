...
public final class C0603d extends OutputStream {
    ...
    public static final byte[] f3859f = new byte[0];
    public int c;
    public int e;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final int f3860a = 128;
    ...
    public final void a(int i) {
        ...
        this.c = length;
        this.d = new byte[Math.max(this.f3860a, Math.max(i, length >>> 1))];
        this.e = 0;
    }
    ...
    public final synchronized AbstractC0604e c() {
        ...
        return arrayList.isEmpty() ? AbstractC0604e.f3861a : AbstractC0604e.a(arrayList.iterator(), arrayList.size());
    }
