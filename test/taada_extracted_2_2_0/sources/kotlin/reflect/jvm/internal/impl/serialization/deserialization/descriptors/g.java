...
public final class g extends AbstractC0765b implements DeserializedDescriptor {
    ...
    public final I2.a f3895f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final SourceElement f3896g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final L2.b f3897h;
    public final EnumC0719k i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final C0712d f3898j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final EnumC0711c f3899k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final X2.i f3900l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final U2.n f3901m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final C0027i f3902n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final t f3903o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final C0.t f3904p;
    public final DeclarationDescriptor q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final NullableLazyValue f3905r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final NotNullLazyValue f3906s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public final NullableLazyValue f3907t;
    public final NotNullLazyValue u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final NullableLazyValue f3908v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final X2.p f3909w;
    ...
    public g(X2.i outerContext, C0111k classProto, NameResolver nameResolver, I2.a aVar, SourceElement sourceElement) {
        ...
        this.e = classProto;
        this.f3895f = aVar;
        this.f3896g = sourceElement;
        this.f3897h = kotlin.reflect.l.w(nameResolver, classProto.e);
        this.i = X2.h.b((B) I2.e.e.c(classProto.d));
        this.f3898j = C5.f.s((k0) I2.e.d.c(classProto.d));
        EnumC0110j enumC0110j = (EnumC0110j) I2.e.f774f.c(classProto.d);
        int i4 = enumC0110j == null ? -1 : s.b[enumC0110j.ordinal()];
        EnumC0711c enumC0711c2 = EnumC0711c.f4229a;
        ...
        this.f3901m = enumC0711c == enumC0711c3 ? new U2.p(gVar2.f1418a, this) : U2.m.f1338a;
        this.f3902n = new C0027i(this);
        v vVar = t.e;
        ...
        this.f3903o = new t(this, storageManager, c0031m, kotlinTypeRefinerForOwnerModule);
        this.f3904p = enumC0711c == enumC0711c3 ? new C0.t(this) : null;
        ...
        this.f3905r = storageManager2.createNullableLazyValue(fVar2);
        this.f3906s = storageManager2.createLazyValue(new f(this, 3));
        this.f3907t = storageManager2.createNullableLazyValue(new f(this, 2));
        this.u = storageManager2.createLazyValue(new f(this, 5));
        this.f3908v = storageManager2.createNullableLazyValue(new f(this, i));
        g gVar3 = declarationDescriptor instanceof g ? (g) declarationDescriptor : null;
        this.f3909w = new X2.p(classProto, iVarA.b, iVarA.d, sourceElement, gVar3 != null ? gVar3.f3909w : null);
    ...
    public final MemberScope b(b3.d dVar) {
        ...
        tVar.getClass();
        R2.e.j(tVar.f4259a);
        return (MemberScope) AbstractC0246d.T(tVar.d, t.f4258f[0]);
    }

    public final e e() {
        b3.d kotlinTypeRefiner = this.f3900l.f1433a.q.getKotlinTypeRefiner();
        t tVar = this.f3903o;
        tVar.getClass();
        kotlin.jvm.internal.h.f(kotlinTypeRefiner, "kotlinTypeRefiner");
        R2.e.j(tVar.f4259a);
        return (e) ((MemberScope) AbstractC0246d.T(tVar.d, t.f4258f[0]));
    }

    public final F f(L2.f fVar) {
        Iterator it = e().getContributedVariables(fVar, EnumC0851b.f4936g).iterator();
        boolean z6 = false;
        Object obj = null;
        while (true) {
            if (!it.hasNext()) {
    ...
    public final ClassDescriptor getCompanionObjectDescriptor() {
        return (ClassDescriptor) this.f3907t.invoke();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final Collection getConstructors() {
        return (Collection) this.f3906s.invoke();
    }
    ...
    public final List getDeclaredTypeParameters() {
        return kotlin.collections.m.o0(this.f3900l.f1436h.f1457g.values());
    }
    ...
    public final ClassConstructorDescriptor getUnsubstitutedPrimaryConstructor() {
        return (ClassConstructorDescriptor) this.f3905r.invoke();
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public final z getValueClassRepresentation() {
        return (z) this.f3908v.invoke();
    }
    ...
    public final boolean isValue() {
        return I2.e.f778k.c(this.e.d).booleanValue() && this.f3895f.a(1, 4, 2);
    }
