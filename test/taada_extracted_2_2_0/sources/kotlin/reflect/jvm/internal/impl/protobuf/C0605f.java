...
public final class C0605f {
    ...
    public C0605f(InputStream inputStream) {
        this.f3865h = Integer.MAX_VALUE;
        this.f3862a = new byte[4096];
        this.b = 0;
        this.d = 0;
        this.f3864g = 0;
        this.e = inputStream;
    ...
    public final u e() {
        ...
        int i3 = this.d;
        if (iK > i - i3 || iK <= 0) {
            return iK == 0 ? AbstractC0604e.f3861a : new u(h(iK));
        }
        byte[] bArr = new byte[iK];
        System.arraycopy(this.f3862a, i3, bArr, 0, iK);
        u uVar = new u(bArr);
        this.d += iK;
        return uVar;
    }
    ...
    */
    ...
    public final boolean s(int i) throws IOException {
        ...
        if (this.f3864g + i3 + i <= this.f3865h && (inputStream = this.e) != null) {
            byte[] bArr = this.f3862a;
            if (i3 > 0) {
                if (i5 > i3) {
            ...
            if (i7 > 0) {
                this.b += i7;
                if ((this.f3864g + i) - AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL > 0) {
