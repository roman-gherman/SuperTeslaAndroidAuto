...
public final class h implements ParameterizedType, TypeImpl {
    ...
    public final boolean equals(Object obj) {
        ...
        if (kotlin.jvm.internal.h.a(this.f3827a, parameterizedType.getRawType()) && kotlin.jvm.internal.h.a(this.b, parameterizedType.getOwnerType())) {
    ...
    public final String getTypeName() {
        ...
        Type[] typeArr = this.c;
        if (typeArr.length != 0) {
            kotlin.collections.j.F(typeArr, sb, ", ", "<", ">", "...", g.f3826a);
        }
    ...
    public final int hashCode() {
        int iHashCode = this.f3827a.hashCode();
        Type type = this.b;
