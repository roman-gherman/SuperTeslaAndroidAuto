...
public abstract class AbstractC0792a {
    ...
    public static final int[] f4679a = {R.attr.theme, fr.sd.taada.R.attr.theme};
    ...
    public static Context a(Context context, AttributeSet attributeSet, int i, int i3) {
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, f4679a);
