...
public final class C0242a extends C0775l {
    ...
    public C0242a(L2.f fVar) {
        ...
        C0773j c0773j = new C0773j(this, null, o2.f.b, true, EnumC0709a.f4226a, sourceElement);
        ...
        c0773j.f4629g = new g(j.d(iVar, new String[0]), fVarB, iVar, list, false, new String[0]);
