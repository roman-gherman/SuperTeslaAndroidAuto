...
public final class d extends B4.a {
    ...
    public d(c cVar, byte[] bArr, e eVar) {
        ...
        int i4 = c0948a.e;
        int i5 = c0948a.f5206f;
        if (length == 64) {
            byte[] bArrH = g5.c.h(bArr, 0, 32);
            byte[] bArrH2 = g5.c.h(bArr, 32, bArr.length);
            b bVar = c0948a.f5205a;
            C0948a c0948a2 = bVar.f5209a;
            ...
            dVar.e = bArr14[4];
            i3 = 0;
            dVar.f5212f = bArr14[0];
            dVar.f5213g = bArr14[1];
            dVar.f5214h = bArr14[5];
        } else {
            dVar = this;
            i = 2;
            i3 = 0;
            dVar.c = g5.c.h(bArr, 0, i5);
            dVar.f5212f = g5.c.h(bArr, i5, (i5 + i4) - 32);
            int i32 = (i4 - 32) + i5;
            int i33 = i32 + 32;
            dVar.f5213g = g5.c.h(bArr, i32, i33);
            int i34 = i32 + 64;
            dVar.d = g5.c.h(bArr, i33, i34);
            dVar.e = g5.c.h(bArr, i34, i32 + 96);
            dVar.f5214h = null;
        }
        if (eVar != null && (!g5.c.g(dVar.f5212f, eVar.c) || !g5.c.g(dVar.f5213g, eVar.d))) {
            throw new IllegalArgumentException("passed in public key does not match private values");
        }
        dVar.i = dVar.f5214h == null ? i : i3;
    }

    public final byte[] getEncoded() {
        return g5.c.f(new byte[][]{this.c, this.f5212f, this.f5213g, this.d, this.e});
    }
    ...
    public d(d dVar, int i) {
        super(dVar.b, true);
        this.c = dVar.c;
        this.f5212f = dVar.f5212f;
        this.f5213g = dVar.f5213g;
        this.d = dVar.d;
        this.e = dVar.e;
        this.f5214h = dVar.f5214h;
        this.i = i;
    }
}
