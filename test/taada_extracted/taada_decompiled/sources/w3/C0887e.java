...
public class C0887e extends AbstractC0899q {
    ...
    public C0887e(int i) {
        ...
        this.f5052a = BigInteger.valueOf(i).toByteArray();
    }
    ...
    public final boolean b(AbstractC0899q abstractC0899q) {
        ...
        return Arrays.equals(this.f5052a, ((C0887e) abstractC0899q).f5052a);
    }

    @Override // w3.AbstractC0899q
    public final void c(C0898p c0898p, boolean z6) {
        c0898p.m(this.f5052a, 10, z6);
    }
    ...
    public C0887e(byte[] bArr, boolean z6) {
        ...
        int i = 0;
        if ((bArr[0] & 128) == 0) {
            this.f5052a = z6 ? g5.c.c(bArr) : bArr;
