...
public final class Z extends AbstractC0902u {
        ...
        switch (this.c) {
            case 0:
                ...
                if (this.d >= 0 || length > 16) {
                    c0898p.k(s());
                    while (i < length) {
                        this.f5073a[i].toASN1Primitive().h().c(xC, true);
                        i++;
                    }
                } else {
                    ...
                    for (int i3 = 0; i3 < length; i3++) {
                        AbstractC0899q abstractC0899qH = this.f5073a[i3].toASN1Primitive().h();
            ...
            default:
                c0898p.p(48, z6);
                j0 j0VarD = c0898p.d();
                int length2 = this.f5073a.length;
                int i4 = 0;
                if (this.d >= 0 || length2 > 16) {
                    c0898p.k(t());
                    while (i4 < length2) {
                        j0VarD.q(this.f5073a[i4].toASN1Primitive());
                        i4++;
                    }
                } else {
                    ...
                    for (int i5 = 0; i5 < length2; i5++) {
                        AbstractC0899q abstractC0899qI = this.f5073a[i5].toASN1Primitive().i();
    ...
    public int s() {
        if (this.d < 0) {
            ...
            for (int i = 0; i < length; i++) {
                iE += this.f5073a[i].toASN1Primitive().h().e(true);
            }
            this.d = iE;
        }
        return this.d;
    ...
    public int t() {
        if (this.d < 0) {
            ...
            int iE = 0;
            for (int i = 0; i < length; i++) {
                iE += this.f5073a[i].toASN1Primitive().i().e(true);
            }
            this.d = iE;
        }
        return this.d;
