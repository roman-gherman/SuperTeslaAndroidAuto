...
public final class H extends AbstractC0899q implements ASN1TaggedObjectParser {
    ...
    public H(int i, int i3, int i4, ASN1Encodable aSN1Encodable) {
        ...
        this.f5031a = aSN1Encodable instanceof ASN1Choice ? 1 : i;
        this.b = i3;
        this.c = i4;
    ...
    public final boolean b(AbstractC0899q abstractC0899q) {
        ...
        if (this.f5031a != h3.f5031a && m() != h3.m()) {
            return false;
        }
    ...
    public AbstractC0899q h() {
        switch (this.e) {
            case 1:
                return this;
            default:
                return new H(this.f5031a, this.b, this.c, this.d, 1);
        }
    }
    ...
    public AbstractC0899q i() {
        switch (this.e) {
            ...
            case 2:
                return this;
            default:
                return new H(this.f5031a, this.b, this.c, this.d, 2);
        }
    }
    ...
    public final ASN1TaggedObjectParser parseImplicitBaseTagged(int i, int i3) {
        ...
        switch (this.e) {
            case 0:
                h3 = new H(this.f5031a, i, i3, this.d, 0);
                break;
            case 1:
                h3 = new H(this.f5031a, i, i3, this.d, 1);
                break;
            default:
                return new H(this.f5031a, i, i3, this.d, 2);
        }
        return h3;
    }
