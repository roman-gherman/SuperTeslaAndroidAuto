...
public class C0886d {
    ...
    public final void a(ASN1Encodable aSN1Encodable) {
        ...
        ASN1Encodable[] aSN1EncodableArr = this.f5050a;
        int length = aSN1EncodableArr.length;
        int i = this.b + 1;
        if (this.c | (i > length)) {
            ASN1Encodable[] aSN1EncodableArr2 = new ASN1Encodable[Math.max(aSN1EncodableArr.length, (i >> 1) + i)];
            System.arraycopy(this.f5050a, 0, aSN1EncodableArr2, 0, this.b);
            this.f5050a = aSN1EncodableArr2;
            this.c = false;
        }
        this.f5050a[this.b] = aSN1Encodable;
        this.b = i;
    }
    ...
    public C0886d(int i) {
        ...
        this.f5050a = i == 0 ? d : new ASN1Encodable[i];
        this.b = 0;
        this.c = false;
    }
}
