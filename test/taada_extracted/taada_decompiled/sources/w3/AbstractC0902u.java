...
public abstract class AbstractC0902u extends AbstractC0899q implements Iterable {
    ...
    public ASN1Encodable[] f5073a;

    public AbstractC0902u() {
        this.f5073a = C0886d.d;
    }
        ...
        if (abstractC0899q instanceof AbstractC0902u) {
            ...
            if (abstractC0902u.size() == size) {
                for (int i = 0; i < size; i++) {
                    AbstractC0899q aSN1Primitive = this.f5073a[i].toASN1Primitive();
                    AbstractC0899q aSN1Primitive2 = abstractC0902u.f5073a[i].toASN1Primitive();
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            iHashCode = (iHashCode * 257) ^ this.f5073a[length].toASN1Primitive().hashCode();
        }
    }

    @Override // w3.AbstractC0899q
    public AbstractC0899q i() {
        Z z6 = new Z(this.f5073a, 1);
        z6.d = -1;
        return z6;
    }

    public Iterator iterator() {
        return new g5.a(this.f5073a);
    }
    ...
    public final AbstractC0884b[] j() {
        ...
        for (int i = 0; i < size; i++) {
            abstractC0884bArr[i] = AbstractC0884b.m(this.f5073a[i]);
        }
    ...
    public final AbstractC0897o[] k() {
        ...
        for (int i = 0; i < size; i++) {
            abstractC0897oArr[i] = AbstractC0897o.j(this.f5073a[i]);
        }
    ...
    public final String toString() {
        ...
        int i = 0;
        while (true) {
            stringBuffer.append(this.f5073a[i]);
            i++;
            if (i >= size) {
                stringBuffer.append(']');
    ...
    public AbstractC0902u(AbstractC0899q abstractC0899q) {
        ...
        this.f5073a = new ASN1Encodable[]{abstractC0899q};
    }
}
