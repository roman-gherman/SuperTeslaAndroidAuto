...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue == null) {
            throw new InflateException(b.e(str, " tag must have a 'class' attribute"));
        }
        try {
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException(a.p("Could not create ", namedString3), e);
                                    }
                                } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) {
        ...
        if (namedResourceId >= 0 && (transitionInflateTransition = inflateTransition(namedResourceId)) != null) {
            if (sceneForLayout2 == null) {
                throw new RuntimeException(b.c(namedResourceId, "No toScene for transition ID "));
            }
