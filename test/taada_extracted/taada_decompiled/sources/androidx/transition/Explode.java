...
public class Explode extends Visibility {
    ...
    private static float calculateMaxDistance(View view, int i, int i3) {
        return calculateDistance(Math.max(i, view.getWidth() - i), Math.max(i3, view.getHeight() - i3));
    }
    ...
    private void calculateOut(View view, Rect rect, int[] iArr) {
        ...
        float fCalculateMaxDistance = calculateMaxDistance(view, iCenterX - i, iCenterY - i3);
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        int i = iArr[0];
        int i3 = iArr[1];
        transitionValues.values.put(PROPNAME_SCREEN_BOUNDS, new Rect(i, i3, view.getWidth() + i, view.getHeight() + i3));
    }
    ...
    public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        calculateOut(viewGroup, rect, this.mTempLoc);
        int[] iArr2 = this.mTempLoc;
        return TranslationAnimationCreator.createAnimation(view, transitionValues, i, i3, translationX, translationY, f6 + iArr2[0], f7 + iArr2[1], sAccelerate, this);
    }
