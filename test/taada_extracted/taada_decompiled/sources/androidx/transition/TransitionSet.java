...
public class TransitionSet extends Transition {
    ...
    public Transition excludeTarget(View view, boolean z6) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).excludeTarget(view, z6);
        }
    ...
    public void setCanRemoveViews(boolean z6) {
        ...
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            this.mTransitions.get(i).setCanRemoveViews(z6);
        }
    }
    ...
    public TransitionSet setOrdering(int i) {
        ...
        if (i != 1) {
            throw new AndroidRuntimeException(b.c(i, "Invalid parameter for TransitionSet ordering: "));
        }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            ...
            sbL.append(this.mTransitions.get(i).toString(str + "  "));
            string = sbL.toString();
        }
        return string;
    }
    ...
    public Transition mo68clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo68clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo68clone());
        }
    ...
    public Transition excludeTarget(String str, boolean z6) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).excludeTarget(str, z6);
        }
    ...
    public Transition excludeTarget(int i, boolean z6) {
        for (int i3 = 0; i3 < this.mTransitions.size(); i3++) {
            this.mTransitions.get(i3).excludeTarget(i, z6);
        }
    ...
    public Transition excludeTarget(Class<?> cls, boolean z6) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).excludeTarget(cls, z6);
        }
