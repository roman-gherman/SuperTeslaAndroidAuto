...
public final class SpannableBuilder extends SpannableStringBuilder {
    ...
    public static class WatcherWrapper implements TextWatcher, SpanWatcher {
        ...
        public void beforeTextChanged(CharSequence charSequence, int i, int i3, int i4) {
            ((TextWatcher) this.mObject).beforeTextChanged(charSequence, i, i3, i4);
        }
        ...
        public void onSpanAdded(Spannable spannable, Object obj, int i, int i3) {
            if (this.mBlockCalls.get() <= 0 || !isEmojiSpan(obj)) {
                ((SpanWatcher) this.mObject).onSpanAdded(spannable, obj, i, i3);
            }
        }
        ...
        */
        ...
        @Override // android.text.SpanWatcher
        public void onSpanRemoved(Spannable spannable, Object obj, int i, int i3) {
            if (this.mBlockCalls.get() <= 0 || !isEmojiSpan(obj)) {
                ((SpanWatcher) this.mObject).onSpanRemoved(spannable, obj, i, i3);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i, int i3, int i4) {
            ((TextWatcher) this.mObject).onTextChanged(charSequence, i, i3, i4);
        }
    ...
    public <T> T[] getSpans(int i, int i3, Class<T> cls) {
        if (!isWatcher((Class<?>) cls)) {
            return (T[]) super.getSpans(i, i3, cls);
        }
        WatcherWrapper[] watcherWrapperArr = (WatcherWrapper[]) super.getSpans(i, i3, WatcherWrapper.class);
    ...
    public CharSequence subSequence(int i, int i3) {
        return new SpannableBuilder(this.mWatcherClass, this, i, i3);
    }
    ...
    public SpannableStringBuilder delete(int i, int i3) {
        super.delete(i, i3);
        return this;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    public SpannableStringBuilder replace(int i, int i3, CharSequence charSequence) {
        blockWatchers();
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    public SpannableStringBuilder insert(int i, CharSequence charSequence, int i3, int i4) {
    ...
    public SpannableBuilder(Class<?> cls, CharSequence charSequence, int i, int i3) {
        super(charSequence, i, i3);
        this.mWatchers = new ArrayList();
        Preconditions.checkNotNull(cls, "watcherClass cannot be null");
        this.mWatcherClass = cls;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable, java.lang.Appendable
    public SpannableStringBuilder append(CharSequence charSequence, int i, int i3) {
