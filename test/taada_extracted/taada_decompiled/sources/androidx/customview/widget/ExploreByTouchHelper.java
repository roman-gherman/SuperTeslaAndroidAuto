...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    public class MyNodeProvider extends AccessibilityNodeProviderCompat {
        ...
        public AccessibilityNodeInfoCompat findFocus(int i) {
            int i3 = i == 2 ? ExploreByTouchHelper.this.mAccessibilityFocusedVirtualViewId : ExploreByTouchHelper.this.mKeyboardFocusedVirtualViewId;
        ...
        public boolean performAction(int i, int i3, Bundle bundle) {
            return ExploreByTouchHelper.this.performAction(i, i3, bundle);
        }
    }
    ...
    private AccessibilityEvent createEvent(int i, int i3) {
        return i != -1 ? createEventForChild(i, i3) : createEventForHost(i3);
    }

    private AccessibilityEvent createEventForChild(int i, int i3) {
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int i) {
        ...
        boolean z6 = this.mKeyboardFocusedVirtualViewId == i;
        if (z6) {
    ...
    private boolean performActionForChild(int i, int i3, Bundle bundle) {
        return i3 != 1 ? i3 != 2 ? i3 != 64 ? i3 != 128 ? onPerformActionForVirtualView(i, i3, bundle) : clearAccessibilityFocus(i) : requestAccessibilityFocus(i) : clearKeyboardFocusForVirtualView(i) : requestKeyboardFocusForVirtualView(i);
    }
    ...
    */
    ...
    public abstract boolean onPerformActionForVirtualView(int i, int i3, Bundle bundle);
    ...
    public void onVirtualViewKeyboardFocusChanged(int i, boolean z6) {
    }

    public boolean performAction(int i, int i3, Bundle bundle) {
        return i != -1 ? performActionForChild(i, i3, bundle) : performActionForHost(i3, bundle);
    }

    public final boolean requestKeyboardFocusForVirtualView(int i) {
        int i3;
        if ((!this.mHost.isFocused() && !this.mHost.requestFocus()) || (i3 = this.mKeyboardFocusedVirtualViewId) == i) {
            return false;
        }
        if (i3 != Integer.MIN_VALUE) {
            clearKeyboardFocusForVirtualView(i3);
    ...
    public final boolean sendEventForVirtualView(int i, int i3) {
        ViewParent parent;
        if (i == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return false;
        }
        return parent.requestSendAccessibilityEvent(this.mHost, createEvent(i, i3));
    }

    public final void invalidateVirtualView(int i, int i3) {
        ViewParent parent;
        if (i == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return;
        }
