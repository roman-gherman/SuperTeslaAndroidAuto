...
public final class CoroutinesRoom {
    ...
    public static final class Companion {
        ...
        public final <R> Object execute(RoomDatabase roomDatabase, boolean z6, CancellationSignal cancellationSignal, Callable<R> callable, Continuation<? super R> continuation) {
            ...
            c0672f.invokeOnCancellation(new CoroutinesRoom$Companion$execute$4$1(cancellationSignal, AbstractC0690y.g(V.f4114a, transactionDispatcher, new CoroutinesRoom$Companion$execute$4$job$1(callable, c0672f, null), 2)));
            return c0672f.m();
        }
    }
