...
public final class AmbiguousColumnResolver {
    ...
    public static final class Solution implements Comparable<Solution> {
        ...
        private static final Solution NO_SOLUTION = new Solution(u.f3804a, Integer.MAX_VALUE, Integer.MAX_VALUE);
    ...
    public static final class AnonymousClass4 extends i implements Function1<List<? extends Match>, m> {
        ...
        public final void invoke2(List<Match> it) {
            ...
            if (solutionBuild.compareTo((Solution) this.$bestSolution.f3816a) < 0) {
                this.$bestSolution.f3816a = solutionBuild;
            }
        }
    }
    ...
    public static final int[][] resolve(String[] resultColumns, String[][] mappings) {
        ...
        v vVar = new v();
        vVar.f3816a = Solution.INSTANCE.getNO_SOLUTION();
        dfs$default(INSTANCE, arrayList, null, 0, new AnonymousClass4(vVar), 6, null);
        List<Match> matches = ((Solution) vVar.f3816a).getMatches();
