...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    private void computeInsetRatio(int[] iArr, int i, int i3, int i4, int i5, float f6, int i6) {
        int i7 = i3 - i;
        int i8 = i5 - i4;
        if (i6 != -1) {
            if (i6 == 0) {
                iArr[0] = (int) ((i8 * f6) + 0.5f);
                iArr[1] = i8;
                return;
            } else {
                if (i6 != 1) {
                ...
                iArr[0] = i7;
                iArr[1] = (int) ((i7 * f6) + 0.5f);
                return;
            }
        }
        int i9 = (int) ((i8 * f6) + 0.5f);
        int i10 = (int) ((i7 / f6) + 0.5f);
        if (i9 <= i7) {
            iArr[0] = i9;
            iArr[1] = i8;
        } else if (i10 <= i8) {
