...
public class ConstraintAnchor {
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i, int i3, boolean z6) {
        if (constraintAnchor == null) {
            reset();
            return true;
        }
        if (!z6 && !isValidConnection(constraintAnchor)) {
            return false;
        }
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type2.ordinal()]) {
            ...
            case 3:
                ...
                return constraintAnchor.getOwner() instanceof Guideline ? z6 || type == Type.CENTER_X : z6;
            case 4:
            case 5:
                boolean z7 = type == Type.TOP || type == Type.BOTTOM;
                return constraintAnchor.getOwner() instanceof Guideline ? z7 || type == Type.CENTER_Y : z7;
            case 6:
