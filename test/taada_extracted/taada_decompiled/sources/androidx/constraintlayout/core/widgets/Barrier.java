...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z6) {
        ...
        int i9 = !(!z7 && (((i = this.mBarrierType) == 0 && z8) || ((i == 2 && z9) || ((i == 1 && z8) || (i == 3 && z9))))) ? 4 : 5;
        for (int i10 = 0; i10 < this.mWidgetsCount; i10++) {
            ...
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                ...
                if (i11 == 0 || i11 == 2) {
                    linearSystem.addLowerBarrier(constraintAnchor2.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin - i12, z7);
                } else {
                    linearSystem.addGreaterBarrier(constraintAnchor2.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin + i12, z7);
                }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mWidgetsCount; i++) {
            ...
            sbK.append(constraintWidget.getDebugName());
            string = sbK.toString();
        }
        return b.e(string, "}");
    }
