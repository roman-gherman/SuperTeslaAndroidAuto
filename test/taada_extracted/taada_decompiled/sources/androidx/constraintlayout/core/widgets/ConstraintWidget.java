...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:357:0x0529 A[ADDED_TO_REGION] */
    ...
    */
    ...
    private void serializeDimensionRatio(StringBuilder sb, String str, float f6, int i) {
        if (f6 == 0.0f) {
            return;
        }
        sb.append(str);
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i3, int i4, int i5, int i6, int i7, float f6, float f7) {
        sb.append(str);
        sb.append(" :  {\n");
    ...
    public void addChildrenToSolverByDependency(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, HashSet<ConstraintWidget> hashSet, int i, boolean z6) {
        if (z6) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:310:0x0576  */
    ...
    */
    ...
    public void connectCircularConstraint(ConstraintWidget constraintWidget, float f6, int i) {
    ...
    public boolean hasResolvedTargets(int i, int i3) {
        ConstraintAnchor constraintAnchor;
        ConstraintAnchor constraintAnchor2;
        if (i == 0) {
            ...
            if (constraintAnchor3 != null && constraintAnchor3.hasFinalValue() && (constraintAnchor2 = this.mRight.mTarget) != null && constraintAnchor2.hasFinalValue()) {
                return (this.mRight.mTarget.getFinalValue() - this.mRight.getMargin()) - (this.mLeft.getMargin() + this.mLeft.mTarget.getFinalValue()) >= i3;
            }
        } else {
            ...
            if (constraintAnchor4 != null && constraintAnchor4.hasFinalValue() && (constraintAnchor = this.mBottom.mTarget) != null && constraintAnchor.hasFinalValue()) {
                if ((this.mBottom.mTarget.getFinalValue() - this.mBottom.getMargin()) - (this.mTop.getMargin() + this.mTop.mTarget.getFinalValue()) >= i3) {
                    return true;
                }
            }
        }
    ...
    public void immediateConnect(ConstraintAnchor.Type type, ConstraintWidget constraintWidget, ConstraintAnchor.Type type2, int i, int i3) {
        getAnchor(type).connect(constraintWidget.getAnchor(type2), i, i3, true);
    }
    ...
    */
    ...
    public void setFinalBaseline(int i) {
        if (this.hasBaseline) {
            int i3 = i - this.mBaselineDistance;
    ...
    public void setFinalFrame(int i, int i3, int i4, int i5, int i6, int i7) {
        setFrame(i, i3, i4, i5);
    ...
    public void setFinalHorizontal(int i, int i3) {
        if (this.resolvedHorizontal) {
            return;
        }
    ...
    public void setFinalVertical(int i, int i3) {
        if (this.resolvedVertical) {
            return;
        }
        this.mTop.setFinalValue(i);
    ...
    public void setFrame(int i, int i3, int i4, int i5) {
        int i6;
        int i7;
        int i8 = i4 - i;
        int i9 = i5 - i3;
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i3 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type.ordinal()];
        if (i3 == 1) {
    ...
    public void setHorizontalDimension(int i, int i3) {
        this.mX = i;
        int i4 = i3 - i;
        this.mWidth = i4;
    ...
    public void setHorizontalMatchStyle(int i, int i3, int i4, float f6) {
    ...
    public void setInBarrier(int i, boolean z6) {
        this.mIsInBarrier[i] = z6;
    }
    ...
    public void setLastMeasureSpec(int i, int i3) {
        this.mLastHorizontalMeasureSpec = i;
        this.mLastVerticalMeasureSpec = i3;
        setMeasureRequested(false);
    }

    public void setLength(int i, int i3) {
        if (i3 == 0) {
            setWidth(i);
        } else if (i3 == 1) {
            setHeight(i);
    ...
    public void setOffset(int i, int i3) {
        this.mOffsetX = i;
        this.mOffsetY = i3;
    }

    public void setOrigin(int i, int i3) {
        this.mX = i;
        this.mY = i3;
    }
    ...
    public void setRelativePositioning(int i, int i3) {
        if (i3 == 0) {
            this.mRelX = i;
        } else if (i3 == 1) {
            this.mRelY = i;
    ...
    public void setVerticalDimension(int i, int i3) {
        this.mY = i;
        int i4 = i3 - i;
        this.mHeight = i4;
        int i5 = this.mMinHeight;
    ...
    public void setVerticalMatchStyle(int i, int i3, int i4, float f6) {
    ...
    public void updateFromRuns(boolean z6, boolean z7) {
        ...
        if (zIsResolved2) {
            if (this.mListDimensionBehaviors[1] == DimensionBehaviour.FIXED && i10 < (i = this.mHeight)) {
                i10 = i;
            }
            this.mHeight = i10;
    ...
    private void serializeAttribute(StringBuilder sb, String str, int i, int i3) {
        if (i == i3) {
            return;
        }
        sb.append(str);
    ...
    public void setDimensionRatio(float f6, int i) {
        this.mDimensionRatio = f6;
        this.mDimensionRatioSide = i;
    }

    public void setFrame(int i, int i3, int i4) {
        if (i4 == 0) {
            setHorizontalDimension(i, i3);
        } else if (i4 == 1) {
            setVerticalDimension(i, i3);
        }
    }

    private void getSceneString(StringBuilder sb, String str, int i, int i3, int i4, int i5, int i6, int i7, float f6, float f7) {
        sb.append(str);
        sb.append(" :  {\n");
    ...
    public ConstraintWidget(int i, int i3, int i4, int i5) {
        this.measured = false;
        this.run = new WidgetRun[2];
        this.horizontalRun = null;
        this.verticalRun = null;
    ...
    public ConstraintWidget(String str, int i, int i3, int i4, int i5) {
        this(i, i3, i4, i5);
        setDebugName(str);
    }

    public ConstraintWidget(int i, int i3) {
        this(0, 0, i, i3);
    }

    public ConstraintWidget(String str, int i, int i3) {
        this(i, i3);
        setDebugName(str);
    }
}
