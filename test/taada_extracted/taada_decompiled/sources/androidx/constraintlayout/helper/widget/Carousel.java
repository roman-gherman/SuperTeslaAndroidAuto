...
public class Carousel extends MotionHelper {
    ...
    public Carousel(Context context) {
        ...
        this.mUpdateRunnable = new Runnable() { // from class: androidx.constraintlayout.helper.widget.Carousel.1
            ...
            public void run() {
                ...
                final float f6 = Carousel.this.dampening * velocity;
    ...
    private boolean enableTransition(int i, boolean z6) {
        MotionLayout motionLayout;
        MotionScene.Transition transition;
        if (i == -1 || (motionLayout = this.mMotionLayout) == null || (transition = motionLayout.getTransition(i)) == null || z6 == transition.isEnabled()) {
            return false;
        }
    ...
    private boolean updateViewVisibility(View view, int i) {
        ...
        for (int i3 : motionLayout.getConstraintSetIds()) {
            zUpdateViewVisibility |= updateViewVisibility(i3, view, i);
        }
    ...
    public void onTransitionChange(MotionLayout motionLayout, int i, int i3, float f6) {
        this.mLastStartId = i;
    }
    ...
    public void transitionToIndex(int i, int i3) {
    ...
    private boolean updateViewVisibility(int i, View view, int i3) {
