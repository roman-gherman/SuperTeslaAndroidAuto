...
public class KeyPosition extends KeyPositionBase {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    default:
                        ...
                        Log.e(TypedValues.PositionType.NAME, sb.toString());
                        break;
                }
            }
    ...
    @Override // androidx.constraintlayout.motion.widget.KeyPositionBase
    public boolean intersects(int i, int i3, RectF rectF, RectF rectF2, float f6, float f7) {
        calcPosition(i, i3, rectF.centerX(), rectF.centerY(), rectF2.centerX(), rectF2.centerY());
