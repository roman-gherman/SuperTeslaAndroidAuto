...
class TouchResponse {
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i, MotionScene motionScene) {
        ...
        if (action == 1) {
            ...
            if (f8 == 0.0f || f8 == 1.0f || (i3 = this.mOnTouchUp) == 3) {
                if (0.0f >= f8 || 1.0f <= f8) {
        ...
        if (Math.abs((this.mTouchDirectionY * rawY) + (this.mTouchDirectionX * rawX)) > this.mDragThreshold || this.mDragStarted) {
            ...
            if (i5 != -1) {
                ...
                c7 = 0;
                f6 = progress2;
                this.mMotionLayout.getAnchorDpDt(i5, f6, this.mTouchAnchorX, this.mTouchAnchorY, this.mAnchorDpDt);
            } else {
                c6 = 1;
                f6 = progress2;
                c7 = 0;
    ...
    */
    ...
    public void scrollUp(float f6, float f7) {
        ...
        if (progress != 0.0f) {
            ...
            if ((i != 3) && z6) {
                this.mMotionLayout.touchAnimateTo(i, ((double) progress) >= 0.5d ? 1.0f : 0.0f, f9);
            }
        }
    }
