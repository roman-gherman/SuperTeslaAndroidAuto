...
abstract class MapCollections<K, V> {
    ...
    public final class ArrayIterator<T> implements Iterator<T> {
        ...
        public T next() {
            ...
            T t6 = (T) MapCollections.this.colGetEntry(this.mIndex, this.mOffset);
            this.mIndex++;
    ...
    public final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public V setValue(V v6) {
            if (this.mEntryValid) {
                return (V) MapCollections.this.colSetValue(this.mIndex, v6);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
    ...
    public abstract Object colGetEntry(int i, int i3);
    ...
    public abstract void colPut(K k6, V v6);

    public abstract void colRemoveAt(int i);

    public abstract V colSetValue(int i, V v6);
