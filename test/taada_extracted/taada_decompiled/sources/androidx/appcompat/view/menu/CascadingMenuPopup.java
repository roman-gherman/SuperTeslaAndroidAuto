...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(Context context, View view, int i, int i3, boolean z6) {
    ...
    private int getNextMenuPosition(int i) {
        ListView listView = ((CascadingMenuInfo) b.b(1, this.mShowingMenus)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) b.b(1, this.mShowingMenus);
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) b.b(1, this.mShowingMenus)).getListView();
    }
