...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public MenuItemImpl(MenuBuilder menuBuilder, int i, int i3, int i4, int i5, CharSequence charSequence, int i6) {
    ...
    private static void appendModifier(StringBuilder sb, int i, int i3, String str) {
        if ((i & i3) == i3) {
            sb.append(str);
        }
    }
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    public MenuItem setShortcut(char c, char c6, int i, int i3) {
        this.mShortcutNumericChar = c;
        this.mShortcutNumericModifiers = KeyEvent.normalizeMetaState(i);
        this.mShortcutAlphabeticChar = Character.toLowerCase(c6);
