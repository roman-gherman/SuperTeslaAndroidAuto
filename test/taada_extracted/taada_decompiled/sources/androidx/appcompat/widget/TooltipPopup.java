...
class TooltipPopup {
    ...
    private void computePosition(View view, int i, int i3, boolean z6, WindowManager.LayoutParams layoutParams) {
        int height;
        int i4;
    ...
    public void show(View view, int i, int i3, boolean z6, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i, i3, z6, this.mLayoutParams);
