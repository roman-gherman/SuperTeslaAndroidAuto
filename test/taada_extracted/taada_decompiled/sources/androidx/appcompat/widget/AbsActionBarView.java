...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public static int next(int i, int i3, boolean z6) {
        return z6 ? i - i3 : i + i3;
    }
    ...
    public int measureChildView(View view, int i, int i3, int i4) {
    ...
    public int positionChild(View view, int i, int i3, int i4, boolean z6) {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i, long j6) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = this.mVisibilityAnim;
        if (viewPropertyAnimatorCompat != null) {
            viewPropertyAnimatorCompat.cancel();
        }
