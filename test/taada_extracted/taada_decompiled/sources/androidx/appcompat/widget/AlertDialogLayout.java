...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    */
    ...
    private void setChildFrame(View view, int i, int i3, int i4, int i5) {
        view.layout(i, i3, i4 + i, i5 + i3);
    }

    private boolean tryOnMeasure(int i, int i3) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(getPaddingRight() + getPaddingLeft() + iMax, i, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i3, 0));
        if (mode2 == 1073741824) {
            return true;
        }
