...
class DropDownListView extends ListView {
    ...
    public DropDownListView(Context context, boolean z6) {
    ...
    private void positionSelectorLikeFocusCompat(int i, View view) {
        ...
        boolean z6 = (selector == null || i == -1) ? false : true;
        if (z6) {
    ...
    private void positionSelectorLikeTouchCompat(int i, View view, float f6, float f7) {
    ...
    private void setPressedItem(View view, int i, float f6, float f7) {
        View childAt;
        ...
        positionSelectorLikeTouchCompat(i, view, f6, f7);
    ...
    public int lookForSelectablePosition(int i, boolean z6) {
        int iMin;
    ...
    public int measureHeightOfChildrenCompat(int i, int i3, int i4, int i5, int i6) {
