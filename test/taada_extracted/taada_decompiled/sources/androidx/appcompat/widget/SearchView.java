...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public void onFocusChanged(boolean z6, int i, Rect rect) {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z7 && !this.mSlopBounds.contains(x, y)) {
                        z8 = z7;
                        z6 = false;
                    }
                } else {
            ...
            if (!z6 || this.mActualBounds.contains(x, y)) {
    ...
    private boolean launchSuggestion(int i, int i3, String str) {
    ...
    public boolean onItemClicked(int i, int i3, String str) {
