...
class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    public Drawable getDrawableForDensity(int i, int i3) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i, i3, null);
    }

    @Override // android.content.res.Resources
    public float getFraction(int i, int i3, int i4) {
        return this.mResources.getFraction(i, i3, i4);
    }
    ...
    @Override // android.content.res.Resources
    public String getQuantityString(int i, int i3, Object... objArr) {
        return this.mResources.getQuantityString(i, i3, objArr);
    }

    @Override // android.content.res.Resources
    public CharSequence getQuantityText(int i, int i3) {
        return this.mResources.getQuantityText(i, i3);
    }
    ...
    @Override // android.content.res.Resources
    public void getValue(int i, TypedValue typedValue, boolean z6) {
        this.mResources.getValue(i, typedValue, z6);
    }

    @Override // android.content.res.Resources
    public void getValueForDensity(int i, int i3, TypedValue typedValue, boolean z6) {
        Compatibility.Api15Impl.getValueForDensity(this.mResources, i, i3, typedValue, z6);
    }
    ...
    public Drawable getDrawableForDensity(int i, int i3, Resources.Theme theme) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i, i3, theme);
    }

    @Override // android.content.res.Resources
    public String getQuantityString(int i, int i3) {
        return this.mResources.getQuantityString(i, i3);
    }
