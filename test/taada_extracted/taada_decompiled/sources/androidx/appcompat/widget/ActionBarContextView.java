...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z6, int i, int i3, int i4, int i5) {
        ...
        int paddingRight = zIsLayoutRtl ? (i4 - i) - getPaddingRight() : getPaddingLeft();
        ...
        int paddingLeft = zIsLayoutRtl ? getPaddingLeft() : (i4 - i) - getPaddingRight();
    ...
    @Override // androidx.appcompat.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i, long j6) {
        return super.setupAnimatorToVisibility(i, j6);
    }
