...
public class ToolbarWidgetWrapper implements DecorToolbar {
        ...
        if (i != i3) {
            ...
            if (i != 0) {
                if (i == 1) {
                    ...
                    if (i != 2) {
                        throw new IllegalArgumentException(B2.b.c(i, "Invalid navigation mode "));
                    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i, long j6) {
        return ViewCompat.animate(this.mToolbar).alpha(i == 0 ? 1.0f : 0.0f).setDuration(j6).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z6, int i, int i3) {
        Drawable drawable;
