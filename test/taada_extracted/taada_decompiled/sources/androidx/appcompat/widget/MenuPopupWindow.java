...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class Api29Impl {
        ...
        public static void setTouchModal(PopupWindow popupWindow, boolean z6) {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int i, boolean z6) {
            return super.lookForSelectablePosition(i, z6);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i, int i3, int i4, int i5, int i6) {
            return super.measureHeightOfChildrenCompat(i, i3, i4, i5, i6);
        }
    ...
    public MenuPopupWindow(Context context, AttributeSet attributeSet, int i, int i3) {
    ...
    public void setTouchModal(boolean z6) {
        if (Build.VERSION.SDK_INT > 28) {
            Api29Impl.setTouchModal(this.mPopup, z6);
            return;
        }
