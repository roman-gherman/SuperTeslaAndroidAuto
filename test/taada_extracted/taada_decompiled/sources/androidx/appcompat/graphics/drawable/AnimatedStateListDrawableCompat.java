...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        private static long generateTransitionKey(int i, int i3) {
            return ((long) i3) | (((long) i) << 32);
        }
        ...
        public int addTransition(int i, int i3, Drawable drawable, boolean z6) {
            int iAddChild = addChild(drawable);
            long jGenerateTransitionKey = generateTransitionKey(i, i3);
            long j6 = z6 ? REVERSIBLE_FLAG_BIT : 0L;
            long j7 = iAddChild;
            this.mTransitions.append(jGenerateTransitionKey, Long.valueOf(j7 | j6));
            if (z6) {
                this.mTransitions.append(generateTransitionKey(i3, i), Long.valueOf(REVERSED_BIT | j7 | j6));
            }
            return iAddChild;
        }
        ...
        public int indexOfTransition(int i, int i3) {
            return (int) this.mTransitions.get(generateTransitionKey(i, i3), -1L).longValue();
        }

        public boolean isTransitionReversed(int i, int i3) {
            return (this.mTransitions.get(generateTransitionKey(i, i3), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        public boolean transitionHasReversibleFlag(int i, int i3) {
            return (this.mTransitions.get(generateTransitionKey(i, i3), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f6) {
            int i = (int) ((f6 * this.mTotalDuration) + 0.5f);
            int i3 = this.mFrames;
            ...
            return (i4 / i3) + (i4 < i3 ? i / this.mTotalDuration : 0.0f);
        }
        ...
        public int updateFrames(AnimationDrawable animationDrawable, boolean z6) {
            ...
            for (int i3 = 0; i3 < numberOfFrames; i3++) {
                int duration = animationDrawable.getDuration(z6 ? (numberOfFrames - i3) - 1 : i3);
                iArr2[i3] = duration;
                i += duration;
            }
    ...
    public <T extends Drawable & Animatable> void addTransition(int i, int i3, T t6, boolean z6) {
        ObjectsCompat.requireNonNull(t6);
        this.mState.addTransition(i, i3, t6, z6);
    }
