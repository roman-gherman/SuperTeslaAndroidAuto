...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public void growArray(int i, int i3) {
        ...
        public final boolean setLayoutDirection(int i, int i3) {
    ...
    */
    ...
    public void setHotspotBounds(int i, int i3, int i4, int i5) {
        Rect rect = this.mHotspotBounds;
        if (rect == null) {
            this.mHotspotBounds = new Rect(i, i3, i4, i5);
        } else {
            rect.set(i, i3, i4, i5);
        }
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            DrawableCompat.setHotspotBounds(drawable, i, i3, i4, i5);
        }
    }
