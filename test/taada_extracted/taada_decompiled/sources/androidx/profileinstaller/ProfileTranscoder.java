...
class ProfileTranscoder {
    ...
    private static String generateDexKey(String str, String str2, byte[] bArr) {
        ...
        sbK.append(ProfileVersion.dexKeySeparator(bArr));
        sbK.append(str2);
        return sbK.toString();
    }
    ...
    private static int methodFlagBitmapIndex(int i, int i3, int i4) {
        if (i == 1) {
        ...
        throw Encoding.error(B2.b.c(i, "Unexpected flag: "));
    }
    ...
    private static int readFlagsFromBitmap(BitSet bitSet, int i, int i3) {
        int i4 = bitSet.get(methodFlagBitmapIndex(2, i, i3)) ? 2 : 0;
        return bitSet.get(methodFlagBitmapIndex(4, i, i3)) ? i4 | 4 : i4;
    }
    ...
    public static DexProfileData[] readMetadata001(InputStream inputStream, byte[] bArr, DexProfileData[] dexProfileDataArr) throws IOException {
        if (!Arrays.equals(bArr, ProfileVersion.METADATA_V001_N)) {
            throw Encoding.error("Unsupported meta version");
        }
    ...
    public static DexProfileData[] readMetadataV002(InputStream inputStream, byte[] bArr, DexProfileData[] dexProfileDataArr) throws IOException {
        int uInt16 = Encoding.readUInt16(inputStream);
        byte[] compressed = Encoding.readCompressed(inputStream, (int) Encoding.readUInt32(inputStream), (int) Encoding.readUInt32(inputStream));
        if (inputStream.read() > 0) {
            throw Encoding.error("Content found after the end of file");
    ...
    private static DexProfileData[] readMetadataV002Body(InputStream inputStream, byte[] bArr, int i, DexProfileData[] dexProfileDataArr) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (dexProfileDataFindByDexName == null) {
                throw Encoding.error(androidx.constraintlayout.core.motion.a.p("Missing profile key: ", string));
            }
    ...
    private static void readMethodBitmap(InputStream inputStream, DexProfileData dexProfileData) {
        ...
        while (true) {
            ...
            int flagsFromBitmap = readFlagsFromBitmap(bitSetValueOf, i, i3);
    ...
    private static DexProfileData[] readUncompressedBody(InputStream inputStream, String str, int i) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            dexProfileDataArr[i3] = new DexProfileData(str, Encoding.readString(inputStream, uInt16), Encoding.readUInt32(inputStream), 0L, uInt162, (int) Encoding.readUInt32(inputStream), (int) Encoding.readUInt32(inputStream), new int[uInt162], new TreeMap());
        }
        for (int i4 = 0; i4 < i; i4++) {
            DexProfileData dexProfileData = dexProfileDataArr[i4];
    ...
    private static void setMethodBitmapBit(byte[] bArr, int i, int i3, DexProfileData dexProfileData) {
        int iMethodFlagBitmapIndex = methodFlagBitmapIndex(i, i3, dexProfileData.numMethodIds);
