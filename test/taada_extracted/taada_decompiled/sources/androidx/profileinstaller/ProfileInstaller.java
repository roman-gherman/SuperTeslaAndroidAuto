...
public class ProfileInstaller {
    ...
    public static boolean deleteProfileWrittenFor(File file) {
    ...
    public static void diagnostic(Executor executor, DiagnosticsCallback diagnosticsCallback, int i, Object obj) {
        executor.execute(new b(diagnosticsCallback, i, obj, 1));
    }
    ...
    public static void result(Executor executor, DiagnosticsCallback diagnosticsCallback, int i, Object obj) {
        executor.execute(new b(diagnosticsCallback, i, obj, 0));
    }
    ...
    public static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnosticsCallback, boolean z6) {
