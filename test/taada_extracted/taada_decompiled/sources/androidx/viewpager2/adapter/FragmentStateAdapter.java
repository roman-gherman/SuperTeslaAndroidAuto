...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    private static String createKey(String str, long j6) {
        return str + j6;
    }
    ...
    private Long itemForViewHolder(int i) {
        ...
        for (int i3 = 0; i3 < this.mItemIdToViewHolder.size(); i3++) {
            if (this.mItemIdToViewHolder.valueAt(i3).intValue() == i) {
                if (lValueOf != null) {
    ...
    private void removeFragment(long j6) {
        ...
        if (fragment.isAdded() && containsItem(j6)) {
            this.mSavedStates.put(j6, this.mFragmentManager.saveFragmentInstanceState(fragment));
        }
