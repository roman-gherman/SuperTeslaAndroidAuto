...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public void closeField() {
        ...
        if (i >= 0) {
            int i3 = this.mPositionLookup.get(i);
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, iDataPosition, i, b.h(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
    ...
    private VersionedParcelParcel(Parcel parcel, int i, int i3, String str, ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeByteArray(byte[] bArr, int i, int i3) {
        if (bArr != null) {
            this.mParcel.writeInt(bArr.length);
            this.mParcel.writeByteArray(bArr, i, i3);
        } else {
            this.mParcel.writeInt(-1);
        }
    }
