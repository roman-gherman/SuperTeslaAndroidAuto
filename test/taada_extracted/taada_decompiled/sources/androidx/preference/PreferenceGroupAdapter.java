...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
        ...
        if (preferenceManager == null || preferenceManager.getPreferenceComparisonCallback() == null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: androidx.preference.PreferenceGroupAdapter.2
                ...
                public boolean areContentsTheSame(int i, int i3) {
                    return preferenceComparisonCallback.arePreferenceContentsTheSame((Preference) list.get(i), (Preference) listCreateVisiblePreferencesList.get(i3));
                }

                @Override // androidx.recyclerview.widget.DiffUtil.Callback
                public boolean areItemsTheSame(int i, int i3) {
                    return preferenceComparisonCallback.arePreferenceItemsTheSame((Preference) list.get(i), (Preference) listCreateVisiblePreferencesList.get(i3));
                }
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (viewGroup2 != null) {
            int i3 = preferenceResourceDescriptor.mWidgetLayoutResId;
            if (i3 != 0) {
