...
final class WeightTypefaceApi21 {
    ...
    public static Typeface createWeightStyle(Typeface typeface, int i, boolean z6) {
        ...
        synchronized (sWeightCacheLock) {
            try {
                ...
                Typeface typefaceCreate = z6 == typeface.isItalic() ? create(nativeCreateWeightAlias(nativeInstance, i)) : create(nativeCreateFromTypefaceWithExactStyle(nativeInstance, i, z6));
    ...
    private static long nativeCreateWeightAlias(long j6, int i) {
        try {
            return ((Long) sNativeCreateWeightAlias.invoke(null, Long.valueOf(j6), Integer.valueOf(i))).longValue();
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        } catch (InvocationTargetException e6) {
            throw new RuntimeException(e6);
