...
public final class MatrixKt {
    ...
    public static /* synthetic */ Matrix rotationMatrix$default(float f6, float f7, float f8, int i, Object obj) {
        if ((i & 2) != 0) {
            f7 = 0.0f;
        }
        if ((i & 4) != 0) {
    ...
    public static /* synthetic */ Matrix scaleMatrix$default(float f6, float f7, int i, Object obj) {
        if ((i & 1) != 0) {
            f6 = 1.0f;
        }
        if ((i & 2) != 0) {
    ...
    public static /* synthetic */ Matrix translationMatrix$default(float f6, float f7, int i, Object obj) {
        if ((i & 1) != 0) {
            f6 = 0.0f;
        }
        if ((i & 2) != 0) {
