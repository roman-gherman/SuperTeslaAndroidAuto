...
public final class SQLiteDatabaseKt {
    public static final <T> T transaction(SQLiteDatabase sQLiteDatabase, boolean z6, Function1<? super SQLiteDatabase, ? extends T> function1) {
        if (z6) {
    ...
    public static /* synthetic */ Object transaction$default(SQLiteDatabase sQLiteDatabase, boolean z6, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            z6 = true;
        }
        if (z6) {
