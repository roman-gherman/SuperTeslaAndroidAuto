...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(ColorStops colorStops, int i, int i3, boolean z6, int i4) {
        return colorStops != null ? colorStops : z6 ? new ColorStops(i, i4, i3) : new ColorStops(i, i3);
    }
    ...
    */
    ...
    public static final class ColorStops {
        ...
        public ColorStops(int i, int i3) {
            this.mColors = new int[]{i, i3};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        public ColorStops(int i, int i3, int i4) {
            this.mColors = new int[]{i, i3, i4};
