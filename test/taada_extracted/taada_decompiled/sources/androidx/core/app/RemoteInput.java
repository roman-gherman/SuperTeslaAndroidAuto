...
public final class RemoteInput {
    ...
    public RemoteInput(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z6, int i, Bundle bundle, Set<String> set) {
        this.mResultKey = str;
        this.mLabel = charSequence;
        this.mChoices = charSequenceArr;
        this.mAllowFreeFormTextInput = z6;
    ...
    private static String getExtraResultsKeyForData(String str) {
        return androidx.constraintlayout.core.motion.a.p(EXTRA_DATA_TYPE_RESULTS_DATA, str);
    }
