...
public class NotificationChannelCompat {
    ...
    public static class Api26Impl {
        ...
        public static void enableLights(NotificationChannel notificationChannel, boolean z6) {
            notificationChannel.enableLights(z6);
        }

        public static void enableVibration(NotificationChannel notificationChannel, boolean z6) {
        ...
        public static void setShowBadge(NotificationChannel notificationChannel, boolean z6) {
    ...
    public static class Builder {
        ...
        public Builder setVibrationEnabled(boolean z6) {
            this.mChannel.mVibrationEnabled = z6;
            return this;
        }
