...
class NotificationCompatJellybean {
    ...
    public static NotificationCompat.Action readAction(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            z6 = bundle.getBoolean(EXTRA_ALLOW_GENERATED_REPLIES);
        ...
        return new NotificationCompat.Action(i, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z6, 0, true, false, false);
    }
