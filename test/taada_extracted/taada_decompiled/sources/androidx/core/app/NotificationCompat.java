...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z6, int i, boolean z7, boolean z8, boolean z9) {
        ...
        public static final class WearableExtender implements Extender {
            ...
            private void setFlag(int i, boolean z6) {
                if (z6) {
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z6, int i3, boolean z7, boolean z8, boolean z9) {
            this(i != 0 ? IconCompat.createWithResource(null, "", i) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z6, i3, z7, z8, z9);
        }

        public Action(IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z6, int i, boolean z7, boolean z8, boolean z9) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            private Builder setFlag(int i, boolean z6) {
                if (z6) {
                    this.mFlags = i | this.mFlags;
                    return this;
                }
        ...
        private BubbleMetadata(PendingIntent pendingIntent, PendingIntent pendingIntent2, IconCompat iconCompat, int i, int i3, int i4, String str) {
            this.mPendingIntent = pendingIntent;
            this.mIcon = iconCompat;
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(c.g(it2.next())));
                }
            }
        ...
        public Builder setLights(int i, int i3, int i4) {
            Notification notification = this.mNotification;
        ...
        public Builder setProgress(int i, int i3, boolean z6) {
            this.mProgressMax = i;
            this.mProgress = i3;
        ...
        public Builder setSmallIcon(int i, int i3) {
            Notification notification = this.mNotification;
            notification.icon = i;
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeAction(int i, int i3, Integer num, int i4, PendingIntent pendingIntent) {
            if (num == null) {
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z6 ? i : i3, z6 ? R.string.call_notification_answer_video_action : R.string.call_notification_answer_action, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
    ...
    public static abstract class Style {
        ...
        public static class Api16Impl {
            ...
            public static void setTextViewTextSize(RemoteViews remoteViews, int i, int i3, float f6) {
                remoteViews.setTextViewTextSize(i, i3, f6);
            }

            public static void setViewPadding(RemoteViews remoteViews, int i, int i3, int i4, int i5, int i6) {
                remoteViews.setViewPadding(i, i3, i4, i5, i6);
            }
        }
        ...
        public static class Api24Impl {
            ...
            public static void setChronometerCountDown(RemoteViews remoteViews, int i, boolean z6) {
                remoteViews.setChronometerCountDown(i, z6);
            }
        }
        ...
        private Bitmap createIconWithBackground(int i, int i3, int i4, int i5) {
        ...
        */
        ...
        public Bitmap createColoredBitmap(int i, int i3) {
            return createColoredBitmap(i, i3, 0);
        }
        ...
        private Bitmap createColoredBitmap(int i, int i3, int i4) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, i), i3, i4);
        }

        private Bitmap createColoredBitmap(IconCompat iconCompat, int i, int i3) {
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        return new Action(i, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z6, semanticAction, z7, zIsContextual, zIsAuthenticationRequired);
    }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(c.g(it.next())));
                }
            }
        } else {
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class Api20Impl {
            ...
            public static RemoteInput.Builder setAllowFreeFormInput(RemoteInput.Builder builder, boolean z6) {
    ...
    public static class MessagingStyle extends Style {
        ...
        private Message findLatestIncomingMessage() {
            ...
            return (Message) B2.b.b(1, this.mMessages);
        }
