...
public final class HtmlKt {
    ...
    public static /* synthetic */ Spanned parseAsHtml$default(String str, int i, Html.ImageGetter imageGetter, Html.TagHandler tagHandler, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    public static /* synthetic */ String toHtml$default(Spanned spanned, int i, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        return HtmlCompat.toHtml(spanned, i);
