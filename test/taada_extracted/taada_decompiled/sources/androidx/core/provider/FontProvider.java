...
class FontProvider {
    ...
    public static ProviderInfo getProvider(PackageManager packageManager, FontRequest fontRequest, Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (providerInfoResolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(androidx.constraintlayout.core.motion.a.p("No package found for authority: ", providerAuthority));
        }
        if (!providerInfoResolveContentProvider.packageName.equals(fontRequest.getProviderPackage())) {
            StringBuilder sbM = b.m("Found content provider ", providerAuthority, ", but package was not ");
            sbM.append(fontRequest.getProviderPackage());
            throw new PackageManager.NameNotFoundException(sbM.toString());
        }
