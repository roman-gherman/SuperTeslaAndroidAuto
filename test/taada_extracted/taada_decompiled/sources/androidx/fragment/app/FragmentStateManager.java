    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(B2.b.h(sb, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
        ...
        try {
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i) {
                    if (!z6 && i == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
                            Objects.toString(this.mFragment);
                        }
