...
class FragmentStore {
        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
                ...
                if (fragmentStateManager != null) {
                    ...
                    fragment.dump(strE, fileDescriptor, printWriter, strArr);
                } else {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (fragmentFindActiveFragment == null) {
                    throw new IllegalStateException(androidx.constraintlayout.core.motion.a.q("No instantiated fragment for (", str, ")"));
                }
                if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public void restoreSaveState(HashMap<String, Bundle> map) {
