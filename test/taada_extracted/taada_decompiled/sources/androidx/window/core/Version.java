...
public final class Version implements Comparable<Version> {
    ...
    public static final class Companion {
        ...
        public final Version parse(String versionString) {
            if (versionString == null || r.y(versionString)) {
                return null;
            }
    ...
    public /* synthetic */ Version(int i, int i3, int i4, String str, d dVar) {
        this(i, i3, i4, str);
    }
    ...
    public String toString() {
        String strM = !r.y(this.description) ? h.m(this.description, "-") : "";
        StringBuilder sb = new StringBuilder();
        sb.append(this.major);
        sb.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        sb.append(this.minor);
        sb.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        return b.g(sb, strM, this.patch);
    }

    private Version(int i, int i3, int i4, String str) {
        this.major = i;
        this.minor = i3;
        this.patch = i4;
        this.description = str;
        this.bigInteger = AbstractC0132a.M(new Version$bigInteger$2(this));
    }
