...
public final class SplitPairRule extends SplitRule {
    ...
    public /* synthetic */ SplitPairRule(Set set, boolean z6, boolean z7, boolean z8, int i, int i3, float f6, int i4, int i5, d dVar) {
        this(set, (i5 & 2) != 0 ? false : z6, (i5 & 4) != 0 ? true : z7, (i5 & 8) != 0 ? false : z8, (i5 & 16) != 0 ? 0 : i, (i5 & 32) != 0 ? 0 : i3, (i5 & 64) != 0 ? 0.5f : f6, (i5 & 128) != 0 ? 3 : i4);
    }
    ...
    public boolean equals(Object other) {
        ...
        return h.a(this.filters, splitPairRule.filters) && this.finishPrimaryWithSecondary == splitPairRule.finishPrimaryWithSecondary && this.finishSecondaryWithPrimary == splitPairRule.finishSecondaryWithPrimary && this.clearTop == splitPairRule.clearTop;
    }
    ...
    @Override // androidx.window.embedding.SplitRule
    public int hashCode() {
        return Boolean.hashCode(this.clearTop) + ((Boolean.hashCode(this.finishSecondaryWithPrimary) + ((Boolean.hashCode(this.finishPrimaryWithSecondary) + ((this.filters.hashCode() + (super.hashCode() * 31)) * 31)) * 31)) * 31);
    }
    ...
    public final SplitPairRule plus$window_release(SplitPairFilter filter) {
        ...
        return new SplitPairRule(m.s0(linkedHashSet), this.finishPrimaryWithSecondary, this.finishSecondaryWithPrimary, this.clearTop, getMinWidth(), getMinSmallestWidth(), getSplitRatio(), getLayoutDirection());
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SplitPairRule(Set<SplitPairFilter> filters, boolean z6, boolean z7, boolean z8, int i, int i3, float f6, int i4) {
        super(i, i3, f6, i4);
        h.f(filters, "filters");
