...
public final class SplitInfo {
    ...
    public SplitInfo(ActivityStack primaryActivityStack, ActivityStack secondaryActivityStack, float f6) {
        h.f(primaryActivityStack, "primaryActivityStack");
        h.f(secondaryActivityStack, "secondaryActivityStack");
    ...
    public boolean equals(Object other) {
        ...
        return h.a(this.primaryActivityStack, splitInfo.primaryActivityStack) && h.a(this.secondaryActivityStack, splitInfo.secondaryActivityStack) && this.splitRatio == splitInfo.splitRatio;
    }
