...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i, int i3, int i4, int i5) {
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i3, int i4, int i5) {
        if (viewHolder == viewHolder2) {
            return animateMove(viewHolder, i, i3, i4, i5);
        }
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i, i3, i4, i5));
        return true;
    }
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i, int i3, int i4, int i5) {
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i, int i3, int i4, int i5) {
        final View view = viewHolder.itemView;
        final int i6 = i4 - i;
        final int i7 = i5 - i3;
        if (i6 != 0) {
    ...
    public static class ChangeInfo {
        ...
        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i3, int i4, int i5) {
