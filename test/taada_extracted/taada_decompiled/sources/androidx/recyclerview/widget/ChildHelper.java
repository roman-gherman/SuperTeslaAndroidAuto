...
class ChildHelper {
    ...
    public static class Bucket {
        ...
        public void insert(int i, boolean z6) {
            if (i >= 64) {
                ensureNext();
                this.mNext.insert(i - 64, z6);
                return;
            }
            long j6 = this.mData;
    ...
    public void attachViewToParent(View view, int i, ViewGroup.LayoutParams layoutParams, boolean z6) {
    ...
    public void addView(View view, int i, boolean z6) {
        int childCount = i < 0 ? this.mCallback.getChildCount() : getOffset(i);
        this.mBucket.insert(childCount, z6);
        if (z6) {
            hideViewInternal(view);
