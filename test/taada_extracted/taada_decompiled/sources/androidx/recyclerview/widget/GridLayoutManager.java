...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static final class DefaultSpanSizeLookup extends SpanSizeLookup {
        ...
        public int getSpanIndex(int i, int i3) {
            return i % i3;
        }
    ...
    public static abstract class SpanSizeLookup {
        ...
        public int getCachedSpanGroupIndex(int i, int i3) {
            if (!this.mCacheSpanGroupIndices) {
                return getSpanGroupIndex(i, i3);
            }
            int i4 = this.mSpanGroupIndexCache.get(i, -1);
            if (i4 != -1) {
                return i4;
            }
            int spanGroupIndex = getSpanGroupIndex(i, i3);
            this.mSpanGroupIndexCache.put(i, spanGroupIndex);
            return spanGroupIndex;
        }

        public int getCachedSpanIndex(int i, int i3) {
            if (!this.mCacheSpanIndices) {
                return getSpanIndex(i, i3);
            }
            int i4 = this.mSpanIndexCache.get(i, -1);
            if (i4 != -1) {
                return i4;
            }
            int spanIndex = getSpanIndex(i, i3);
            this.mSpanIndexCache.put(i, spanIndex);
            return spanIndex;
        }

        public int getSpanGroupIndex(int i, int i3) {
            int spanSize;
            int i4;
            int i5;
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i, int i3) {
        ...
        setSpanCount(RecyclerView.LayoutManager.getProperties(context, attributeSet, i, i3).spanCount);
    }

    private void assignSpans(RecyclerView.Recycler recycler, RecyclerView.State state, int i, boolean z6) {
        int i3;
        int i4;
        int i5;
        int i6 = 0;
    ...
    private void guessMeasurement(float f6, int i) {
        calculateItemBorders(Math.max(Math.round(f6 * this.mSpanCount), i));
    }

    private void measureChild(View view, int i, boolean z6) {
        ...
        if (this.mOrientation == 1) {
            childMeasureSpec2 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, i, i4, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
            ...
            int childMeasureSpec3 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, i, i3, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i, int i3, boolean z6) {
        ...
        if (z6 ? shouldReMeasureChild(view, i, i3, layoutParams) : shouldMeasureChild(view, i, i3, layoutParams)) {
            view.measure(i, i3);
        }
    }
    ...
    public int getSpaceForSpanRange(int i, int i3) {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        while (i6 < this.mSpanCount && layoutState.hasMore(state) && spanIndex > 0) {
            ...
            if (spanSize > this.mSpanCount) {
                ...
                throw new IllegalArgumentException(b.g(sb, " spans.", this.mSpanCount));
            }
            spanIndex -= spanSize;
        ...
        assignSpans(recycler, state, i6, z7);
        float f6 = 0.0f;
        int i8 = 0;
        ...
        for (int i14 = 0; i14 < i6; i14++) {
            ...
            layoutDecoratedWithMargins(view4, i16, paddingTop, i17, i15);
    ...
    */
    ...
    public void setSpanCount(int i) {
        ...
        if (i < 1) {
            throw new IllegalArgumentException(b.c(i, "Span count should be at least 1. Provided "));
        }
        this.mSpanCount = i;
        this.mSpanSizeLookup.invalidateSpanIndexCache();
        requestLayout();
    ...
    public static int[] calculateItemBorders(int[] iArr, int i, int i3) {
        int i4;
        if (iArr == null || iArr.length != i + 1 || iArr[iArr.length - 1] != i3) {
            iArr = new int[i + 1];
        }
        int i5 = 0;
        iArr[0] = 0;
    ...
    public GridLayoutManager(Context context, int i, int i3, boolean z6) {
        super(context, i3, z6);
        this.mPendingSpanCountChange = false;
        this.mSpanCount = -1;
        this.mPreLayoutSpanSizeCache = new SparseIntArray();
