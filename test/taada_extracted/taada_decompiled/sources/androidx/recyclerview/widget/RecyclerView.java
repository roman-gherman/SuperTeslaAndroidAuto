...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void notifyItemRangeChanged(int i, int i3) {
            this.mObservable.notifyItemRangeChanged(i, i3);
        }

        public final void notifyItemRangeInserted(int i, int i3) {
            this.mObservable.notifyItemRangeInserted(i, i3);
        }

        public final void notifyItemRangeRemoved(int i, int i3) {
            this.mObservable.notifyItemRangeRemoved(i, i3);
        }
        ...
        public final void notifyItemRangeChanged(int i, int i3, Object obj) {
            this.mObservable.notifyItemRangeChanged(i, i3, obj);
        }
    }
    ...
    public static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemMoved(int i, int i3) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeMoved(i, i3, 1);
            }
        }

        public void notifyItemRangeChanged(int i, int i3) {
            notifyItemRangeChanged(i, i3, null);
        }

        public void notifyItemRangeInserted(int i, int i3) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeInserted(i, i3);
            }
        }

        public void notifyItemRangeRemoved(int i, int i3) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeRemoved(i, i3);
            }
        }

        public void notifyItemRangeChanged(int i, int i3, Object obj) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeChanged(i, i3, obj);
            }
        }
    }
    ...
    public interface ChildDrawingOrderCallback {
        int onGetChildDrawingOrder(int i, int i3);
    }
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z6) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    throw new IllegalStateException(a.i(this.mRecyclerView, sb));
                }
                if (iIndexOfChild != i) {
        ...
        public static int chooseSize(int i, int i3, int i4) {
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i3) {
            Properties properties = new Properties();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.recyclerview.R.styleable.RecyclerView, i, i3);
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int i, int i3) {
            ...
            return rect.left - i < width && rect.right - i > paddingLeft && rect.top - i3 < height && rect.bottom - i3 > paddingTop;
        }

        private static boolean isMeasurementUpToDate(int i, int i3, int i4) {
        ...
        public void collectAdjacentPrefetchPositions(int i, int i3, State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }
        ...
        public void ignoreView(View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(a.i(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void layoutDecorated(View view, int i, int i3, int i4, int i5) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).mDecorInsets;
            view.layout(i + rect.left, i3 + rect.top, i4 - rect.right, i5 - rect.bottom);
        }

        public void layoutDecoratedWithMargins(View view, int i, int i3, int i4, int i5) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect rect = layoutParams.mDecorInsets;
            view.layout(i + rect.left + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i3 + rect.top + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, (i4 - rect.right) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, (i5 - rect.bottom) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
        }
        ...
        public void onItemsMoved(RecyclerView recyclerView, int i, int i3, int i4) {
        }
        ...
        public void onMeasure(Recycler recycler, State state, int i, int i3) {
            this.mRecyclerView.defaultOnMeasure(i, i3);
        }
        ...
        public void setMeasuredDimensionFromChildren(int i, int i3) {
            ...
            setMeasuredDimension(this.mRecyclerView.mTempRect, i, i3);
        }
        ...
        public boolean shouldMeasureChild(View view, int i, int i3, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), i, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getHeight(), i3, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public boolean shouldReMeasureChild(View view, int i, int i3, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), i, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getMeasuredHeight(), i3, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public boolean requestChildRectangleOnScreen(RecyclerView recyclerView, View view, Rect rect, boolean z6, boolean z7) {
            ...
            if ((z7 && !isFocusedChildVisibleAfterScrolling(recyclerView, i, i3)) || (i == 0 && i3 == 0)) {
                return false;
            }
            if (z6) {
    ...
    public static abstract class OnFlingListener {
        public abstract boolean onFling(int i, int i3);
    }
    ...
    public static class RecycledViewPool {
        ...
        public boolean willBindInTime(int i, long j6, long j7) {
            long j8 = getScrapDataForType(i).mBindRunningAverageNs;
            return j8 == 0 || j6 + j8 < j7;
        }

        public boolean willCreateInTime(int i, long j6, long j7) {
            long j8 = getScrapDataForType(i).mCreateRunningAverageNs;
            return j8 == 0 || j6 + j8 < j7;
        }
    }
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder viewHolder, int i, int i3, long j6) {
        ...
        public void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z6) {
        ...
        public void bindViewToPosition(View view, int i) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(a.i(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder sbJ = b.j(i, "invalid position ", ". State item count is ");
            sbJ.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(a.i(RecyclerView.this, sbJ));
        }
        ...
        public ViewHolder getScrapOrCachedViewForId(long j6, int i, boolean z6) {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z6) {
            ...
            if (z6 || (viewFindHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) == null) {
                int size2 = this.mCachedViews.size();
        ...
        public void offsetPositionRecordsForRemove(int i, int i3, boolean z6) {
            int i4 = i + i3;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ...
                if (viewHolder != null) {
                    ...
                    if (i5 >= i4) {
                        viewHolder.offsetPosition(-i3, z6);
                    } else if (i5 >= i) {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isTmpDetached()) {
                ...
                throw new IllegalArgumentException(a.i(RecyclerView.this, sb2));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(a.i(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
            ...
            if (z || z7 || !zDoesTransientStatePreventRecycling) {
                return;
            }
            viewHolder.mOwnerRecyclerView = null;
        }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(a.i(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        /* JADX WARN: Removed duplicated region for block: B:105:0x0202 A[ADDED_TO_REGION] */
        ...
        */
        ...
        public void viewRangeUpdate(int i, int i3) {
            int i4;
            int i5 = i3 + i;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null && (i4 = viewHolder.mPosition) >= i && i4 < i5) {
        ...
        public View getViewForPosition(int i, boolean z6) {
            return tryGetViewHolderForPositionByDeadline(i, z6, Long.MAX_VALUE).itemView;
        }
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onItemRangeChanged(int i, int i3, Object obj) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(i, i3, obj)) {
        ...
        public void onItemRangeInserted(int i, int i3) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeInserted(i, i3)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int i, int i3, int i4) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeMoved(i, i3, i4)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int i, int i3) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeRemoved(i, i3)) {
                triggerUpdateProcessor();
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(int i, int i3) {
                this(i, i3, Integer.MIN_VALUE, null);
            }
            ...
            public void update(int i, int i3, int i4, Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i3;
                this.mDuration = i4;
                this.mInterpolator = interpolator;
            ...
            public Action(int i, int i3, int i4) {
                this(i, i3, i4, null);
            }

            public Action(int i, int i3, int i4, Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        public void onAnimation(int i, int i3) {
            ...
            if (this.mRunning) {
                onSeekTargetStep(i, i3, recyclerView.mState, this.mRecyclingAction);
        ...
        public abstract void onSeekTargetStep(int i, int i3, State state, Action action);
    ...
    public static abstract class ViewCacheExtension {
        public abstract View getViewForPositionAndType(Recycler recycler, int i, int i3);
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i3, int i4, int i5) {
            int iRound;
            int iAbs = Math.abs(i);
            int iAbs2 = Math.abs(i3);
            boolean z6 = iAbs > iAbs2;
            int iSqrt = (int) Math.sqrt((i5 * i5) + (i4 * i4));
            int iSqrt2 = (int) Math.sqrt((i3 * i3) + (i * i));
            RecyclerView recyclerView = RecyclerView.this;
            int width = z6 ? recyclerView.getWidth() : recyclerView.getHeight();
            int i6 = width / 2;
            float f6 = width;
            float f7 = i6;
            float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (iSqrt2 * 1.0f) / f6)) * f7) + f7;
            if (iSqrt > 0) {
        ...
        public void fling(int i, int i3) {
            ...
            this.mOverScroller.fling(0, 0, i, i3, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i, i3, i8, i9, null, 1, iArr5);
                RecyclerView recyclerView6 = RecyclerView.this;
                int[] iArr6 = recyclerView6.mReusableIntPair;
                int i10 = i8 - iArr6[0];
                int i11 = i9 - iArr6[1];
                if (i != 0 || i3 != 0) {
                    recyclerView6.dispatchOnScrolled(i, i3);
                }
                ...
                if ((smoothScroller2 == null || !smoothScroller2.isPendingInitialRun()) && z6) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i, i3);
                    }
                }
            }
        ...
        public void smoothScrollBy(int i, int i3, int i4, Interpolator interpolator) {
            if (i4 == Integer.MIN_VALUE) {
                i4 = computeScrollDuration(i, i3, 0, 0);
            }
            int i5 = i4;
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, i, i3, i5);
            postOnAnimation();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder sbL = b.l(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
    ...
    private void animateChange(ViewHolder viewHolder, ViewHolder viewHolder2, ItemAnimator.ItemHolderInfo itemHolderInfo, ItemAnimator.ItemHolderInfo itemHolderInfo2, boolean z6, boolean z7) {
    ...
    */
    ...
    private void setAdapterInternal(Adapter adapter, boolean z6, boolean z7) {
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i3) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null || !layoutManager.onAddFocusables(this, arrayList, i, i3)) {
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(a.i(this, b.k(str)));
        }
        throw new IllegalStateException(a.i(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void defaultOnMeasure(int i, int i3) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingRight() + getPaddingLeft(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(i3, getPaddingBottom() + getPaddingTop(), ViewCompat.getMinimumHeight(this)));
    }
    ...
    public boolean dispatchNestedPreScroll(int i, int i3, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i, i3, iArr, iArr2);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedScroll(int i, int i3, int i4, int i5, int[] iArr) {
        return getScrollingChildHelper().dispatchNestedScroll(i, i3, i4, i5, iArr);
    }
    ...
    public boolean fling(int i, int i3) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
        ...
        if (!dispatchNestedPreFling(f6, f7)) {
            ...
            if (z6) {
                ...
                this.mViewFlinger.fling(iMax, Math.max(-i5, Math.min(i3, i5)));
                return true;
            }
        }
        return false;
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z7 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i3 = i == 2 ? 130 : 33;
                z6 = focusFinder.findNextFocus(this, view, i3) == null;
            ...
            if (!z6 && this.mLayout.canScrollHorizontally()) {
                ...
                boolean z8 = focusFinder.findNextFocus(this, view, i4) == null;
                if (FORCE_ABS_FOCUS_SEARCH_DIRECTION) {
                    i = i4;
                }
                z6 = z8;
    ...
    public int getChildDrawingOrder(int i, int i3) {
        ...
        return childDrawingOrderCallback == null ? super.getChildDrawingOrder(i, i3) : childDrawingOrderCallback.onGetChildDrawingOrder(i, i3);
    }
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.6
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void markViewHoldersUpdated(int i, int i3, Object obj) {
                RecyclerView.this.viewRangeUpdate(i, i3, obj);
                RecyclerView.this.mItemsChanged = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForAdd(int i, int i3) {
                RecyclerView.this.offsetPositionRecordsForInsert(i, i3);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForMove(int i, int i3) {
                RecyclerView.this.offsetPositionRecordsForMove(i, i3);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingInvisible(int i, int i3) {
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingLaidOutOrNewView(int i, int i3) {
                RecyclerView.this.offsetPositionRecordsForRemove(i, i3, false);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
    ...
    public void offsetPositionRecordsForInsert(int i, int i3) {
        ...
        this.mRecycler.offsetPositionRecordsForInsert(i, i3);
        requestLayout();
    }
    ...
    public void offsetPositionRecordsForMove(int i, int i3) {
        ...
        this.mRecycler.offsetPositionRecordsForMove(i, i3);
        requestLayout();
    }
    ...
    public void offsetPositionRecordsForRemove(int i, int i3, boolean z6) {
        ...
        for (int i5 = 0; i5 < unfilteredChildCount; i5++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore()) {
                ...
                if (i6 >= i4) {
                    childViewHolderInt.offsetPosition(-i3, z6);
                    this.mState.mStructureChanged = true;
                } else if (i6 >= i) {
                    childViewHolderInt.flagRemovedAndOffsetPosition(i - 1, -i3, z6);
                    this.mState.mStructureChanged = true;
                }
            }
        }
        this.mRecycler.offsetPositionRecordsForRemove(i, i3, z6);
        requestLayout();
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState != 1) {
                int i3 = x6 - this.mInitialTouchX;
                int i4 = y6 - this.mInitialTouchY;
    ...
    */
    ...
    public void requestDisallowInterceptTouchEvent(boolean z6) {
        int size = this.mOnItemTouchListeners.size();
        for (int i = 0; i < size; i++) {
            this.mOnItemTouchListeners.get(i).onRequestDisallowInterceptTouchEvent(z6);
        }
    ...
    public void scrollBy(int i, int i3) {
        ...
        if (zCanScrollHorizontally || zCanScrollVertically) {
            ...
            scrollByInternal(i, i3, null);
        }
    }

    public boolean scrollByInternal(int i, int i3, MotionEvent motionEvent) {
        int i4;
        int i5;
        int i6;
        int i7;
        ...
        int i12 = iArr4[1];
        int i13 = i7 - i12;
        boolean z6 = (i10 == 0 && i12 == 0) ? false : true;
        ...
        return (!z6 && i4 == 0 && i5 == 0) ? false : true;
    }

    public void scrollStep(int i, int i3, int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
    ...
    public void swapAdapter(Adapter adapter, boolean z6) {
        setLayoutFrozen(false);
    ...
    public void viewRangeUpdate(int i, int i3, Object obj) {
        ...
        this.mRecycler.viewRangeUpdate(i, i3);
    }
    ...
    public boolean dispatchNestedPreScroll(int i, int i3, int[] iArr, int[] iArr2, int i4) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i, i3, iArr, iArr2, i4);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int i, int i3, int i4, int i5, int[] iArr, int i6) {
        return getScrollingChildHelper().dispatchNestedScroll(i, i3, i4, i5, iArr, i6);
    }
    ...
    */
    ...
    public void smoothScrollBy(int i, int i3, Interpolator interpolator) {
        smoothScrollBy(i, i3, interpolator, Integer.MIN_VALUE);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean startNestedScroll(int i, int i3) {
        return getScrollingChildHelper().startNestedScroll(i, i3);
    }
    ...
    public final void dispatchNestedScroll(int i, int i3, int i4, int i5, int[] iArr, int i6, int[] iArr2) {
        getScrollingChildHelper().dispatchNestedScroll(i, i3, i4, i5, iArr, i6, iArr2);
    }

    public void smoothScrollBy(int i, int i3, Interpolator interpolator, int i4) {
        smoothScrollBy(i, i3, interpolator, i4, false);
    }
    ...
    public void smoothScrollBy(int i, int i3, Interpolator interpolator, int i4, boolean z6) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
        ...
        this.mViewFlinger.smoothScrollBy(i, i3, i4, interpolator);
    }
