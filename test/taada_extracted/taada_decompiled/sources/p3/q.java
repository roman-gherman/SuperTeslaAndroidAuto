...
public final class q implements StateFlow, CancellableFlow, FusibleFlow {
    ...
    public final /* synthetic */ MutableStateFlow f4490a;

    public q(MutableStateFlow mutableStateFlow) {
        this.f4490a = mutableStateFlow;
    }

    @Override // kotlinx.coroutines.flow.SharedFlow, kotlinx.coroutines.flow.Flow
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        return this.f4490a.collect(flowCollector, continuation);
    }
    ...
    public final List getReplayCache() {
        return this.f4490a.getReplayCache();
    }
