...
public class u extends AbstractC0785b implements MutableSharedFlow, CancellableFlow, FusibleFlow {
    ...
    public final EnumC0743a f4496f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public Object[] f4497g;
    ...
    */
    public static void g(p3.u r8, kotlinx.coroutines.flow.FlowCollector r9, kotlin.coroutines.Continuation r10) {
        ...
        L79:
            ...
            E1.h r6 = p3.v.f4501a     // Catch: java.lang.Throwable -> L38
            if (r10 != r6) goto L92
            r0.f4493a = r5     // Catch: java.lang.Throwable -> L38
            r0.b = r2     // Catch: java.lang.Throwable -> L38
            r0.c = r9     // Catch: java.lang.Throwable -> L38
            r0.d = r8     // Catch: java.lang.Throwable -> L38
            r0.f4495g = r4     // Catch: java.lang.Throwable -> L38
        ...
        La0:
            ...
            r0.c = r9     // Catch: java.lang.Throwable -> L38
            r0.d = r8     // Catch: java.lang.Throwable -> L38
            r0.f4495g = r3     // Catch: java.lang.Throwable -> L38
    ...
    public final Object emit(Object obj, Continuation continuation) throws Throwable {
        ...
        c0672f.initCancellability();
        Continuation[] continuationArrJ2 = AbstractC0786c.f4652a;
        synchronized (this) {
            try {
                if (m(obj)) {
                    try {
                    ...
                    try {
                        s sVar2 = new s(this, k() + ((long) (this.f4499j + this.f4500k)), obj, c0672f);
                        i(sVar2);
                        this.f4500k++;
                        if (this.e == 0) {
    ...
    public final void f() {
        if (this.e != 0 || this.f4500k > 1) {
            ...
            while (this.f4500k > 0) {
                ...
                int i = this.f4499j;
                int i3 = this.f4500k;
                if (objArr[((int) ((jK + ((long) (i + i3))) - 1)) & (objArr.length - 1)] != v.f4501a) {
                    return;
                }
                this.f4500k = i3 - 1;
                v.b(objArr, k() + ((long) (this.f4499j + this.f4500k)), null);
            }
        }
    }
    ...
    public final List getReplayCache() {
        synchronized (this) {
            int iK = (int) ((k() + ((long) this.f4499j)) - this.f4498h);
            if (iK == 0) {
            ...
            kotlin.jvm.internal.h.c(objArr);
            for (int i = 0; i < iK; i++) {
                arrayList.add(objArr[((int) (this.f4498h + ((long) i))) & (objArr.length - 1)]);
            }
            return arrayList;
        }
    }
    ...
    public final void h() {
        ...
        if (this.i < jK) {
            if (this.b != 0 && (abstractC0787dArr = this.f4651a) != null) {
    ...
    public final void i(Object obj) {
        int i = this.f4499j + this.f4500k;
        Object[] objArrL = this.f4497g;
        if (objArrL == null) {
            objArrL = l(null, 0, 2);
    ...
    public final long k() {
        return Math.min(this.i, this.f4498h);
    }
    ...
    */
    ...
    public final long n(w wVar) {
        long j6 = wVar.f4502a;
        if (j6 < k() + ((long) this.f4499j)) {
            return j6;
        }
        if (this.e <= 0 && j6 <= k() && this.f4500k != 0) {
            return j6;
        }
        return -1L;
    }
    ...
    public final Object o(w wVar) {
        Object obj;
        Continuation[] continuationArrQ = AbstractC0786c.f4652a;
        synchronized (this) {
            try {
                long jN = n(wVar);
                if (jN < 0) {
    ...
    public final void p(long j6, long j7, long j8, long j9) {
        ...
        this.f4498h = j6;
        this.i = j7;
        this.f4499j = (int) (j8 - jMin);
        this.f4500k = (int) (j9 - j8);
    }
    ...
    public final Continuation[] q(long j6) {
        ...
        AbstractC0787d[] abstractC0787dArr;
        long j8 = this.i;
        Continuation[] continuationArr3 = AbstractC0786c.f4652a;
        if (j6 <= j8) {
            long jK = k();
            long j9 = ((long) this.f4499j) + jK;
            int i4 = this.e;
            if (i4 == 0 && this.f4500k > 0) {
                j9++;
            }
            int i5 = 0;
            if (this.b != 0 && (abstractC0787dArr = this.f4651a) != null) {
                for (AbstractC0787d abstractC0787d : abstractC0787dArr) {
                    if (abstractC0787d != null) {
                        long j10 = ((w) abstractC0787d).f4502a;
                        if (j10 >= 0 && j10 < j9) {
                            j9 = j10;
                        }
                    }
            ...
            if (j9 > this.i) {
                long jK2 = k() + ((long) this.f4499j);
                int iMin = this.b > 0 ? Math.min(this.f4500k, i4 - ((int) (jK2 - j9))) : this.f4500k;
                long j11 = ((long) this.f4500k) + jK2;
                E1.h hVar = v.f4501a;
                if (iMin > 0) {
                ...
                long jMax = Math.max(this.f4498h, jK2 - ((long) Math.min(i3, i7)));
                if (i == 0 && jMax < j11) {
                    Object[] objArr2 = this.f4497g;
    ...
    public final void resetReplayCache() throws Throwable {
        synchronized (this) {
            try {
                try {
                    p(k() + ((long) this.f4499j), this.i, k() + ((long) this.f4499j), k() + ((long) this.f4499j) + ((long) this.f4500k));
                } catch (Throwable th) {
                    th = th;
                    throw th;
                }
    ...
    public final boolean tryEmit(Object obj) {
        int i;
        boolean z6;
        Continuation[] continuationArrJ = AbstractC0786c.f4652a;
        synchronized (this) {
            if (m(obj)) {
