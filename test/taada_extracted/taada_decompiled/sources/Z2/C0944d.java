...
public final class C0944d implements Annotations {
    ...
    public C0944d(C0946f c, JavaAnnotationOwner annotationOwner, boolean z6) {
        ...
        this.c = z6;
        this.d = c.f5203a.f5183a.createMemoizedFunctionWithNullableValues(new q(this, 5));
    }
    ...
    public final AnnotationDescriptor findAnnotation(L2.c fqName) {
        ...
        L2.f fVar = AbstractC0916c.f5112a;
        return AbstractC0916c.a(fqName, javaAnnotationOwner, this.f5201a);
    }
    ...
    public final Iterator<AnnotationDescriptor> iterator() {
        ...
        L2.f fVar = AbstractC0916c.f5112a;
        return new k3.e(m.x(m.A(j.u(new Sequence[]{uVarD, j.u(new Object[]{AbstractC0916c.a(o.f3752m, javaAnnotationOwner, this.f5201a)})})), p.d));
    }
}
