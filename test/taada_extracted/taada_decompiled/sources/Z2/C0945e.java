...
public final class C0945e implements PackageFragmentProviderOptimized {
    ...
    public C0945e(C0941a c0941a) {
        this.f5202a = new C0946f(c0941a, C0943c.b, new N1.b(null));
        this.b = c0941a.f5183a.createCacheWithNotNullValues();
    }

    public final t a(L2.c cVar) {
        return (t) this.b.computeIfAbsent(cVar, new y(17, this, this.f5202a.f5203a.b.findPackage(cVar, true)));
    }
    ...
    public final boolean isEmpty(L2.c fqName) {
        h.f(fqName, "fqName");
        this.f5202a.f5203a.b.findPackage(fqName, true);
        return false;
    }

    public final String toString() {
        return "LazyJavaPackageFragmentProvider of module " + this.f5202a.f5203a.f5192o;
    }
}
