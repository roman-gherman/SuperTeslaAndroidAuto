...
public final class C0855b implements CancellableContinuation, Waiter {
    ...
    public final boolean cancel(Throwable th) {
        return this.f4940a.cancel(th);
    }

    @Override // kotlinx.coroutines.CancellableContinuation
    public final void completeResume(Object obj) {
        this.f4940a.completeResume(obj);
    }
    ...
    public final Object tryResume(Object obj, Object obj2, Function1 function1) {
        ...
        E1.h hVarV = this.f4940a.v((N1.m) obj, obj2, c0854a);
        if (hVarV != null) {
            g.f4945h.set(gVar, this.b);
        }
        return hVarV;
    }
}
