...
public final class g extends k implements Mutex {
    ...
    public static final AtomicReferenceFieldUpdater f4945h = AtomicReferenceFieldUpdater.newUpdater(g.class, Object.class, "owner");

    @Volatile
    @Nullable
    private volatile Object owner = h.f4947a;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final f f4946g = new f(this);

    @Override // kotlinx.coroutines.sync.Mutex
    public final SelectClause2 getOnLock() {
        C0857d c0857d = C0857d.f4942a;
        z.d(3, c0857d);
        e eVar = e.f4943a;
        z.d(3, eVar);
        return new t(this, c0857d, eVar, this.f4946g);
    }

    @Override // kotlinx.coroutines.sync.Mutex
    public final boolean holdsLock(Object obj) {
        while (isLocked()) {
            Object obj2 = f4945h.get(this);
            if (obj2 != h.f4947a) {
                return obj2 == obj;
            }
        }
    ...
    */
    public final java.lang.Object lock(java.lang.Object r4, kotlin.coroutines.Continuation r5) {
        ...
        L16:
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r4 = v3.k.f4950f     // Catch: java.lang.Throwable -> L3b
            int r4 = r4.getAndDecrement(r3)     // Catch: java.lang.Throwable -> L3b
            r2 = 1
            if (r4 > r2) goto L16
            if (r4 <= 0) goto L27
            t2.q r4 = r3.f4951a     // Catch: java.lang.Throwable -> L3b
    ...
    public final String toString() {
        return "Mutex@" + AbstractC0690y.e(this) + "[isLocked=" + isLocked() + ",owner=" + f4945h.get(this) + ']';
    }
    ...
    public final void unlock(Object obj) {
        while (isLocked()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4945h;
