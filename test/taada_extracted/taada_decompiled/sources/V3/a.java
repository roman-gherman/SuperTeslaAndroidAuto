...
public final class a implements MLKEMPrivateKey {
    ...
    public final void a(C3.a aVar) {
        ...
        this.f1374a = dVar;
        this.b = e.c(Y3.c.a(((z4.c) dVar.b).f5211a).f1489a);
    }
    ...
    public final Y3.c getParameterSpec() {
        return Y3.c.a(((z4.c) this.f1374a.b).f5211a);
    }
    ...
    public final MLKEMPrivateKey getPrivateKey(boolean z6) {
        return (!z6 || g5.c.c(this.f1374a.f5214h) == null) ? new a(this.f1374a.n(2)) : new a(this.f1374a.n(1));
    }

    @Override // org.bouncycastle.jcajce.interfaces.MLKEMPrivateKey
    public final MLKEMPublicKey getPublicKey() {
        z4.d dVar = this.f1374a;
        return new b(new z4.e((z4.c) dVar.b, dVar.f5212f, dVar.f5213g));
    }

    @Override // org.bouncycastle.jcajce.interfaces.MLKEMPrivateKey
    public final byte[] getSeed() {
        return g5.c.c(this.f1374a.f5214h);
    }
    ...
    public final String toString() {
        ...
        String str = e.f3346a;
        z4.d dVar = this.f1374a;
        byte[] bArrE = g5.c.e(dVar.f5212f, dVar.f5213g);
        sb.append(this.b);
