...
public final class C0586e implements Function0 {
    ...
    public final Object invoke() {
        ...
        switch (this.f3705a) {
            case 0:
                return Arrays.asList(iVar.k().getPackage(p.f3767k), iVar.k().getPackage(p.f3769m), iVar.k().getPackage(p.f3770n), iVar.k().getPackage(p.f3768l));
            default:
                EnumMap enumMap = new EnumMap(k.class);
                HashMap map = new HashMap();
                HashMap map2 = new HashMap();
                for (k kVar : k.values()) {
                    String strB = kVar.f3720a.b();
                    if (strB == null) {
                        iVar.getClass();
                        i.a(46);
                        throw null;
