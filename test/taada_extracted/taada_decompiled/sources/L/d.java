...
public final class d implements TransportBackend {
    ...
    public d(Context context, Clock clock, Clock clock2) {
        K0.d dVar = new K0.d();
        h.f3998a.configure(dVar);
        dVar.d = true;
        this.f3953a = new g(dVar, 8);
        this.c = context;
    ...
    public final e send(n.d dVar) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                aVar.f117g = new m.o((v) v.f4017a.get(oVar3.b("net-type")), (u) u.f4016a.get(oVar3.b("mobile-subtype")));
                Integer num = iVar.b;
                if (num != null) {
                    aVar.c = num;
                }
