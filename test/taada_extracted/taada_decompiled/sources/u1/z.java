...
public abstract class z {
    ...
    public static final List f4883a = Z.p("");
    ...
    public static final void c(y yVar, String urlString) {
        ...
        if (yVar.f4878a.f4845a.equals("file")) {
            if (i13 != 2) {
                if (i13 != 3) {
        ...
        if (yVar.f4878a.f4845a.equals("mailto")) {
            if (i13 != 0) {
        ...
        List list = kotlin.collections.u.f3804a;
        List list2 = f4883a;
        if (i6 >= i11) {
        ...
        yVar.f4881h = i13 == 0 ? kotlin.collections.m.N(yVar.f4881h) : list;
        ...
        if (iIntValue3 > i6) {
            ...
            List list3 = (yVar.f4881h.size() == i4 && ((CharSequence) kotlin.collections.m.P(yVar.f4881h)).length() == 0) ? list : yVar.f4881h;
            ...
            yVar.f4881h = kotlin.collections.m.b0(kotlin.collections.m.b0(listQ, list), list3);
            i6 = iIntValue3;
        }
        if (i6 < i11 && urlString.charAt(i6) == '?') {
            int i17 = i6 + 1;
