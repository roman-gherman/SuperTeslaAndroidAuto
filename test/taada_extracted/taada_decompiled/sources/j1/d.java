...
public final class d extends U1.g implements Function3 {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        switch (this.f3648a) {
            case 0:
                d dVar = new d(this.c, (e) this.f3649f, (Continuation) obj3);
                dVar.d = (E1.f) obj;
                dVar.e = obj2;
                return dVar.invokeSuspend(N1.m.f1129a);
            case 1:
                g1.f fVar = this.c;
                d dVar2 = new d((D) this.f3649f, fVar, (Continuation) obj3, 1);
                dVar2.d = (Sender) obj;
                dVar2.e = (q1.c) obj2;
                return dVar2.invokeSuspend(N1.m.f1129a);
            case 2:
                g1.f fVar2 = this.c;
                d dVar3 = new d((L) this.f3649f, fVar2, (Continuation) obj3, 2);
                dVar3.d = (E1.f) obj;
                dVar3.e = obj2;
                return dVar3.invokeSuspend(N1.m.f1129a);
            default:
                g1.f fVar3 = this.c;
                d dVar4 = new d((P) this.f3649f, fVar3, (Continuation) obj3, 3);
                dVar4.d = (Sender) obj;
                dVar4.e = (q1.c) obj2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        v1.d dVar = v1.d.f4927a;
        g1.f fVar3 = this.c;
        Object obj2 = this.f3649f;
        ...
        switch (this.f3648a) {
            case 0:
                ...
                if (i == 0) {
                    ...
                    if (obj3 == null) {
                        ...
                        cVar2.a(kotlin.reflect.l.i0(kotlin.reflect.l.F(kTypeA), w.f3817a.b(Object.class), kTypeA));
                        ...
                        cVar2.a(kotlin.reflect.l.i0(kotlin.reflect.l.F(kTypeA2), w.f3817a.b(Object.class), kTypeA2));
                    }
                    vVar.d(AbstractC0809b.b);
                    C0835D c0835dB = cVar2.f4512a.b();
                    r rVar = cVar2.b;
                    u1.n nVar = new u1.n((Map) cVar2.c.f4279a);
                    Object obj4 = cVar2.d;
                    ...
                    Iterator it = requestData.f4516g.iterator();
                    do {
                        eVar = (e) obj2;
                        if (!it.hasNext()) {
                            this.d = fVar;
            ...
            case 1:
                ...
                ((D) obj2).getClass();
                if (!E.f4035a.contains(c0494b2.c().getMethod())) {
                    return c0494b2;
                }
                C0632a c0632a = D.f4034a;
                this.d = null;
                this.e = null;
                this.b = 2;
                ...
                if (i4 == 0) {
                    ...
                    if (obj6 instanceof v1.g) {
                        ...
                        if (obj6 == null) {
                            ...
                            cVar3.a(kotlin.reflect.l.i0(kotlin.reflect.l.F(kTypeA3), w.f3817a.b(v1.g.class), kTypeA3));
                        } else if (obj6 != null) {
                            cVar3.getClass();
                            ...
                            cVar3.a(kotlin.reflect.l.i0(kotlin.reflect.l.F(kTypeA4), w.f3817a.b(v1.g.class), kTypeA4));
                        }
                        L l6 = (L) obj2;
                        l6.getClass();
                        Sender j6 = new J(fVar3);
                        ArrayList arrayList2 = l6.f4042a;
                    ...
                    String str = "\n|Fail to prepare request body for sending. \n|The body type is: " + w.f3817a.b(obj6.getClass()) + ", with Content-Type: " + k1.j.e((HttpMessageBuilder) fVar2.f289a) + ".\n|\n|If you expect serialized body, please check that you have installed the corresponding plugin(like `ContentNegotiation`) and set `Content-Type` header.";
            ...
            default:
                ...
                C0832A c0832a = cVar5.f4512a.f4878a;
                kotlin.jvm.internal.h.f(c0832a, "<this>");
                String str3 = c0832a.f4845a;
                if (str3.equals("ws") || str3.equals("wss")) {
                    ...
                    O o6 = P.d;
                    z1.a aVar2 = f.f3651a;
                    z1.f fVar6 = cVar5.f4513f;
                    Map map = (Map) fVar6.getOrNull(aVar2);
                    M m6 = (M) (map != null ? map.get(o6) : null);
                    P p5 = (P) obj2;
                    if (m6 == null && (p5.f4045a != null || p5.b != null || p5.c != null)) {
                        m6 = new M();
                        ((Map) fVar6.computeIfAbsent(aVar2, q1.b.f4511a)).put(o6, m6);
                    }
                    if (m6 != null) {
                        Long l7 = m6.b;
                        if (l7 == null) {
