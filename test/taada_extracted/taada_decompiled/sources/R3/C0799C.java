...
public final class C0799C implements CoroutineContext.Key {
    ...
    public final ThreadLocal f4697a;

    public C0799C(ThreadLocal threadLocal) {
        this.f4697a = threadLocal;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof C0799C) && kotlin.jvm.internal.h.a(this.f4697a, ((C0799C) obj).f4697a);
    }
    ...
    public final String toString() {
        return "ThreadLocalKey(threadLocal=" + this.f4697a + ')';
    }
}
