...
public class D {
    ...
    public ThreadSafeHeapNode[] f4698a;

    public final void a(N n6) {
        n6.setHeap(this);
        ThreadSafeHeapNode[] threadSafeHeapNodeArr = this.f4698a;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = b;
        if (threadSafeHeapNodeArr == null) {
            threadSafeHeapNodeArr = new ThreadSafeHeapNode[4];
            this.f4698a = threadSafeHeapNodeArr;
    ...
    */
    public final kotlinx.coroutines.internal.ThreadSafeHeapNode b(int r9) {
        /*
            r8 = this;
            kotlinx.coroutines.internal.ThreadSafeHeapNode[] r0 = r8.f4698a
        ...
        L3c:
            ...
            goto L80
        L47:
            kotlinx.coroutines.internal.ThreadSafeHeapNode[] r5 = r8.f4698a
            kotlin.jvm.internal.h.c(r5)
            int r2 = r2 + 2
            int r6 = r1.get(r8)
            if (r2 >= r6) goto L67
