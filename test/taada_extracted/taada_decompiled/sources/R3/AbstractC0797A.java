...
public abstract class AbstractC0797A {
    ...
    public static final E1.h f4695a = new E1.h("NO_THREAD_ELEMENTS", 9);
    public static final x b = x.f4722a;
    public static final y c = y.f4723a;
    public static final z d = z.f4724a;
    ...
    public static final Object c(CoroutineContext coroutineContext, Object obj) {
        ...
        return obj == 0 ? f4695a : obj instanceof Integer ? coroutineContext.fold(new E(((Number) obj).intValue(), coroutineContext), d) : ((ThreadContextElement) obj).updateThreadContext(coroutineContext);
    }
}
