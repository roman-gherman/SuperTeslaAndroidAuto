...
public abstract class AbstractC0615a {
    ...
    public static final int[] f3956a = {R.attr.state_pressed};
    ...
    public static final String f3957f = AbstractC0615a.class.getSimpleName();
    ...
    public static ColorStateList b(ColorStateList colorStateList) {
        ...
        if (Build.VERSION.SDK_INT <= 27 && Color.alpha(colorStateList.getDefaultColor()) == 0 && Color.alpha(colorStateList.getColorForState(e, 0)) != 0) {
            Log.w(f3957f, "Use a non-transparent color for the default color as it will be used to finish ripple animations.");
        }
