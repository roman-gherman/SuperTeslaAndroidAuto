...
public final class SavedStateViewModelFactoryKt {
    ...
    public static final <T> Constructor<T> findMatchingConstructor(Class<T> modelClass, List<? extends Class<?>> signature) {
        ...
        h.e(constructors, "modelClass.constructors");
        for (Object obj : constructors) {
            Constructor<T> constructor = (Constructor<T>) obj;
            Class<?>[] parameterTypes = constructor.getParameterTypes();
            h.e(parameterTypes, "constructor.parameterTypes");
            List listL = j.L(parameterTypes);
            if (signature.equals(listL)) {
                return constructor;
            }
            if (signature.size() == listL.size() && listL.containsAll(signature)) {
    ...
    public static final <T extends ViewModel> T newInstance(Class<T> modelClass, Constructor<T> constructor, Object... params) {
        ...
        try {
            ...
            throw new RuntimeException(a.j(modelClass, "Failed to access "), e);
        } catch (InstantiationException e6) {
            throw new RuntimeException(a.k(modelClass, "A ", " cannot be instantiated."), e6);
        } catch (InvocationTargetException e7) {
            throw new RuntimeException(a.j(modelClass, "An exception happened in constructor of "), e7.getCause());
        }
    }
}
