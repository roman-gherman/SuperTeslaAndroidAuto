...
public final class Transformations {
    ...
    public static final class AnonymousClass1<X> extends i implements Function1<X, m> {
        ...
        public final void invoke2(X x) {
            ...
            if (this.$firstTime.f3813a || ((value == null && x != null) || !(value == null || value.equals(x)))) {
                this.$firstTime.f3813a = false;
    ...
    public static final class C01961<X> extends i implements Function1<X, m> {
        ...
        public final void invoke2(X x) {
            ...
            Object obj = this.$liveData.f3816a;
            if (obj != liveData) {
                if (obj != null) {
