...
public final class y1 extends com.google.crypto.tink.shaded.protobuf.O implements KmsEnvelopeAeadKeyFormatOrBuilder {
    ...
    public final C0058h1 getDekTemplate() {
        return ((z1) this.b).getDekTemplate();
    }

    @Override // com.google.crypto.tink.proto.KmsEnvelopeAeadKeyFormatOrBuilder
    public final String getKekUri() {
        return ((z1) this.b).getKekUri();
    }

    @Override // com.google.crypto.tink.proto.KmsEnvelopeAeadKeyFormatOrBuilder
    public final AbstractC0381o getKekUriBytes() {
        return ((z1) this.b).getKekUriBytes();
    }

    @Override // com.google.crypto.tink.proto.KmsEnvelopeAeadKeyFormatOrBuilder
    public final boolean hasDekTemplate() {
        return ((z1) this.b).hasDekTemplate();
    }
