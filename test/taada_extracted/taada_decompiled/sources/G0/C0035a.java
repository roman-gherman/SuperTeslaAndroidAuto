...
public final class C0035a extends com.google.crypto.tink.shaded.protobuf.O implements AesCmacKeyOrBuilder {
    ...
    public final AbstractC0381o getKeyValue() {
        return ((C0038b) this.b).getKeyValue();
    }

    @Override // com.google.crypto.tink.proto.AesCmacKeyOrBuilder
    public final C0050f getParams() {
        return ((C0038b) this.b).getParams();
    }

    @Override // com.google.crypto.tink.proto.AesCmacKeyOrBuilder
    public final int getVersion() {
        return ((C0038b) this.b).getVersion();
    }

    @Override // com.google.crypto.tink.proto.AesCmacKeyOrBuilder
    public final boolean hasParams() {
        return ((C0038b) this.b).hasParams();
    }
