...
public final class C0093w extends com.google.crypto.tink.shaded.protobuf.O implements AesEaxKeyOrBuilder {
    ...
    public final AbstractC0381o getKeyValue() {
        return ((C0095x) this.b).getKeyValue();
    }

    @Override // com.google.crypto.tink.proto.AesEaxKeyOrBuilder
    public final B getParams() {
        return ((C0095x) this.b).getParams();
    }

    @Override // com.google.crypto.tink.proto.AesEaxKeyOrBuilder
    public final int getVersion() {
        return ((C0095x) this.b).getVersion();
    }

    @Override // com.google.crypto.tink.proto.AesEaxKeyOrBuilder
    public final boolean hasParams() {
        return ((C0095x) this.b).hasParams();
    }
