...
public final class L0 extends com.google.crypto.tink.shaded.protobuf.O implements JwtEcdsaPublicKeyOrBuilder {
    ...
    public final K0 getAlgorithm() {
        return ((O0) this.b).getAlgorithm();
    }

    @Override // com.google.crypto.tink.proto.JwtEcdsaPublicKeyOrBuilder
    public final int getAlgorithmValue() {
        return ((O0) this.b).getAlgorithmValue();
    }

    @Override // com.google.crypto.tink.proto.JwtEcdsaPublicKeyOrBuilder
    public final N0 getCustomKid() {
        return ((O0) this.b).getCustomKid();
    }
    ...
    public final int getVersion() {
        return ((O0) this.b).getVersion();
    }

    @Override // com.google.crypto.tink.proto.JwtEcdsaPublicKeyOrBuilder
    public final AbstractC0381o getX() {
        return ((O0) this.b).getX();
    }

    @Override // com.google.crypto.tink.proto.JwtEcdsaPublicKeyOrBuilder
    public final AbstractC0381o getY() {
        return ((O0) this.b).getY();
    }

    @Override // com.google.crypto.tink.proto.JwtEcdsaPublicKeyOrBuilder
    public final boolean hasCustomKid() {
        return ((O0) this.b).hasCustomKid();
    }
