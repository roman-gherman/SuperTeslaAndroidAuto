...
public final class G extends com.google.crypto.tink.shaded.protobuf.O implements AesGcmHkdfStreamingParamsOrBuilder {
    ...
    public final int getCiphertextSegmentSize() {
        return ((H) this.b).getCiphertextSegmentSize();
    }
    ...
    public final int getDerivedKeySize() {
        return ((H) this.b).getDerivedKeySize();
    }

    @Override // com.google.crypto.tink.proto.AesGcmHkdfStreamingParamsOrBuilder
    public final EnumC0086s0 getHkdfHashType() {
        return ((H) this.b).getHkdfHashType();
    }

    @Override // com.google.crypto.tink.proto.AesGcmHkdfStreamingParamsOrBuilder
    public final int getHkdfHashTypeValue() {
        return ((H) this.b).getHkdfHashTypeValue();
    }
