...
public final class C0923j extends C0915b {
    ...
    public static final /* synthetic */ KProperty[] f5121h;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final NotNullLazyValue f5122g;

    static {
        x xVar = w.f3817a;
        f5121h = new KProperty[]{xVar.f(new q(xVar.b(C0923j.class), "allValueArguments", "getAllValueArguments()Ljava/util/Map;"))};
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0923j(JavaAnnotation annotation, C0946f c) {
        super(c, annotation, o.f3758t);
        kotlin.jvm.internal.h.f(annotation, "annotation");
        kotlin.jvm.internal.h.f(c, "c");
        this.f5122g = c.f5203a.f5183a.createLazyValue(new C0866A(this, 2));
    }
    ...
    public final Map getAllValueArguments() {
        return (Map) AbstractC0246d.T(this.f5122g, f5121h[0]);
    }
}
