...
public final class o {
    ...
    public final r a(DeclarationDescriptor declarationDescriptor) {
        ...
        if (declarationDescriptor instanceof kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.g) {
            return ((kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.g) declarationDescriptor).f3908w;
        }
        return null;
    }
    ...
    public final kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.b d(C0113m c0113m, boolean z6) {
        ...
        int i = c0113m.d;
        a aVar = a.f1412a;
        kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.b bVar = new kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.b(classDescriptor, null, b(c0113m, i, aVar), z6, EnumC0709a.f4226a, c0113m, iVar.b, iVar.d, iVar.e, iVar.f1435g, null);
        i iVarA = iVar.a(bVar, kotlin.collections.u.f3804a, iVar.b, iVar.d, iVar.e, iVar.f1434f);
        List list = c0113m.e;
        ...
        bVar.f4638r = classDescriptor.isExpect();
        bVar.f4642w = !I2.e.f781n.c(c0113m.d).booleanValue();
        return bVar;
    }
    ...
    public final kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.o e(C0125z proto) {
        ...
        oVar.u(wVarK, thisAsReceiverParameter, arrayList2, listO0, iVarA.i.g(list3, proto, aVar2), yVar.f(kotlin.reflect.l.Z(proto, fVar)), h.b((B) I2.e.e.c(i4)), C5.f.s((k0) I2.e.d.c(i4)), kotlin.collections.v.f3805a);
        oVar.f4634m = I2.e.f783p.c(i4).booleanValue();
        oVar.f4635n = I2.e.q.c(i4).booleanValue();
        oVar.f4636o = I2.e.f786t.c(i4).booleanValue();
        oVar.f4637p = I2.e.f784r.c(i4).booleanValue();
        oVar.q = I2.e.f785s.c(i4).booleanValue();
        oVar.f4641v = I2.e.u.c(i4).booleanValue();
        oVar.f4638r = I2.e.f787v.c(i4).booleanValue();
        oVar.f4642w = !I2.e.f788w.c(i4).booleanValue();
