...
public final class m {
    ...
    public final AtomicReferenceArray f4840a = new AtomicReferenceArray(128);
    ...
    public final h a(h hVar) {
        ...
        while (true) {
            AtomicReferenceArray atomicReferenceArray = this.f4840a;
    ...
    public final h b() {
        ...
        while (true) {
            ...
            int i3 = i & 127;
            if (atomicIntegerFieldUpdater.compareAndSet(this, i, i + 1) && (hVar = (h) this.f4840a.getAndSet(i3, null)) != null) {
                if (hVar.b.f4834a == 1) {
