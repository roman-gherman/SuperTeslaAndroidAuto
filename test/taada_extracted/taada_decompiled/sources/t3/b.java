...
public final class b implements Executor, Closeable {
    ...
    public static final AtomicLongFieldUpdater f4824h = AtomicLongFieldUpdater.newUpdater(b.class, "parkedWorkersStack");
    public static final AtomicLongFieldUpdater i = AtomicLongFieldUpdater.newUpdater(b.class, "controlState");

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static final AtomicIntegerFieldUpdater f4825j = AtomicIntegerFieldUpdater.newUpdater(b.class, "_isTerminated");

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public static final E1.h f4826k = new E1.h("NOT_IN_STACK", 9);
    ...
    public final int a() {
        synchronized (this.f4829g) {
            try {
                ...
                if (i5 <= 0 || this.f4829g.b(i5) != null) {
                    throw new IllegalArgumentException("Failed requirement.");
                }
                C0828a c0828a = new C0828a(this, i5);
                this.f4829g.c(i5, c0828a);
    ...
    public final void b(Runnable runnable, i iVar, boolean z6) {
        ...
        if (runnable instanceof h) {
            jVar = (h) runnable;
            jVar.f4833a = jNanoTime;
            jVar.b = iVar;
        } else {
            jVar = new j(runnable, jNanoTime, iVar);
        }
        boolean z7 = false;
        boolean z8 = jVar.b.f4834a == 1;
        AtomicLongFieldUpdater atomicLongFieldUpdater = i;
        ...
        if (c0828a == null || !kotlin.jvm.internal.h.a(c0828a.f4823h, this)) {
            c0828a = null;
        }
        if (c0828a != null && (i3 = c0828a.c) != 5 && (jVar.b.f4834a != 0 || i3 != 2)) {
            c0828a.f4822g = true;
            m mVar = c0828a.f4820a;
            if (z6) {
                jVar = mVar.a(jVar);
            } else {
                mVar.getClass();
        ...
        if (jVar != null) {
            if (!(jVar.b.f4834a == 1 ? this.f4828f.a(jVar) : this.e.a(jVar))) {
    ...
    */
    public final void close() throws java.lang.InterruptedException {
        /*
            r8 = this;
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r0 = t3.b.f4825j
            r1 = 0
            r2 = 1
        ...
        L88:
            ...
            r0.h(r1)
        La2:
            java.util.concurrent.atomic.AtomicLongFieldUpdater r0 = t3.b.f4824h
            r1 = 0
            r0.set(r8, r1)
    ...
    public final void d(C0828a c0828a, int i3, int i4) {
        while (true) {
            ...
            if (i5 >= 0) {
                if (f4824h.compareAndSet(this, j6, ((long) i5) | j7)) {
                    return;
                }
            }
        }
    ...
    public final boolean f() {
        ...
        int iB;
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = f4824h;
            long j6 = atomicLongFieldUpdater.get(this);
            C0828a c0828a = (C0828a) this.f4829g.b((int) (2097151 & j6));
            if (c0828a == null) {
                c0828a = null;
            } else {
                long j7 = (2097152 + j6) & (-2097152);
