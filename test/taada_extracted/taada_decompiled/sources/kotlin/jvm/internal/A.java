...
public final class A implements KType {
    ...
    public A(KClass classifier) {
        ...
        this.f3808a = classifier;
        this.b = arguments;
    }

    public final String a(boolean z6) {
        String name;
        KClass kClass = this.f3808a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!h.a(this.f3808a, ((A) obj).f3808a)) {
            return false;
        }
        List list = Collections.EMPTY_LIST;
    ...
    public final int hashCode() {
        return Integer.hashCode(0) + androidx.constraintlayout.core.motion.a.d(Collections.EMPTY_LIST, this.f3808a.hashCode() * 31, 31);
    }
