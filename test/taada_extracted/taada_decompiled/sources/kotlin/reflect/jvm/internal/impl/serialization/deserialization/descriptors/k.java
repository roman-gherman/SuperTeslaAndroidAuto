    ...
    public final Object invoke() {
        switch (this.f3916a) {
            ...
            case 2:
                ...
                g gVar = (g) tVar.e;
                Iterator it = gVar.f3901n.getSupertypes().iterator();
                while (it.hasNext()) {
            ...
            default:
                q qVar = (q) this.b;
                X2.i iVar2 = qVar.f3937k;
                return kotlin.collections.m.o0(iVar2.f1433a.e.loadTypeParameterAnnotations(qVar.f3938l, iVar2.b));
        }
    }
