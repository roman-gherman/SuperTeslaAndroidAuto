    ...
    */
    public final java.util.List a(X2.r r7, E2.p r8, boolean r9, boolean r10, java.lang.Boolean r11, boolean r12) {
        ...
        L23:
            r7 = r9
        L24:
            kotlin.collections.u r9 = kotlin.collections.u.f3804a
            if (r7 != 0) goto L29
            goto L3e
        L29:
            r10 = r0
    ...
    public final KotlinJvmBinaryClass d(r rVar, boolean z6, boolean z7, Boolean bool, boolean z8) {
        ...
        if (z6) {
            ...
            if (rVar instanceof X2.p) {
                ...
                if (pVar2.f1446g == enumC0110j) {
                    return AbstractC0132a.u(c0813c, pVar2.f1445f.d(L2.f.e("DefaultImpls")), ((l) this).f3840f);
                }
            }
            if (bool.booleanValue() && (rVar instanceof q)) {
                ...
                if (aVar != null) {
                    ...
                    return AbstractC0132a.u(c0813c, L2.b.j(new L2.c(kotlin.text.r.A(strE, ClassPathElement.SEPARATOR_CHAR, TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH))), ((l) this).f3840f);
                }
            }
        }
        ...
        return kotlinJvmBinaryClass == null ? AbstractC0132a.u(c0813c, gVar2.a(), ((l) this).f3840f) : kotlinJvmBinaryClass;
    }
    ...
    public final boolean e(L2.b bVar) throws InvocationTargetException {
        ...
        KotlinJvmBinaryClass kotlinJvmBinaryClassU = AbstractC0132a.u(this.f3833a, bVar, ((l) this).f3840f);
        if (kotlinJvmBinaryClassU == null) {
            return false;
        }
        LinkedHashSet linkedHashSet = AbstractC0565b.f3659a;
        s sVar = new s();
    ...
    public final k g(L2.b bVar, SourceElement sourceElement, List result) {
        ...
        if (AbstractC0565b.f3659a.contains(bVar)) {
            return null;
        }
    ...
    public final List loadCallableAnnotations(r container, MessageLite proto, X2.a kind) {
        ...
        return pVarC == null ? u.f3804a : b(this, container, pVarC, null, false, 60);
    }
    ...
    public final List loadExtensionReceiverParameterAnnotations(r container, MessageLite proto, X2.a kind) {
        ...
        kotlin.jvm.internal.h.f(kind, "kind");
        p pVarC = c(proto, container.f1448a, container.b, kind, false);
        return pVarC != null ? b(this, container, new p(B2.b.h(new StringBuilder(), pVarC.f311a, "@0")), null, false, 60) : u.f3804a;
    }
    ...
    */
    public final java.util.List loadValueParameterAnnotations(X2.r r8, kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r9, X2.a r10, int r11, G2.d0 r12) {
        ...
        L80:
            ...
            throw r8
        L98:
            kotlin.collections.u r8 = kotlin.collections.u.f3804a
            return r8
        */
