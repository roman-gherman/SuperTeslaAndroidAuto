...
public final class C0607h {
    ...
    public final MessageLite f3866a;
    public final int b;

    public C0607h(int i, MessageLite messageLite) {
        this.f3866a = messageLite;
        this.b = i;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f3866a == c0607h.f3866a && this.b == c0607h.b;
    }

    public final int hashCode() {
        return (System.identityHashCode(this.f3866a) * 65535) + this.b;
    }
}
