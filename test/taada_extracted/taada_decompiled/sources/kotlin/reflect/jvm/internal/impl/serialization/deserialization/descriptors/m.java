...
public final class m extends l {
    ...
    public final PackageFragmentDescriptor f3918f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final String f3919g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final L2.c f3920h;
    ...
    public m(PackageFragmentDescriptor packageDescriptor, D proto, NameResolver nameResolver, I2.a metadataVersion, E2.g gVar, X2.g components, String debugName, Function0 classNames) {
        ...
        this.f3918f = packageDescriptor;
        this.f3919g = debugName;
        this.f3920h = packageDescriptor.getFqName();
    }
    ...
    public final L2.b e(L2.f name) {
        ...
        return new L2.b(this.f3920h, name);
    }
    ...
    public final Collection getContributedDescriptors(U2.f kindFilter, Function1 nameFilter) {
        ...
        Iterable iterable = this.f3917a.f1433a.f1423k;
        ArrayList arrayList = new ArrayList();
        Iterator it = iterable.iterator();
        while (it.hasNext()) {
            s.F(((ClassDescriptorFactory) it.next()).getAllContributedClassesIfPossible(this.f3920h), arrayList);
        }
    ...
    public final boolean j(L2.f fVar) {
        ...
        Iterator it = iterable.iterator();
        while (it.hasNext()) {
            if (((ClassDescriptorFactory) it.next()).shouldCreateClass(this.f3920h, fVar)) {
                return true;
            }
        }
        return false;
    ...
    public final void recordLookup(L2.f name, LookupLocation location) {
        kotlin.jvm.internal.h.f(name, "name");
        kotlin.jvm.internal.h.f(location, "location");
        Z.u(this.f3917a.f1433a.i, location, this.f3918f, name);
    }
