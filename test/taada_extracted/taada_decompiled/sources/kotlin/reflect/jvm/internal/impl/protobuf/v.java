...
public final class v implements DFS$Neighbors, ShapeAppearancePathProvider$PathListener, ContentTypeMatcher, ModuleDependencies, ModuleClassResolver {
    ...
    public boolean contains(C0840e contentType) {
        ...
        return contentType.g((C0840e) this.f3877a);
    }

    public void d(z.e definition) {
        kotlin.jvm.internal.h.f(definition, "definition");
        q0 q0Var = (q0) ((B1.a) this.f3877a).a(definition);
        if (q0Var != null) {
            Object objC = q0Var.c();
    ...
    public Iterable getNeighbors(Object obj) {
        C0661m c0661m = (C0661m) this.f3877a;
    ...
    public void onCornerPathCreated(n0.t tVar, Matrix matrix, int i) {
        n0.f fVar = (n0.f) this.f3877a;
        BitSet bitSet = fVar.d;
        tVar.getClass();
        bitSet.set(i, false);
        tVar.a(tVar.e);
        fVar.b[i] = new n0.m(new ArrayList(tVar.f4222g), new Matrix(matrix));
    }
    ...
    public v(C0937a c0937a) {
        int i = c0937a.c;
        this.f3877a = new y4.f[i];
        for (int i3 = 0; i3 < i; i3++) {
            ((y4.f[]) this.f3877a)[i3] = new y4.f(c0937a, 1);
        }
    }
    ...
    public v(int i) {
        switch (i) {
            case 5:
                this.f3877a = new B1.a();
                break;
            default:
                this.f3877a = new Stack();
                break;
        }
    }
}
