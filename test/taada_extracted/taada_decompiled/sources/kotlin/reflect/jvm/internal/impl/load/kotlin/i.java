...
public final class i implements KotlinJvmBinaryClass.AnnotationArrayArgumentVisitor {
    ...
    public final ArrayList f3836a = new ArrayList();
    ...
    public final void visit(Object obj) {
        this.f3836a.add(l.j(this.b, this.c, obj));
    }
    ...
    public final void visitClassLiteral(P2.f value) {
        ...
        this.f3836a.add(new r(new p(value)));
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.kotlin.KotlinJvmBinaryClass.AnnotationArrayArgumentVisitor
    public final void visitEnd() {
        ArrayList elements = this.f3836a;
        k kVar = (k) this.d;
        ...
        if (kVar.c.e(kVar.e) && kotlin.jvm.internal.h.a(fVar.b(), "value")) {
            ...
            while (it.hasNext()) {
                kVar.f3838f.add((AnnotationDescriptor) ((P2.a) it.next()).f1217a);
            }
        }
    }
    ...
    public final void visitEnum(L2.b enumClassId, L2.f enumEntryName) {
        ...
        this.f3836a.add(new P2.i(enumClassId, enumEntryName));
    }
}
