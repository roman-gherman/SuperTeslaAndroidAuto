...
public interface TypeSystemContext extends TypeSystemOptimizationContext {
    ...
    @Nullable
    SimpleTypeMarker captureFromArguments(@NotNull SimpleTypeMarker simpleTypeMarker, @NotNull EnumC0418b enumC0418b);

    @NotNull
    EnumC0418b captureStatus(@NotNull CapturedTypeMarker capturedTypeMarker);
    ...
    @NotNull
    c getVariance(@NotNull TypeArgumentMarker typeArgumentMarker);

    @NotNull
    c getVariance(@NotNull TypeParameterMarker typeParameterMarker);
    ...
    @NotNull
    P substitutionSupertypePolicy(@NotNull SimpleTypeMarker simpleTypeMarker);
    ...
    @NotNull
    KotlinTypeMarker withNullability(@NotNull KotlinTypeMarker kotlinTypeMarker, boolean z6);
