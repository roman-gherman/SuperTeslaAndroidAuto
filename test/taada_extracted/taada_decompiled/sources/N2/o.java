    ...
    */
    ...
    public static void r(CallableMemberDescriptor callableMemberDescriptor, C0587f c0587f) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : callableMemberDescriptor.getOverriddenDescriptors()) {
            if (callableMemberDescriptor2.getVisibility() == AbstractC0713e.f4234g) {
                r(callableMemberDescriptor2, c0587f);
            }
        }
        if (callableMemberDescriptor.getVisibility() != AbstractC0713e.f4234g) {
            return;
        }
        ...
        if (overriddenDescriptors.isEmpty()) {
            abstractC0714fG = AbstractC0713e.f4237k;
        } else {
        ...
        if (callableMemberDescriptor.getKind() == EnumC0709a.b) {
            ...
            abstractC0714fG = AbstractC0713e.g(((C0712d) abstractC0714fG).f4231a.c());
        }
        if (abstractC0714fG == null) {
            if (c0587f != null) {
    ...
    public final void h(L2.f fVar, Collection collection, Collection collection2, ClassDescriptor classDescriptor, q qVar) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z6 = !AbstractC0713e.e(callableMemberDescriptor2.getVisibility()) && AbstractC0713e.c(AbstractC0713e.f4239m, callableMemberDescriptor2, callableMemberDescriptor) == null;
                int iB = s.b(iC);
                if (iB == 0) {
                    if (z6) {
