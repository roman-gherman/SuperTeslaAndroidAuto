...
public final class I extends F implements JavaWildcardType {
    ...
    public final WildcardType f4799a;

    public I(WildcardType wildcardType) {
        this.f4799a = wildcardType;
    }
    ...
    public final JavaType getBound() {
        WildcardType wildcardType = this.f4799a;
    ...
    public final boolean isExtends() {
        kotlin.jvm.internal.h.e(this.f4799a.getUpperBounds(), "reflectType.upperBounds");
