...
public abstract class e implements TypeCheckingProcedureCallbacks {
    ...
    public static TypeParameterDescriptor A(TypeVariableTypeConstructorMarker receiver) {
        ...
        sb.append(receiver);
        sb.append(", ");
        throw new IllegalArgumentException(B2.b.i(w.f3817a, receiver.getClass(), sb).toString());
    }
    ...
    public static boolean H(TypeParameterMarker receiver, TypeConstructorMarker typeConstructorMarker) {
        ...
        sb2.append(receiver);
        sb2.append(", ");
        throw new IllegalArgumentException(B2.b.i(w.f3817a, receiver.getClass(), sb2).toString());
    }
    ...
    public static boolean I(SimpleTypeMarker a6, SimpleTypeMarker b) {
        ...
        if (!(a6 instanceof F)) {
            throw new IllegalArgumentException(B2.b.i(w.f3817a, a6.getClass(), B2.b.n("ClassicTypeSystemContext couldn't handle: ", a6, ", ")).toString());
        }
        if (b instanceof F) {
            return ((F) a6).a() == ((F) b).a();
        }
        throw new IllegalArgumentException(B2.b.i(w.f3817a, b.getClass(), B2.b.n("ClassicTypeSystemContext couldn't handle: ", b, ", ")).toString());
    }

    public static boolean J(TypeConstructorMarker receiver) {
        kotlin.jvm.internal.h.f(receiver, "$receiver");
        if (receiver instanceof TypeConstructor) {
            return k2.i.H((TypeConstructor) receiver, k2.o.f3742a);
        }
        StringBuilder sb = new StringBuilder("ClassicTypeSystemContext couldn't handle: ");
        sb.append(receiver);
        sb.append(", ");
    ...
    public static boolean L(TypeConstructorMarker receiver) {
        ...
        if (receiver instanceof TypeConstructor) {
            ...
            return (classDescriptor == null || classDescriptor.getModality() != EnumC0719k.f4247a || classDescriptor.getKind() == EnumC0711c.c || classDescriptor.getKind() == EnumC0711c.d || classDescriptor.getKind() == EnumC0711c.e) ? false : true;
        }
        StringBuilder sb = new StringBuilder("ClassicTypeSystemContext couldn't handle: ");
        sb.append(receiver);
        sb.append(", ");
    ...
    public static boolean R(SimpleTypeMarker receiver) {
        ...
        throw new IllegalArgumentException(B2.b.i(w.f3817a, receiver.getClass(), sbN).toString());
    }
    ...
    public static boolean W(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker receiver) {
        kotlin.jvm.internal.h.f(receiver, "$receiver");
        if (!(receiver instanceof F)) {
            throw new IllegalArgumentException(B2.b.i(w.f3817a, receiver.getClass(), B2.b.n("ClassicTypeSystemContext couldn't handle: ", receiver, ", ")).toString());
        }
    ...
    public static boolean b(TypeConstructorMarker c12, TypeConstructorMarker c22) {
        ...
        if (!(c12 instanceof TypeConstructor)) {
            ...
            sb.append(c12);
            sb.append(", ");
            throw new IllegalArgumentException(B2.b.i(w.f3817a, c12.getClass(), sb).toString());
        }
        ...
        sb2.append(c22);
        sb2.append(", ");
        throw new IllegalArgumentException(B2.b.i(w.f3817a, c22.getClass(), sb2).toString());
    }
    ...
    public static C0232a i0(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker type) {
        ...
        throw new IllegalArgumentException(B2.b.i(w.f3817a, type.getClass(), sbN).toString());
    }
    ...
    public static F l(SimpleTypeMarker type, EnumC0418b status) {
        ...
        if (!(type instanceof F)) {
            throw new IllegalArgumentException(B2.b.i(w.f3817a, type.getClass(), B2.b.n("ClassicTypeSystemContext couldn't handle: ", type, ", ")).toString());
        }
        F f6 = (F) type;
        g gVar = null;
    ...
    public static c0 o(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker lowerBound, SimpleTypeMarker upperBound) {
        ...
        if (!(lowerBound instanceof F)) {
            ...
            sb.append(", ");
            throw new IllegalArgumentException(B2.b.i(w.f3817a, classicTypeSystemContext.getClass(), sb).toString());
        }
        ...
        sb2.append(", ");
        throw new IllegalArgumentException(B2.b.i(w.f3817a, classicTypeSystemContext.getClass(), sb2).toString());
    }
