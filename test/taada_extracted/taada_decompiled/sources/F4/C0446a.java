...
public final class C0446a extends AbstractC0243a {
    public static final BigInteger i = C0448c.i;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final c4.i f3221h;

    static {
        new C0448c(ECConstants.ONE);
    }

    public C0446a() {
        super(i);
        this.f3221h = new c4.i(this, null, null, 1);
        this.b = new C0448c(new BigInteger(1, h5.b.a("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.c = new C0448c(new BigInteger(1, h5.b.a("E87579C11079F43DD824993C2CEE5ED3")));
        this.d = new BigInteger(1, h5.b.a("FFFFFFFE0000000075A30D1B9038A115"));
    ...
    public final AbstractC0246d k(SecureRandom secureRandom) {
        ...
        do {
            ...
            do {
                ...
                g5.c.r(bArr, iArr, 4);
            } while (E1.k.X(iArr, AbstractC0447b.f3222a, 4) == 0);
            i3 = 0;
