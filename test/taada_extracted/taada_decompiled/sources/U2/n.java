...
public abstract class n implements MemberScope {
    ...
    public Set getFunctionNames() {
        Collection contributedDescriptors = getContributedDescriptors(f.f1329p, j3.g.f3666a);
    ...
    public Set getVariableNames() {
        Collection contributedDescriptors = getContributedDescriptors(f.q, j3.g.f3666a);
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        for (Object obj : contributedDescriptors) {
            if (obj instanceof SimpleFunctionDescriptor) {
                L2.f name = ((SimpleFunctionDescriptor) obj).getName();
