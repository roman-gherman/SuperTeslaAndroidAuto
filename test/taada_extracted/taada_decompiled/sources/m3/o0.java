...
public class o0 implements Job, ChildJob, ParentJob {
    ...
    public static final AtomicReferenceFieldUpdater f4141a = AtomicReferenceFieldUpdater.newUpdater(o0.class, Object.class, "_state");
    ...
    public o0(boolean z6) {
        this._state = z6 ? AbstractC0690y.f4153j : AbstractC0690y.i;
    }
    ...
    public final void A(e0 e0Var) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = r3.k.f4712a;
        ...
        r3.k kVarD = e0Var.d();
        do {
            atomicReferenceFieldUpdater = f4141a;
    ...
    public final int B(Object obj) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4141a;
        if (z6) {
            if (((J) obj).f4107a) {
                return 0;
            }
    ...
    public final Object E(Object obj, Object obj2) throws IllegalAccessException, InvocationTargetException {
        ...
        synchronized (h0Var) {
            ...
            if (h0Var != incomplete2) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f4141a;
            ...
            if (c0675iW != null) {
                while (c0675iW.e.invokeOnCompletion((1 & 1) == 0, (1 & 2) != 0, new g0(this, h0Var, c0675iW, obj2)) == r0.f4143a) {
                    c0675iW = w(c0675iW);
                    if (c0675iW == null) {
                    }
                }
    ...
    */
    ...
    public final boolean f(Throwable th) {
        if (!t()) {
            ...
            return (childHandle == null || childHandle == r0.f4143a) ? z6 : childHandle.childCancelled(th) || z6;
        }
        return true;
    }
    ...
    public final CancellationException getCancellationException() {
        ...
        if (!(objP instanceof h0)) {
            if (!(objP instanceof Incomplete)) {
                return objP instanceof C0677k ? D(this, ((C0677k) objP).f4133a) : new C0668b0(getClass().getSimpleName().concat(" has completed normally"), null, this);
            }
    ...
    public final SelectClause0 getOnJoin() {
        kotlin.jvm.internal.z.d(3, n0.f4139a);
        return new B.h(this);
    }
    ...
    public final Object u(Object obj) throws IllegalAccessException, InvocationTargetException {
        ...
        do {
            ...
            if (objE == AbstractC0690y.d) {
                ...
                C0677k c0677k = obj instanceof C0677k ? (C0677k) obj : null;
                throw new IllegalStateException(str, c0677k != null ? c0677k.f4133a : null);
            }
