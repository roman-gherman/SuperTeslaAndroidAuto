...
public final class U extends T implements Delay {
    ...
    public U(Executor executor) {
        ...
        Method method2 = AbstractC0802c.f4702a;
        try {
            ScheduledThreadPoolExecutor scheduledThreadPoolExecutor = executor instanceof ScheduledThreadPoolExecutor ? (ScheduledThreadPoolExecutor) executor : null;
            if (scheduledThreadPoolExecutor != null && (method = AbstractC0802c.f4702a) != null) {
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof U) && ((U) obj).f4113a == this.f4113a;
    }

    public final int hashCode() {
        return System.identityHashCode(this.f4113a);
    }
    ...
    public final DisposableHandle invokeOnTimeout(long j6, Runnable runnable, CoroutineContext coroutineContext) {
        ...
        return scheduledFutureSchedule != null ? new H(scheduledFutureSchedule) : RunnableC0691z.f4154h.invokeOnTimeout(j6, runnable, coroutineContext);
    }
    ...
    public final void scheduleResumeAfterDelay(long j6, CancellableContinuation cancellableContinuation) {
        ...
        if (scheduledFutureSchedule != null) {
            ...
            RunnableC0691z.f4154h.scheduleResumeAfterDelay(j6, cancellableContinuation);
        }
    }
