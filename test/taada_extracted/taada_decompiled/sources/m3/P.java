...
public abstract class P extends Q implements Delay {
    ...
    public static final AtomicReferenceFieldUpdater f4110f = AtomicReferenceFieldUpdater.newUpdater(P.class, Object.class, "_delayed");

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final AtomicIntegerFieldUpdater f4111g = AtomicIntegerFieldUpdater.newUpdater(P.class, "_isCompleted");
    ...
    */
    ...
    public void h(Runnable runnable) {
        if (!i(runnable)) {
            RunnableC0691z.f4154h.h(runnable);
            return;
        }
        Thread threadF = f();
    ...
    */
    public final boolean i(java.lang.Runnable r7) {
        ...
        L0:
            ...
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r2 = m3.P.f4111g
            int r2 = r2.get(r6)
            r3 = 0
            r4 = 1
            if (r2 == 0) goto L12
    ...
    public DisposableHandle invokeOnTimeout(long j6, Runnable runnable, CoroutineContext coroutineContext) {
        return AbstractC0664A.f4101a.invokeOnTimeout(j6, runnable, coroutineContext);
    }

    public final boolean j() {
        O o6;
        kotlin.collections.i iVar = this.c;
        if (!(iVar != null ? iVar.isEmpty() : true) || ((o6 = (O) f4110f.get(this)) != null && r3.D.b.get(o6) != 0)) {
            return false;
        }
        Object obj = e.get(this);
        if (obj != null) {
            if (obj instanceof r3.n) {
                long j6 = r3.n.f4715f.get((r3.n) obj);
    ...
    public final void k(long j6, N n6) {
        int iA;
        Thread threadF;
        boolean z6 = f4111g.get(this) != 0;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f4110f;
        if (z6) {
            iA = 1;
        } else {
        ...
        if (o8 != null) {
            synchronized (o8) {
                ThreadSafeHeapNode[] threadSafeHeapNodeArr = o8.f4698a;
