...
public final class C0932b extends f {
    ...
    public final SimpleFunctionDescriptor f5137D;
    ...
    public C0932b(ClassDescriptor ownerDescriptor, SimpleFunctionDescriptor simpleFunctionDescriptor, SimpleFunctionDescriptor simpleFunctionDescriptor2, PropertyDescriptor propertyDescriptor) {
        super(ownerDescriptor, o2.f.b, simpleFunctionDescriptor.getModality(), simpleFunctionDescriptor.getVisibility(), simpleFunctionDescriptor2 != null, propertyDescriptor.getName(), simpleFunctionDescriptor.getSource(), null, EnumC0709a.f4226a, false, null);
        h.f(ownerDescriptor, "ownerDescriptor");
        Annotations.Companion.getClass();
        this.C = simpleFunctionDescriptor;
        this.f5137D = simpleFunctionDescriptor2;
