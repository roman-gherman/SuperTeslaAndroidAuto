...
public class f extends I implements JavaCallableMemberDescriptor {
    ...
    public static f n(DeclarationDescriptor declarationDescriptor, C0944d c0944d, AbstractC0714f abstractC0714f, boolean z6, L2.f fVar, JavaSourceElement javaSourceElement, boolean z7) {
        ...
        if (javaSourceElement != null) {
            return new f(declarationDescriptor, c0944d, enumC0719k, abstractC0714f, z6, fVar, javaSourceElement, null, EnumC0709a.f4226a, z7, null);
        }
        a(12);
        throw null;
    }
    ...
    public final JavaCallableMemberDescriptor enhance(AbstractC0162z abstractC0162z, List list, AbstractC0162z abstractC0162z2, N1.e eVar) {
        ...
        f fVar = new f(getContainingDeclaration(), getAnnotations(), getModality(), getVisibility(), this.f4585f, getName(), getSource(), original, getKind(), this.f5140A, eVar);
        J j7 = this.f4568w;
        if (j7 != null) {
            J j8 = new J(fVar, j7.getAnnotations(), j7.getModality(), j7.getVisibility(), j7.e, j7.f4545f, j7.i, getKind(), original == null ? null : original.getGetter(), j7.getSource());
            j8.f4550l = j7.f4550l;
            j8.f4570m = abstractC0162z2;
            j6 = j8;
        } else {
            j6 = null;
        }
        K k7 = this.x;
        if (k7 != null) {
            k6 = new K(fVar, k7.getAnnotations(), k7.getModality(), k7.getVisibility(), k7.e, k7.f4545f, k7.i, getKind(), original == null ? null : original.getSetter(), k7.getSource());
            k6.f4550l = k6.f4550l;
        ...
        fVar.k(j6, k6, this.y, this.f4569z);
        ?? r42 = this.f4587h;
        if (r42 != 0) {
            fVar.g(this.f4586g, r42);
        }
        ...
        fVar.m(abstractC0162z2, getTypeParameters(), this.f4566t, wVarK, u.f3804a);
        return fVar;
    }
    ...
    public final boolean isConst() {
        ...
        g gVar = x.f268a;
        L2.c ENHANCED_NULLABILITY_ANNOTATION = D.f4973p;
    ...
    public final I j(DeclarationDescriptor declarationDescriptor, EnumC0719k enumC0719k, AbstractC0714f abstractC0714f, PropertyDescriptor propertyDescriptor, EnumC0709a enumC0709a, L2.f fVar, SourceElement sourceElement) {
        ...
        return new f(declarationDescriptor, getAnnotations(), enumC0719k, abstractC0714f, this.f4585f, fVar, sourceElement, propertyDescriptor, enumC0709a, this.f5140A, this.f5141B);
    }
