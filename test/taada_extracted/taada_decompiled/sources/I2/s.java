...
public final class s implements Caller {
    ...
    */
    ...
    public final Object call(Object[] args) throws IllegalAccessException, InvocationTargetException {
        ...
        Object objCall = this.f3477a.call(objArrCopyOf);
    ...
    public final Member getMember() {
        return this.f3477a.getMember();
    }

    @Override // kotlin.reflect.jvm.internal.calls.Caller
    public final List getParameterTypes() {
        return this.f3477a.getParameterTypes();
    }

    @Override // kotlin.reflect.jvm.internal.calls.Caller
    public final Type getReturnType() {
        return this.f3477a.getReturnType();
    }
}
