...
public abstract class m extends r {
    ...
    public void a(Object[] objArr) {
        switch (this.e) {
            case 0:
                ...
                if (this.f3472f && kotlin.collections.j.H(objArr) == null) {
    ...
    public Object c(Object obj, Object[] args) {
        ...
        return this.f3472f ? N1.m.f1129a : ((Method) this.f3476a).invoke(obj, Arrays.copyOf(args, args.length));
    }
    ...
    public Object call(Object[] args) throws IllegalAccessException {
        kotlin.jvm.internal.h.f(args, "args");
        a(args);
        ((Field) this.f3476a).set(this.c != null ? kotlin.collections.j.A(args) : null, kotlin.collections.j.H(args));
        return N1.m.f1129a;
    }
    ...
    public m(Method method, boolean z6, Type[] typeArr) {
        ...
        this.f3472f = genericReturnType.equals(Void.TYPE);
    }
