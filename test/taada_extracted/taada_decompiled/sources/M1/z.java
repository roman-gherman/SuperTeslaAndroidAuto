    ...
    public final Object invokeSuspend(Object obj) throws A.a {
        ...
        switch (this.f4071a) {
            case 0:
                ...
                if (c0840eE != null) {
                    if (!kotlin.jvm.internal.h.a(c0840eE.d, AbstractC0839d.f4860a.d)) {
                        return mVar;
                    }
                }
                q1.c cVar = (q1.c) obj3;
                String str2 = (String) obj2;
                C0840e c0840e = c0840eE == null ? AbstractC0839d.f4860a : c0840eE;
                if (c0840eE == null || (charset = io.ktor.utils.io.internal.t.d(c0840eE)) == null) {
                    charset = c0631a.b;
                }
                B.f4027a.trace("Sending request body to " + cVar.f4512a + " as text/plain with charset " + charset);
            ...
            default:
                ...
                if (i3 == 0) {
                    ...
                    F1.a aVar3 = cVar2.f4688a;
                    if (!kotlin.jvm.internal.h.a(aVar3.f347a, kotlin.jvm.internal.w.f3817a.b(String.class))) {
                        return mVar;
                    }
                    Object obj4 = cVar2.b;
                ...
                List list2 = u1.q.f4869a;
                String str3 = headers.get("Content-Type");
                if (str3 != null) {
                    C0840e c0840e2 = C0840e.f4861f;
                    c0840eX = b0.x(str3);
                } else {
                    c0840eX = null;
                }
                ...
                if (charset2 == null) {
                    charset2 = c0631a.f4026a;
                }
                B.f4027a.trace("Reading response body for " + call.c().getUrl() + " as String with charset " + charset2);
