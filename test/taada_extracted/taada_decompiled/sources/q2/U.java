...
public abstract class U extends T {
    ...
    public NullableLazyValue f4586g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public kotlin.jvm.internal.i f4587h;
    ...
    public final void g(NullableLazyValue nullableLazyValue, Function0 function0) {
        ...
        this.f4587h = (kotlin.jvm.internal.i) function0;
        if (nullableLazyValue == null) {
            nullableLazyValue = (NullableLazyValue) function0.invoke();
        }
        this.f4586g = nullableLazyValue;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptor
    public final P2.g getCompileTimeInitializer() {
        NullableLazyValue nullableLazyValue = this.f4586g;
        if (nullableLazyValue != null) {
