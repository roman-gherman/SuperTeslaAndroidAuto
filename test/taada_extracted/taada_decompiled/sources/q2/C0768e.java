...
public final class C0768e implements TypeConstructor {
    ...
    public final /* synthetic */ kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.p f4590a;
    ...
    public final Collection getSupertypes() {
        Collection<AbstractC0162z> supertypes = this.f4590a.getUnderlyingType().c().getSupertypes();
    ...
    public final String toString() {
        return "[typealias " + this.f4590a.getName().b() + ']';
    }
}
