...
public final class r extends U2.n {
    ...
    public final MemoizedFunctionToNotNull f4605a;
    ...
    public r(C0781s c0781s, StorageManager storageManager) {
        ...
        this.d = c0781s;
        this.f4605a = storageManager.createMemoizedFunction(new C0779p(this, 0));
        int i = 1;
    ...
    */
    ...
    public final Collection getContributedFunctions(L2.f fVar, LookupLocation lookupLocation) {
        ...
        Collection collection = (Collection) this.f4605a.invoke(fVar);
        if (collection != null) {
            return collection;
        }
        a(7);
