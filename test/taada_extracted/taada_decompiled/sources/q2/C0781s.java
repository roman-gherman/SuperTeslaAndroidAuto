...
public final class C0781s extends AbstractC0774k {
    ...
    public final Annotations f4608j;
    ...
    public C0781s(StorageManager storageManager, ClassDescriptor classDescriptor, a3.F f6, L2.f fVar, NotNullLazyValue notNullLazyValue, Annotations annotations, SourceElement sourceElement) {
        ...
        this.f4608j = annotations;
        this.f4606g = new C0150m(this, Collections.EMPTY_LIST, Collections.singleton(f6), storageManager);
        this.f4607h = new r(this, storageManager);
    ...
    public final Annotations getAnnotations() {
        Annotations annotations = this.f4608j;
        if (annotations != null) {
            return annotations;
        }
        c(21);
