...
public final class H {
    ...
    public DeclarationDescriptor f4551a;
    public EnumC0719k b;
    public AbstractC0714f c;
    public EnumC0709a e;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final ReceiverParameterDescriptor f4554h;
    public final L2.f i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final AbstractC0162z f4555j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public final /* synthetic */ I f4556k;
    public PropertyDescriptor d = null;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public W f4552f = W.f1541a;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public boolean f4553g = true;

    public H(I i) {
        this.f4556k = i;
        this.f4551a = i.getContainingDeclaration();
        this.b = i.getModality();
        this.c = i.getVisibility();
        this.e = i.getKind();
        this.f4554h = i.f4566t;
        this.i = i.getName();
        this.f4555j = i.getType();
    }
    ...
    public final I b() {
        ...
        I i = this.f4556k;
        i.getClass();
        DeclarationDescriptor declarationDescriptor = this.f4551a;
        ...
        Z zL0 = E1.k.l0(typeParameters, this.f4552f, J, arrayList);
        d0 d0Var = d0.OUT_VARIANCE;
        AbstractC0162z abstractC0162z2 = this.f4555j;
        ...
        if (abstractC0162zJ != null) {
            ...
            ReceiverParameterDescriptor receiverParameterDescriptor2 = this.f4554h;
            ...
            Iterator it2 = i.f4565s.iterator();
            while (it2.hasNext()) {
            ...
            if (j7 == null) {
                ...
                AbstractC0714f visibility = i.f4568w.getVisibility();
                if (this.e == enumC0709a2 && AbstractC0713e.e(AbstractC0713e.g(((C0712d) visibility).f4231a.c()))) {
                    visibility = AbstractC0713e.f4235h;
                }
                ...
                j6 = new J(J, annotations, enumC0719k2, abstractC0714f2, z7, j8.f4545f, j8.i, enumC0709a3, propertyDescriptor2 == null ? r21 : propertyDescriptor2.getGetter(), SourceElement.NO_SOURCE);
            }
            if (j6 != 0) {
                J j9 = i.f4568w;
                AbstractC0162z abstractC0162z3 = j9.f4570m;
                j6.f4550l = j9.getInitialSignatureDescriptor() != null ? j9.getInitialSignatureDescriptor().substitute(zL0) : r21;
            ...
            if (k7 == null) {
                ...
                if (this.e == enumC0709a2 && AbstractC0713e.e(AbstractC0713e.g(((C0712d) visibility2).f4231a.c()))) {
                    visibility2 = AbstractC0713e.f4235h;
                }
                AbstractC0714f abstractC0714f3 = visibility2;
                K k8 = i.x;
                boolean z8 = k8.e;
                boolean z9 = k8.f4545f;
                boolean z10 = k8.i;
            ...
            if (k6 != 0) {
                ...
                if (listK == null) {
                    listK = Collections.singletonList(K.h(k6, R2.e.e(this.f4551a).m(), ((ValueParameterDescriptor) i.x.getValueParameters().get(0)).getAnnotations()));
                }
                if (listK.size() != 1) {
                ...
                k6.f4550l = k9.getInitialSignatureDescriptor() != null ? k9.getInitialSignatureDescriptor().substitute(z6) : r21;
                ValueParameterDescriptor valueParameterDescriptor = (ValueParameterDescriptor) listK.get(0);
                if (valueParameterDescriptor == null) {
                    K.a(6);
                    throw r21;
                }
                k6.f4572m = valueParameterDescriptor;
            } else {
                z6 = zL0;
            }
            C0782t c0782t = i.y;
            ?? c0782t2 = c0782t == null ? r21 : new C0782t(c0782t.getAnnotations(), J);
            C0782t c0782t3 = i.f4569z;
