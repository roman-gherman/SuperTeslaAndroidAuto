...
public final class n extends AbstractC0893k {
    ...
    public n(int i, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        ...
        this.d = g5.c.c(bArr2);
        this.e = g5.c.c(bArr3);
        this.f4378f = g5.c.c(bArr4);
        this.f4380h = g5.c.c(bArr5);
        this.f4379g = -1;
    }
    ...
    public final AbstractC0899q toASN1Primitive() {
        ...
        int i = this.f4379g;
        c0886d.a(i >= 0 ? new C0891i(1L) : new C0891i(0L));
        C0886d c0886d2 = new C0886d();
        c0886d2.a(new C0891i(this.b));
        c0886d2.a(new W(this.c));
        c0886d2.a(new W(this.d));
        c0886d2.a(new W(this.e));
        c0886d2.a(new W(this.f4378f));
        if (i >= 0) {
            c0886d2.a(new H(false, 0, (ASN1Encodable) new C0891i(i), 1));
        }
        Z z6 = new Z(c0886d2, false);
        z6.d = -1;
        c0886d.a(z6);
        c0886d.a(new H(true, 0, (ASN1Encodable) new W(this.f4380h), 1));
        Z z7 = new Z(c0886d, false);
        z7.d = -1;
        return z7;
    }

    public n(int i, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, int i3) {
        this.f4377a = 1;
        this.b = i;
        this.c = g5.c.c(bArr);
        this.d = g5.c.c(bArr2);
    ...
    public n(AbstractC0902u abstractC0902u) {
        ...
        this.b = C0891i.j(abstractC0902uL.m(0)).m();
        this.c = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(1)).f5066a);
        this.d = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(2)).f5066a);
        this.e = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(3)).f5066a);
        this.f4378f = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(4)).f5066a);
        ...
        if (abstractC0902u.size() != 3) {
            ...
            this.f4380h = g5.c.c(((AbstractC0897o) AbstractC0897o.b.g(H.l(abstractC0902u.m(2)), true)).f5066a);
        }
    }
}
