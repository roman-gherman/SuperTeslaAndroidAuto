...
public final class C0750c extends AbstractC0893k {
    ...
    public static C0750c b(AbstractC0899q abstractC0899q) {
        ...
        c0750c.b = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(1)).f5066a);
        c0750c.c = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(2)).f5066a);
        c0750c.d = g5.c.c(AbstractC0897o.j(abstractC0902uL.m(3)).f5066a);
        if (abstractC0902uL.size() == 5) {
            ...
            if (aSN1EncodableM instanceof d) {
                ...
                dVar = new d();
                dVar.f4363a = g5.c.c(AbstractC0897o.j(abstractC0902uL2.m(0)).f5066a);
            }
            c0750c.e = dVar;
        }
        return c0750c;
