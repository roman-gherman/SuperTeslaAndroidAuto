...
public final class OpcodeInfo {
    ...
    static {
        ...
        Info info205 = new Info(209, "rsub-int", instructionCodec18, indexType);
        RSUB_INT = info205;
        Info info206 = new Info(210, "mul-int/lit16", instructionCodec18, indexType);
        MUL_INT_LIT16 = info206;
        Info info207 = new Info(211, "div-int/lit16", instructionCodec18, indexType);
        DIV_INT_LIT16 = info207;
        Info info208 = new Info(212, "rem-int/lit16", instructionCodec18, indexType);
        REM_INT_LIT16 = info208;
        Info info209 = new Info(213, "and-int/lit16", instructionCodec18, indexType);
        AND_INT_LIT16 = info209;
        Info info210 = new Info(214, "or-int/lit16", instructionCodec18, indexType);
        ...
        Info info215 = new Info(219, "div-int/lit8", instructionCodec19, indexType);
        DIV_INT_LIT8 = info215;
        Info info216 = new Info(220, "rem-int/lit8", instructionCodec19, indexType);
        ...
        OR_INT_LIT8 = info218;
        Info info219 = new Info(223, "xor-int/lit8", instructionCodec19, indexType);
        XOR_INT_LIT8 = info219;
        Info info220 = new Info(224, "shl-int/lit8", instructionCodec19, indexType);
        SHL_INT_LIT8 = info220;
        Info info221 = new Info(225, "shr-int/lit8", instructionCodec19, indexType);
        SHR_INT_LIT8 = info221;
        Info info222 = new Info(226, "ushr-int/lit8", instructionCodec19, indexType);
        ...
        Info info224 = new Info(251, "invoke-polymorphic/range", InstructionCodec.FORMAT_4RCC, indexType6);
        INVOKE_POLYMORPHIC_RANGE = info224;
        IndexType indexType7 = IndexType.CALL_SITE_REF;
        Info info225 = new Info(252, "invoke-custom", instructionCodec12, indexType7);
        INVOKE_CUSTOM = info225;
        Info info226 = new Info(253, "invoke-custom/range", instructionCodec13, indexType7);
