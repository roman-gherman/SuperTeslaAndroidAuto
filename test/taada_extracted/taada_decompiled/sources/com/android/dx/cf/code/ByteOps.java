...
public class ByteOps {
    ...
    static {
        ...
        while (i3 < 2498) {
            int i4 = 16;
            int iDigit = (Character.digit(OPCODE_DETAILS.charAt(i3), 16) << 4) | Character.digit(OPCODE_DETAILS.charAt(i3 + 1), 16);
            char cCharAt = OPCODE_DETAILS.charAt(i3 + 3);
            if (cCharAt == '-') {
                i4 = 1;
            } else if (cCharAt == 'I') {
                i4 = 13;
            ...
            int i5 = i3 + 5;
            if (OPCODE_DETAILS.charAt(i3 + 4) == ':') {
                while (true) {
                    char cCharAt2 = OPCODE_DETAILS.charAt(i5);
                    if (cCharAt2 == 'D') {
                        i = i4 | 256;
                    } else if (cCharAt2 == 'F') {
                        i = i4 | 64;
            ...
            int iIndexOf = OPCODE_DETAILS.indexOf(59, i5);
            OPCODE_INFO[iDigit] = i4;
            OPCODE_NAMES[iDigit] = OPCODE_DETAILS.substring(i5, iIndexOf);
            i3 = iIndexOf + 1;
        }
    }
