...
public final class Dops {
    ...
    static {
        ...
        Dop dop201 = new Dop(208, 144, -1, insnFormat17, true);
        ADD_INT_LIT16 = dop201;
        Dop dop202 = new Dop(209, 209, -1, insnFormat17, true);
        RSUB_INT = dop202;
        Dop dop203 = new Dop(210, 146, -1, insnFormat17, true);
        MUL_INT_LIT16 = dop203;
        Dop dop204 = new Dop(211, 147, -1, insnFormat17, true);
        DIV_INT_LIT16 = dop204;
        Dop dop205 = new Dop(212, 148, -1, insnFormat17, true);
        REM_INT_LIT16 = dop205;
        Dop dop206 = new Dop(213, 149, -1, insnFormat17, true);
        AND_INT_LIT16 = dop206;
        Dop dop207 = new Dop(214, 150, -1, insnFormat17, true);
        OR_INT_LIT16 = dop207;
        Dop dop208 = new Dop(215, 151, -1, insnFormat17, true);
        XOR_INT_LIT16 = dop208;
        InsnFormat insnFormat18 = Form22b.THE_ONE;
        Dop dop209 = new Dop(216, 144, 208, insnFormat18, true);
        ADD_INT_LIT8 = dop209;
        Dop dop210 = new Dop(217, 209, 209, insnFormat18, true);
        RSUB_INT_LIT8 = dop210;
        Dop dop211 = new Dop(218, 146, 210, insnFormat18, true);
        MUL_INT_LIT8 = dop211;
        Dop dop212 = new Dop(219, 147, 211, insnFormat18, true);
        DIV_INT_LIT8 = dop212;
        Dop dop213 = new Dop(220, 148, 212, insnFormat18, true);
        REM_INT_LIT8 = dop213;
        Dop dop214 = new Dop(221, 149, 213, insnFormat18, true);
        AND_INT_LIT8 = dop214;
        Dop dop215 = new Dop(222, 150, 214, insnFormat18, true);
        OR_INT_LIT8 = dop215;
        Dop dop216 = new Dop(223, 151, 215, insnFormat18, true);
        XOR_INT_LIT8 = dop216;
        Dop dop217 = new Dop(224, 152, -1, insnFormat18, true);
        SHL_INT_LIT8 = dop217;
        Dop dop218 = new Dop(225, 153, -1, insnFormat18, true);
        SHR_INT_LIT8 = dop218;
        Dop dop219 = new Dop(226, 154, -1, insnFormat18, true);
        USHR_INT_LIT8 = dop219;
        Dop dop220 = new Dop(250, 250, 251, Form45cc.THE_ONE, false);
        INVOKE_POLYMORPHIC = dop220;
        Dop dop221 = new Dop(251, 250, -1, Form4rcc.THE_ONE, false);
        INVOKE_POLYMORPHIC_RANGE = dop221;
        Dop dop222 = new Dop(252, 252, 253, insnFormat11, false);
        INVOKE_CUSTOM = dop222;
        Dop dop223 = new Dop(253, 252, -1, insnFormat12, false);
        INVOKE_CUSTOM_RANGE = dop223;
        Dop dop224 = new Dop(254, 254, -1, insnFormat9, true);
        CONST_METHOD_HANDLE = dop224;
        Dop dop225 = new Dop(255, 255, -1, insnFormat9, true);
        CONST_METHOD_TYPE = dop225;
        DOPS = new Dop[65537];
        set(dop);
        set(dop2);
        set(dop3);
