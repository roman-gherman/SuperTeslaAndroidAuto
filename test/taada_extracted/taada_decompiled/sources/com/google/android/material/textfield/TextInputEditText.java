...
public class TextInputEditText extends AppCompatEditText {
    ...
    public final Rect f2593a;
    public boolean b;

    public TextInputEditText(Context context, AttributeSet attributeSet) {
        super(AbstractC0792a.a(context, attributeSet, R.attr.editTextStyle, 0), attributeSet, R.attr.editTextStyle);
        this.f2593a = new Rect();
        int[] iArr = V.a.f1350F;
        com.google.android.material.internal.o.a(context, attributeSet, R.attr.editTextStyle, R.style.Widget_Design_TextInputEditText);
        com.google.android.material.internal.o.b(context, attributeSet, iArr, R.attr.editTextStyle, R.style.Widget_Design_TextInputEditText, new int[0]);
    ...
    public final boolean getGlobalVisibleRect(Rect rect, Point point) {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !this.b) ? super.getGlobalVisibleRect(rect, point) : textInputLayout.getGlobalVisibleRect(rect, point);
    }
