...
public interface zzan extends IInterface {
    ...
    Bundle zzh(int i, String str, String str2, String str3, Bundle bundle);

    Bundle zzi(int i, String str, String str2, String str3);

    Bundle zzj(int i, String str, String str2, String str3, Bundle bundle);

    Bundle zzk(int i, String str, String str2, Bundle bundle);

    Bundle zzl(int i, String str, String str2, Bundle bundle, Bundle bundle2);

    void zzm(int i, String str, Bundle bundle, zzy zzyVar);

    void zzn(int i, String str, Bundle bundle, zzaa zzaaVar);

    void zzo(int i, String str, Bundle bundle, zzac zzacVar);

    void zzp(int i, String str, Bundle bundle, zzae zzaeVar);

    void zzq(int i, String str, Bundle bundle, zzag zzagVar);

    void zzr(int i, String str, Bundle bundle, zzai zzaiVar);

    void zzs(int i, String str, Bundle bundle, zzak zzakVar);

    void zzt(int i, String str, Bundle bundle, zzap zzapVar);
