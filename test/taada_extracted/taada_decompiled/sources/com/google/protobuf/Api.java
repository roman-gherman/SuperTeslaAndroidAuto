...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
    ...
    public int hashCode() {
        ...
        if (getMethodsCount() > 0) {
            iHashCode = getMethodsList().hashCode() + androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 2, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 3, 53);
        }
        int iHashCode2 = getVersion().hashCode() + androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 4, 53);
        if (hasSourceContext()) {
            iHashCode2 = getSourceContext().hashCode() + androidx.constraintlayout.core.motion.a.b(iHashCode2, 37, 5, 53);
        }
        if (getMixinsCount() > 0) {
            iHashCode2 = getMixinsList().hashCode() + androidx.constraintlayout.core.motion.a.b(iHashCode2, 37, 6, 53);
        }
        int iHashCode3 = this.unknownFields.hashCode() + ((androidx.constraintlayout.core.motion.a.b(iHashCode2, 37, 7, 53) + this.syntax_) * 29);
