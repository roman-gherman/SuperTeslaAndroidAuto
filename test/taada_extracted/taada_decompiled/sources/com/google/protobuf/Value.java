...
public final class Value extends GeneratedMessageV3 implements ValueOrBuilder {
    ...
    public int hashCode() {
        ...
        switch (this.kindCase_) {
            case 1:
                iB = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 1, 53);
                nullValueValue = getNullValueValue();
                break;
            case 2:
                iB = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 2, 53);
                nullValueValue = Internal.hashLong(Double.doubleToLongBits(getNumberValue()));
                break;
            case 3:
                iB = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 3, 53);
                nullValueValue = getStringValue().hashCode();
                break;
            case 4:
                iB = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 4, 53);
                nullValueValue = Internal.hashBoolean(getBoolValue());
                break;
            case 5:
                iB = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 5, 53);
                nullValueValue = getStructValue().hashCode();
                break;
            case 6:
                iB = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 6, 53);
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ValueOrBuilder {
        ...
        public ListValueOrBuilder getListValueOrBuilder() {
            ...
            return (i != 6 || (singleFieldBuilderV3 = this.listValueBuilder_) == null) ? i == 6 ? (ListValue) this.kind_ : ListValue.getDefaultInstance() : (ListValueOrBuilder) singleFieldBuilderV3.getMessageOrBuilder();
        }
        ...
        public StructOrBuilder getStructValueOrBuilder() {
            ...
            int i = this.kindCase_;
            return (i != 5 || (singleFieldBuilderV3 = this.structValueBuilder_) == null) ? i == 5 ? (Struct) this.kind_ : Struct.getDefaultInstance() : (StructOrBuilder) singleFieldBuilderV3.getMessageOrBuilder();
        }
