...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i3, Collection collection, JavaType javaType) {
        int i4;
        this.id = i3;
        this.collection = collection;
        this.javaType = javaType;
        int i5 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i5 == 1 || i5 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i4 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i4 == 2 || i4 == 3) ? false : true;
    }
