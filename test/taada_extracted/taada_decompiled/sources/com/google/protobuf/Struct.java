...
public final class Struct extends GeneratedMessageV3 implements StructOrBuilder {
    ...
    public int hashCode() {
        ...
        if (!internalGetFields().getMap().isEmpty()) {
            iHashCode = androidx.constraintlayout.core.motion.a.b(iHashCode, 37, 1, 53) + internalGetFields().hashCode();
        }
    ...
    public MapField internalGetMapField(int i) {
        ...
        throw new RuntimeException(b.c(i, "Invalid map field number: "));
    }
