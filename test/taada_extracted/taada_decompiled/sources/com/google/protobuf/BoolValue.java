...
public final class BoolValue extends GeneratedMessageV3 implements BoolValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        boolean z6 = this.value_;
        int serializedSize = this.unknownFields.getSerializedSize() + (z6 ? CodedOutputStream.computeBoolSize(1, z6) : 0);
    ...
    public int hashCode() {
        ...
        int iHashCode = this.unknownFields.hashCode() + ((Internal.hashBoolean(getValue()) + ((((getDescriptor().hashCode() + 779) * 37) + 1) * 53)) * 29);
