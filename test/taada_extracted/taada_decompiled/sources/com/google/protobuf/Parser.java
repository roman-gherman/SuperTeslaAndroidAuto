...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i, int i3, ExtensionRegistryLite extensionRegistryLite);
    ...
    MessageType parsePartialFrom(byte[] bArr, int i, int i3, ExtensionRegistryLite extensionRegistryLite);
