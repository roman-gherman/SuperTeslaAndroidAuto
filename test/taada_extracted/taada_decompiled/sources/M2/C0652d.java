...
public final class C0652d {
    ...
    public static final L2.c f4075f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final L2.b f4076g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final HashMap f4077h;
    public static final HashMap i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static final HashMap f4078j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public static final HashMap f4079k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public static final HashMap f4080l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final HashMap f4081m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final List f4082n;

    static {
        StringBuilder sb = new StringBuilder();
        EnumC0621e enumC0621e = EnumC0621e.d;
        sb.append(enumC0621e.f3973a.f958a.toString());
        sb.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        sb.append(enumC0621e.b);
        f4074a = sb.toString();
        StringBuilder sb2 = new StringBuilder();
        EnumC0621e enumC0621e2 = EnumC0621e.f3970f;
        sb2.append(enumC0621e2.f3973a.f958a.toString());
        ...
        sb3.append(enumC0621e3.f3973a.f958a.toString());
        sb3.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        sb3.append(enumC0621e3.b);
        c = sb3.toString();
        StringBuilder sb4 = new StringBuilder();
        EnumC0621e enumC0621e4 = EnumC0621e.f3971g;
        sb4.append(enumC0621e4.f3973a.f958a.toString());
        ...
        f4080l = new HashMap();
        f4081m = new HashMap();
        L2.b bVarJ2 = L2.b.j(k2.o.f3724A);
        L2.c cVar = k2.o.I;
        L2.c cVarG = bVarJ2.g();
        ...
        L2.b bVarJ3 = L2.b.j(k2.o.f3761z);
        L2.c cVar2 = k2.o.H;
        ...
        L2.b bVarJ4 = L2.b.j(k2.o.f3725B);
        L2.c cVar3 = k2.o.J;
        ...
        L2.b bVarJ7 = L2.b.j(k2.o.f3726D);
        L2.c cVar6 = k2.o.f3730L;
        ...
        L2.c cVar7 = k2.o.f3727F;
        L2.b bVarJ8 = L2.b.j(cVar7);
        L2.c cVar8 = k2.o.f3732N;
        ...
        L2.b bVarD = L2.b.j(cVar7).d(k2.o.f3728G.f());
        L2.c cVar9 = k2.o.f3733O;
        ...
        f4082n = listY;
        c(Object.class, k2.o.f3742a);
        c(String.class, k2.o.f3746f);
        c(CharSequence.class, k2.o.e);
        a(d(Throwable.class), L2.b.j(k2.o.f3750k));
        c(Cloneable.class, k2.o.c);
        c(Number.class, k2.o.i);
        a(d(Comparable.class), L2.b.j(k2.o.f3751l));
        c(Enum.class, k2.o.f3749j);
        a(d(Annotation.class), L2.b.j(k2.o.f3757s));
        for (C0651c c0651c8 : listY) {
            L2.b bVar = c0651c8.f4073a;
            L2.b bVar2 = c0651c8.b;
            a(bVar, bVar2);
            L2.b bVar3 = c0651c8.c;
            b(bVar3.b(), bVar);
            f4080l.put(bVar3, bVar2);
            f4081m.put(bVar2, bVar3);
            L2.c cVarB = bVar2.b();
            L2.c cVarB2 = bVar3.b();
            L2.e eVarI = bVar3.b().i();
            kotlin.jvm.internal.h.e(eVarI, "mutableClassId.asSingleFqName().toUnsafe()");
            f4078j.put(eVarI, cVarB);
            L2.e eVarI2 = cVarB.i();
            kotlin.jvm.internal.h.e(eVarI2, "readOnlyFqName.toUnsafe()");
            f4079k.put(eVarI2, cVarB2);
        }
        for (S2.b bVar4 : S2.b.values()) {
            L2.b bVarJ9 = L2.b.j(bVar4.e());
            k2.k kVarD = bVar4.d();
            kotlin.jvm.internal.h.e(kVarD, "jvmType.primitiveType");
            a(bVarJ9, L2.b.j(p.f3767k.c(kVarD.f3720a)));
        }
        for (L2.b bVar5 : C0584c.f3703a) {
            a(L2.b.j(new L2.c("kotlin.jvm.internal." + bVar5.i().b() + "CompanionObject")), bVar5.d(L2.h.b));
        }
        for (int i3 = 0; i3 < 23; i3++) {
            a(L2.b.j(new L2.c(B2.b.c(i3, "kotlin.jvm.functions.Function"))), new L2.b(p.f3767k, L2.f.e("Function" + i3)));
            b(new L2.c(b + i3), f4076g);
        }
        for (int i4 = 0; i4 < 22; i4++) {
            EnumC0621e enumC0621e5 = EnumC0621e.f3971g;
            b(new L2.c((enumC0621e5.f3973a.f958a.toString() + TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH + enumC0621e5.b) + i4), f4076g);
        }
    ...
    public static L2.b f(L2.e eVar) {
        return (e(eVar, f4074a) || e(eVar, c)) ? e : (e(eVar, b) || e(eVar, d)) ? f4076g : (L2.b) i.get(eVar);
    }
}
