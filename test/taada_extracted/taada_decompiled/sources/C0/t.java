...
public final class t implements ClassDataFinder, MatchResult, Factory, SelectClause2 {
    ...
    public t(kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.g gVar) {
        ...
        LinkedHashMap linkedHashMap = new LinkedHashMap(iF < 16 ? 16 : iF);
        for (Object obj : list) {
            linkedHashMap.put(kotlin.reflect.l.I(gVar.f3899l.b, ((C0120u) obj).d), obj);
        }
        ...
        this.c = gVar2.f3899l.f1433a.f1418a.createMemoizedFunctionWithNullableValues(new A2.q(9, this, gVar2));
        this.d = ((kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.g) this.e).f3899l.f1433a.f1418a.createLazyValue(new kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.k(this, 2));
    }
