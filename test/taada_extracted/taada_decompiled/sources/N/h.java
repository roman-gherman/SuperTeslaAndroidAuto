...
public final class h implements BackendRegistry {
    ...
    public final synchronized TransportBackend get(String str) {
        ...
        BackendFactory backendFactoryF = this.f4161a.f(str);
        if (backendFactoryF == null) {
            return null;
        }
        g gVar = this.b;
        TransportBackend transportBackendCreate = backendFactoryF.create(new c(gVar.f4160a, gVar.b, gVar.c, str));
