        ...
        if (z6) {
            ...
            if (eVar.getTypeParameters().isEmpty()) {
                ...
                if ((nVarI != null ? nVarI.c() : 0) == 0) {
                    ...
                    k3.u uVarD = k3.m.D(kotlin.collections.m.K(valueParameters), C0879m.f5016a);
                    AbstractC0162z abstractC0162z = eVar.f4629g;
                            ...
                            if (callableDescriptorSubstitute != null) {
                                if (callableDescriptorSubstitute instanceof SimpleFunctionDescriptor) {
                                    ...
                                    if (!typeParameters.isEmpty()) {
                                        callableDescriptorSubstitute = simpleFunctionDescriptor.newCopyBuilder().setTypeParameters(kotlin.collections.u.f3804a).build();
                                ...
                                if (AbstractC0878l.f5015a[f.s.b(iC)] == 1) {
                                    return N2.h.f1137a;
                                }
                            }
                        }
