...
public final class P extends AbstractC0496A {
    ...
    public P(S s3) {
        ...
        this.f3378f = new r0(new O(this, 0));
        this.f3379g = s0.g(null, new N(s3, this));
    }
}
