...
public final class F extends AbstractC0514q implements FunctionBase, KFunction, FunctionWithAllInvokes {
    ...
    public static final /* synthetic */ KProperty[] f3365l;
    ...
    static {
        ...
        f3365l = new KProperty[]{xVar.f(new kotlin.jvm.internal.q(xVar.b(F.class), "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/FunctionDescriptor;"))};
    }
    ...
    public F(D d, String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.f3369j = AbstractC0132a.N(2, new E(this, 0));
        this.f3370k = AbstractC0132a.N(2, new E(this, 1));
    }
    ...
    public static final i2.r h(F f6, Constructor constructor, FunctionDescriptor functionDescriptor, boolean z6) {
                    ...
                    if (!valueParameters.isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (AbstractC0132a.b0(type)) {
                                if (f6.g()) {
                                    return new C0531d(constructor, E1.k.l(f6.f3368h, f6.e()), 0);
                                }
                                ...
                                return new C0532e(constructor, declaringClass, null, (Type[]) (genericParameterTypes.length <= 1 ? new Type[0] : kotlin.collections.j.x(genericParameterTypes, 0, genericParameterTypes.length - 1)), 0);
                            }
                        }
                    }
                }
        ...
        if (f6.g()) {
            return new C0531d(constructor, E1.k.l(f6.f3368h, f6.e()), 1);
        }
        kotlin.jvm.internal.h.f(constructor, "constructor");
        ...
        return new C0532e(constructor, declaringClass2, cls, genericParameterTypes2, 1);
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, kotlin.Lazy] */
    @Override // h2.AbstractC0514q
    public final Caller b() {
        return (Caller) this.f3369j.getValue();
    }
    ...
    public final Caller d() {
        return (Caller) this.f3370k.getValue();
    }

    public final boolean equals(Object obj) {
        F fB = x0.b(obj);
        return fB != null && kotlin.jvm.internal.h.a(this.f3366f, fB.f3366f) && getName().equals(fB.getName()) && kotlin.jvm.internal.h.a(this.f3367g, fB.f3367g) && kotlin.jvm.internal.h.a(this.f3368h, fB.f3368h);
    }

    @Override // h2.AbstractC0514q
    public final boolean g() {
        return !kotlin.jvm.internal.h.a(this.f3368h, kotlin.jvm.internal.b.NO_RECEIVER);
    }
    ...
    public final int hashCode() {
        return this.f3367g.hashCode() + ((getName().hashCode() + (this.f3366f.hashCode() * 31)) * 31);
    }

    @Override // h2.AbstractC0514q
    /* JADX INFO: renamed from: i, reason: merged with bridge method [inline-methods] */
    public final FunctionDescriptor e() {
        KProperty kProperty = f3365l[0];
