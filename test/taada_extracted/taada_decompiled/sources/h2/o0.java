...
public final class o0 implements KTypeParameter, KClassifierImpl {
    ...
    public final TypeParameterDescriptor f3424a;
    public final q0 b;
        ...
        if (kTypeParameterOwnerImpl == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    if (eVar == null || (cls = eVar.f4768a) == null) {
    ...
    public final String getName() {
        String strB = this.f3424a.getName().b();
    ...
    public final kotlin.reflect.e getVariance() {
        int iOrdinal = this.f3424a.getVariance().ordinal();
        if (iOrdinal == 0) {
            return kotlin.reflect.e.f3823a;
        }
        if (iOrdinal == 1) {
