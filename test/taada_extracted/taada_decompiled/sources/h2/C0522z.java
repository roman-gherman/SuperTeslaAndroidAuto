...
public final class C0522z extends D implements KClass, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final Collection c() {
        ...
        if (descriptor.getKind() == EnumC0711c.b || descriptor.getKind() == EnumC0711c.f4229f) {
    ...
    public final PropertyDescriptor e(int i) {
        ...
        if (gVar != null) {
            ...
            if (h3 != null) {
                ...
                return (PropertyDescriptor) x0.f(this.b, h3, iVar.b, iVar.d, gVar.f3894f, C0521y.f3452a);
            }
        }
        return null;
    }
    ...
    public final List getAnnotations() {
        ...
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[1];
    ...
    public final Collection getConstructors() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[4];
        Object objInvoke = c0519w.f3438g.invoke();
    ...
    public final Collection getMembers() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[17];
        Object objInvoke = c0519w.f3448s.invoke();
    ...
    public final Collection getNestedClasses() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[5];
        Object objInvoke = c0519w.f3439h.invoke();
    ...
    public final Object getObjectInstance() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[6];
    ...
    public final String getQualifiedName() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[3];
        return (String) c0519w.f3437f.invoke();
    }
    ...
    public final List getSealedSubclasses() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[9];
        Object objInvoke = c0519w.f3442l.invoke();
    ...
    public final String getSimpleName() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[2];
    ...
    public final List getSupertypes() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[8];
        Object objInvoke = c0519w.f3441k.invoke();
    ...
    public final List getTypeParameters() {
        C0519w c0519w = (C0519w) this.c.invoke();
        c0519w.getClass();
        KProperty kProperty = C0519w.f3436t[7];
        Object objInvoke = c0519w.f3440j.invoke();
    ...
    public final boolean isFinal() {
        return getDescriptor().getModality() == EnumC0719k.f4247a;
    }
    ...
    public final L2.b n() {
        ...
        if (klass.isArray()) {
            ...
            return kVarD != null ? new L2.b(k2.p.f3767k, kVarD.b) : L2.b.j(k2.o.f3747g.g());
        }
        ...
        if (kVarD != null) {
            return new L2.b(k2.p.f3767k, kVarD.f3720a);
        }
        L2.b bVarA = AbstractC0823e.a(klass);
        if (!bVarA.c) {
            String str = C0652d.f4074a;
            L2.b bVar2 = (L2.b) C0652d.f4077h.get(bVarA.b().i());
            if (bVar2 != null) {
                return bVar2;
            }
        }
