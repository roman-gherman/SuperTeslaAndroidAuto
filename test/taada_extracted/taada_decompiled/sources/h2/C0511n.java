            ...
            case 0:
                ...
                for (KParameter kParameter : abstractC0514q.getParameters()) {
                    if (kParameter.isOptional()) {
                        ...
                        if (n0Var == null || (abstractC0162z = n0Var.f3422a) == null || !N2.i.c(abstractC0162z)) {
            ...
            case 2:
                ...
                if (abstractC0514q.g()) {
                    ...
                    if (receiverParameterDescriptorG != null) {
                        arrayList.add(new U(abstractC0514q, 0, kotlin.reflect.b.f3820a, new C0512o(receiverParameterDescriptorG, 0)));
                        i = 1;
                    } else {
                        i = 0;
                    }
