...
public final class S extends D {
    ...
    public final Collection d(L2.f fVar) {
        ...
        p5.getClass();
        KProperty kProperty = P.f3377h[1];
    ...
    public final PropertyDescriptor e(int i) {
        P p5 = (P) this.c.invoke();
        p5.getClass();
        KProperty kProperty = P.f3377h[3];
        N1.k kVar = (N1.k) p5.f3378f.invoke();
        if (kVar == null) {
            return null;
        }
        ...
        return (PropertyDescriptor) x0.f(this.b, h3, gVar, new I2.f(b0Var), fVar, Q.f3380a);
    }
    ...
    public final Class g() {
        P p5 = (P) this.c.invoke();
        p5.getClass();
        KProperty kProperty = P.f3377h[2];
    ...
    public final Collection getMembers() {
        P p5 = (P) this.c.invoke();
        p5.getClass();
        KProperty kProperty = P.f3377h[4];
        Object objInvoke = p5.f3379g.invoke();
