...
public final class C0908a implements Digest {
    ...
    public final ExtendedDigest f5078a;
    public final int b;

    public C0908a(int i, ExtendedDigest extendedDigest) {
        this.f5078a = extendedDigest;
        this.b = i;
    }

    @Override // org.bouncycastle.crypto.Digest
    public final int doFinal(byte[] bArr, int i) {
        ExtendedDigest extendedDigest = this.f5078a;
    ...
    public final String getAlgorithmName() {
        return this.f5078a.getAlgorithmName() + "/" + (this.b * 8);
    }
    ...
    public final void update(byte b) {
        this.f5078a.update(b);
    }

    @Override // org.bouncycastle.crypto.Digest
    public final void update(byte[] bArr, int i, int i3) {
        this.f5078a.update(bArr, i, i3);
    }
}
