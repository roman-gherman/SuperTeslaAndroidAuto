...
public final class C extends kotlin.jvm.internal.i implements Function1 {
    ...
    public final /* synthetic */ kotlin.jvm.internal.v f3489a;
    ...
    public final /* synthetic */ kotlin.jvm.internal.s f3490f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final /* synthetic */ kotlin.jvm.internal.s f3491g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public final /* synthetic */ Appendable f3492h;
    ...
    public final Object invoke(Object obj) throws IOException {
        ...
        kotlin.jvm.internal.v vVar = this.f3489a;
        ByteBuffer byteBuffer = (ByteBuffer) vVar.f3816a;
        if (byteBuffer != null) {
        ...
        if (i4 != Integer.MAX_VALUE) {
            length = Math.min(length, i4 - tVar.f3814a);
        }
        ...
        ByteBuffer byteBuffer2 = (ByteBuffer) vVar.f3816a;
        kotlin.jvm.internal.t tVar2 = this.i;
        if (byteBuffer2 != null) {
            buffer.position((byteBuffer2.position() + i) - tVar2.f3814a);
        ...
        this.e.f3814a = Math.max(1, i21);
        kotlin.jvm.internal.s sVar = this.f3490f;
        int i22 = -1;
        if (i21 == -1) {
            sVar.f3813a = true;
        }
        ...
        Appendable appendable = this.f3492h;
        ...
        if (i20 == 0 && buffer.remaining() < i21) {
            ...
            tVar2.f3814a = buffer.remaining();
            ((ByteBuffer) objBorrow).put(buffer);
            vVar.f3816a = objBorrow;
        }
        if (i4 == Integer.MAX_VALUE || tVar.f3814a < i4 || sVar.f3813a) {
            return N1.m.f1129a;
        }
