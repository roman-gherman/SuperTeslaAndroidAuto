...
public abstract class t {
    public static final void a(y yVar, StringBuilder sb) {
        List listP;
        sb.append(yVar.f4878a.f4845a);
        String str = yVar.f4878a.f4845a;
        if (str.equals("file")) {
        ...
        if (!((Map) encodedQueryParameters.f4279a).isEmpty() || z6) {
        ...
        kotlin.collections.m.U(arrayList, sb, "&", null, null, C0833B.f4846a, 60);
        if (yVar.f4880g.length() > 0) {
            sb.append('#');
            sb.append(yVar.f4880g);
        }
    }
    ...
    */
    public static java.lang.Object n(o3.C0744b r4, kotlin.coroutines.Continuation r5) {
        ...
        L18:
            ...
            if (r2 == 0) goto L31
            if (r2 != r3) goto L29
            kotlinx.coroutines.channels.ChannelIterator r4 = r0.f4352a
    ...
    public static final void o(y yVar, String value) {
        ...
        List listP0 = kotlin.text.r.y(value) ? u.f3804a : value.equals("/") ? z.f4883a : kotlin.collections.m.p0(kotlin.text.i.Q(value, new char[]{ClassPathElement.SEPARATOR_CHAR}));
