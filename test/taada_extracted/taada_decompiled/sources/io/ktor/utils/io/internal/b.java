...
public final class b implements Continuation {
    ...
    public static final /* synthetic */ AtomicReferenceFieldUpdater f3581a = AtomicReferenceFieldUpdater.newUpdater(b.class, Object.class, "state");
    ...
    public static final void a(b bVar, Job job, Throwable th) {
        while (true) {
            ...
            if (obj instanceof Continuation) {
                ...
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f3581a;
    ...
    public final Object c(Continuation continuation) throws Throwable {
        while (true) {
            ...
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f3581a;
            ...
            if ((aVar != null ? aVar.f3580a : null) != job) {
                if (job == null) {
                    ...
                    while (true) {
                        ...
                        a aVar4 = (a) obj2;
                        if (aVar4 != null && aVar4.f3580a == job) {
                            aVar3.a();
                            break;
                        }
