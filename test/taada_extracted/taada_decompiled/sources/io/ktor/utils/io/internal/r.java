...
public final class r {
    ...
    public final void a(int i) {
        ...
        do {
            ...
            i4 = i3 + i;
            if (i4 > this.f3590a) {
                throw new IllegalArgumentException("Completed read overflow: " + i3 + " + " + i + " = " + i4 + " > " + this.f3590a);
            }
    ...
    public final void b(int i) {
        ...
        do {
            ...
            i4 = i3 + i;
            if (i4 > this.f3590a) {
                throw new IllegalArgumentException("Complete write overflow: " + i3 + " + " + i + " > " + this.f3590a);
            }
    ...
    public final void e() {
        this._availableForRead$internal = this.f3590a;
    ...
    public final void f() {
        ...
        this._pendingToFlush = 0;
        this._availableForWrite$internal = this.f3590a;
    }
    ...
    public final boolean g() {
        ...
        do {
            ...
            if (this._pendingToFlush > 0 || this._availableForRead$internal > 0 || i != this.f3590a) {
                return false;
            }
    ...
    public final String toString() {
        return "RingBufferCapacity[read: " + this._availableForRead$internal + ", write: " + this._availableForWrite$internal + ", flush: " + this._pendingToFlush + ", capacity: " + this.f3590a + ']';
    }
}
