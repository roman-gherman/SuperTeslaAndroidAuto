        ...
        switch (this.f3524a) {
                ...
                while (true) {
                    ...
                    if (((U) this.b).k0(i)) {
                        ...
                        while (((Continuation) u._writeOp) == null) {
                            ...
                            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = U.f3536n;
                            ...
                            if (!u2.k0(i)) {
                                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = U.f3536n;
            ...
            default:
                ...
                if (it.get(it.position()) == 10) {
                    ...
                    ((kotlin.jvm.internal.s) this.b).f3813a = true;
                }
                return N1.m.f1129a;
        }
    }
