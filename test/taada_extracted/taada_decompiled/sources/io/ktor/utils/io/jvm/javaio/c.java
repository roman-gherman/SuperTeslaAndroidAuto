...
public abstract class c {
    ...
    public static final /* synthetic */ AtomicReferenceFieldUpdater f3596f = AtomicReferenceFieldUpdater.newUpdater(c.class, Object.class, "state");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Job f3597a;
    public final b b;
    ...
    public final int c(Object jobToken) throws Throwable {
        ...
        while (true) {
            ...
            if (this.state == thread) {
                ...
                if (parking == f.c) {
                    ((Logger) e.f3599a.getValue()).warn("Blocking network thread detected. \nIt can possible lead to a performance decline or even a deadlock.\nPlease make sure you're using blocking IO primitives like InputStream and OutputStream only in \nthe context of Dispatchers.IO:\n```\nwithContext(Dispatchers.IO) {\n    myInputStream.read()\n}\n```");
                }
                while (true) {
                    K k6 = (K) u0.f4145a.get();
                    long jD = k6 != null ? k6.d() : LocationRequestCompat.PASSIVE_INTERVAL;
                    if (this.state != thread) {
                        break;
                    }
                    if (jD > 0) {
                        Parking parking2 = (Parking) l.f3607a.get();
                        if (parking2 == null) {
                            parking2 = fVar;
                        }
                        parking2.park(jD);
