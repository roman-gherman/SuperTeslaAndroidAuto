...
public abstract class Z {
    ...
    public static C0946f c(C0946f c0946f, ClassOrPackageFragmentDescriptor classOrPackageFragmentDescriptor, JavaClass javaClass, int i) {
        ...
        return new C0946f(c0946f.f5203a, javaClass != null ? new Y0.b(c0946f, classOrPackageFragmentDescriptor, javaClass, 0) : c0946f.b, AbstractC0132a.N(3, new A2.y(15, c0946f, classOrPackageFragmentDescriptor)));
    }
    ...
    */
    ...
    public static final C0946f g(C0946f c0946f, Annotations additionalAnnotations) {
        ...
        return new C0946f(c0946f.f5203a, c0946f.b, AbstractC0132a.N(3, new A2.y(16, c0946f, additionalAnnotations)));
    }
    ...
    public static w4.n k(w4.i iVar) {
        ...
        iVar.f5090h.doFinal(bArr, 0);
        iVar.f5090h = null;
        w4.f fVar = (w4.f) a6.b;
        int i = fVar.b;
        int i3 = fVar.d;
        byte[] bArr2 = new byte[i3 * i];
        Digest digestF = io.ktor.utils.io.jvm.javaio.q.f(i, fVar.f5084f);
        ...
        try {
            ...
            return new w4.n(iVar.b.f1800a, new w4.h(fVar, iVar.f5087a, bArr2), iVar.c, iVar.d);
        } catch (Exception e) {
    ...
    public static final A2.N m(ClassDescriptor classDescriptor) {
        ...
        while (true) {
            ...
            if (!k2.i.w(next)) {
                ...
                if (N2.f.n(declarationDescriptor, EnumC0711c.f4228a) || N2.f.n(declarationDescriptor, EnumC0711c.c)) {
                    break;
                }
            }
        }
    ...
    public static final boolean o(ClassDescriptor classDescriptor) {
        LinkedHashSet linkedHashSet = C0584c.f3703a;
        if (!N2.f.l(classDescriptor)) {
            return false;
        }
        LinkedHashSet linkedHashSet2 = C0584c.f3703a;
    ...
    public static final void t(C0850a c0850a, LookupLocation lookupLocation, ClassDescriptor scopeOwner, L2.f fVar) {
        ...
        if (c0850a == C0850a.f4932a || (location = lookupLocation.getLocation()) == null) {
            return;
        }
        C0852c c0852c = C0852c.f4937a;
    ...
    public static final void u(C0850a c0850a, LookupLocation lookupLocation, PackageFragmentDescriptor scopeOwner, L2.f fVar) {
        ...
        c0850a.record(location.getFilePath(), C0852c.f4937a, strB, EnumC0853d.f4938a, strB2);
    }
    ...
    public static boolean w(w4.m mVar, w4.i iVar) {
        w4.n nVar = iVar.f5088f;
        w4.p pVar = nVar.c;
        int i = pVar.c;
        w4.g gVar = iVar.e;
        w4.f fVar = gVar.f5085a;
