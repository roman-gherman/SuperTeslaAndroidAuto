...
public abstract class G extends U2.n {
    ...
    public G(C0946f c, r rVar) {
        ...
        this.c = nVar.createRecursionTolerantLazyValue(new C(this, 0), kotlin.collections.u.f3804a);
    ...
    public static B n(C0946f c0946f, q2.v vVar, List jValueParameters) {
        ...
        while (true) {
            ...
            arrayList.add(new S(vVar, null, i, c0944dZ, name, abstractC0162z, false, false, false, abstractC0162z2, c0941a.f5187j.source(javaValueParameter)));
            z6 = false;
        }
    }
    ...
    public Collection getContributedFunctions(L2.f name, LookupLocation location) {
        ...
        return !getFunctionNames().contains(name) ? kotlin.collections.u.f3804a : (Collection) this.f13g.invoke(name);
    }
    ...
    public Collection getContributedVariables(L2.f name, LookupLocation location) {
        kotlin.jvm.internal.h.f(name, "name");
        kotlin.jvm.internal.h.f(location, "location");
        return !getVariableNames().contains(name) ? kotlin.collections.u.f3804a : (Collection) this.f16k.invoke(name);
    }
    ...
    public final y2.e m(JavaMethod method) {
        ...
        y2.e eVarV = y2.e.v(j(), b0.z(c0946f, method), method.getName(), c0946f.f5203a.f5187j.source(method), ((DeclaredMemberIndex) this.d.invoke()).findRecordComponentByName(method.getName()) != null && method.getValueParameters().isEmpty());
        kotlin.jvm.internal.h.f(c0946f, "<this>");
        C0946f c0946f2 = new C0946f(c0946f.f5203a, new Y0.b(c0946f, eVarV, method, 0), c0946f.c);
        ...
        eVarV.u(wVarK, i(), kotlin.collections.u.f3804a, aL.d, aL.c, aL.f4a, method.isAbstract() ? EnumC0719k.d : !method.isFinal() ? EnumC0719k.c : EnumC0719k.f4247a, w2.O.a(method.getVisibility()), abstractC0162z != null ? kotlin.collections.B.G(new N1.e(y2.e.f5138G, kotlin.collections.m.P(list))) : kotlin.collections.v.f3805a);
        eVarV.w(false, bN.b);
        List<String> list2 = aL.e;
        if (!list2.isEmpty()) {
            c0946f2.f5203a.e.reportSignatureErrors(eVarV, list2);
        }
        return eVarV;
    }
