...
public final class s extends kotlin.jvm.internal.i implements Function0 {
    ...
    public final Object invoke() {
        switch (this.f65a) {
            case 0:
                t tVar = this.b;
                List<String> listFindPackageParts = tVar.f68h.f5203a.f5189l.findPackageParts(tVar.e.b());
                ArrayList arrayList = new ArrayList();
                for (String str : listFindPackageParts) {
                    KotlinJvmBinaryClass kotlinJvmBinaryClassU = AbstractC0132a.u(tVar.f68h.f5203a.c, L2.b.j(new L2.c(S2.a.d(str).f1283a.replace(ClassPathElement.SEPARATOR_CHAR, TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH))), tVar.i);
