                ...
                while (true) {
                    ...
                    if (!zHasNext) {
                        ...
                        if (zIsRecord) {
                            ...
                            C0931a c0931aV = C0931a.v(classDescriptor2, eVar3, true, c0946f3.f5203a.f5187j.source(javaClass));
                            ...
                            for (JavaRecordComponent javaRecordComponent : recordComponents) {
                                ...
                                C0941a c0941a = c0946f3.f5203a;
                                AbstractC0162z abstractC0162zF = zIsVararg ? c0941a.f5192o.d.f(abstractC0162zS) : null;
                                Annotations.Companion.getClass();
                                L2.f name = javaRecordComponent.getName();
                                JavaSourceElement javaSourceElementSource = c0941a.f5187j.source(javaRecordComponent);
                            ...
                            if (arrayList2.isEmpty()) {
                                ...
                                c0946f.f5203a.f5185g.recordConstructor(javaClass, c0773j);
                            } else {
                        ...
                        c0946f.f5203a.x.generateConstructors(c0946f, classDescriptor2, arrayList2);
                        ...
                        if (arrayList2.isEmpty()) {
                            ...
                            if ((javaClass.isInterface() || !javaClass.hasDefaultConstructor()) && !zIsAnnotationType) {
                                ...
                                Annotations.Companion.getClass();
                                ?? V5 = C0931a.v(classDescriptor2, eVar, z6, c0946f3.f5203a.f5187j.source(javaClass));
                                ...
                                c0946f3.f5203a.f5185g.recordConstructor(javaClass, V5);
                                r13 = V5;
                            }
                        ...
                        return kotlin.collections.m.o0(c0941a2.f5194r.c(c0946f2, listZ));
                    }
                    JavaConstructor next = it.next();
                    C0944d c0944dZ = b0.z(c0946f3, next);
                    C0941a c0941a3 = c0946f3.f5203a;
                    C0931a c0931aV2 = C0931a.v(classDescriptor2, c0944dZ, false, c0941a3.f5187j.source(next));
                    ...
                    c0946f7.f5203a.f5185g.recordConstructor(next, c0931aV2);
                    arrayList2.add(c0931aV2);
                }
                break;
            default:
                C0946f c0946f8 = this.b;
                return kotlin.collections.m.s0(c0946f8.f5203a.x.getNestedClassNames(c0946f8, this.c.f58m));
        }
    }
