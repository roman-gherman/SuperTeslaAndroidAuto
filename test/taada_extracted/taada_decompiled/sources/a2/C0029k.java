...
public final class C0029k extends AbstractC0774k implements JavaClassDescriptor {
    ...
    public C0029k(C0946f outerContext, DeclarationDescriptor containingDeclaration, JavaClass jClass, ClassDescriptor classDescriptor) {
        ...
        C0941a c0941a = outerContext.f5203a;
        super(c0941a.f5183a, containingDeclaration, jClass.getName(), c0941a.f5187j.source(jClass));
        this.f39g = outerContext;
        this.f40h = jClass;
        this.i = classDescriptor;
        C0946f c0946fC = Z.c(outerContext, this, jClass, 4);
        this.f41j = c0946fC;
        C0941a c0941a2 = c0946fC.f5203a;
        c0941a2.f5185g.recordClass(jClass, this);
        jClass.getLightClassOriginKind();
        this.f42k = AbstractC0132a.M(new C0026h(this, 2));
        this.f43l = jClass.isAnnotationType() ? EnumC0711c.e : jClass.isInterface() ? EnumC0711c.b : jClass.isEnum() ? EnumC0711c.c : EnumC0711c.f4228a;
        ...
        this.q = rVar;
        n2.v vVar = n2.t.e;
        Z2.n storageManager = c0941a2.f5183a;
        c0941a2.u.getClass();
    ...
    public final MemberScope b(b3.d dVar) {
        ...
        tVar.getClass();
        R2.e.j(tVar.f4258a);
        return (r) ((MemberScope) AbstractC0246d.T(tVar.d, n2.t.f4257f[0]));
    }
    ...
    public final AbstractC0714f getVisibility() {
        C0712d c0712d = AbstractC0713e.f4232a;
