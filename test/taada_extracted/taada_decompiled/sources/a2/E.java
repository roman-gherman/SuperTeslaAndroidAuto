...
public final class E extends kotlin.jvm.internal.i implements Function0 {
    ...
    public final Object invoke() {
        switch (this.f8a) {
            case 0:
                C0941a c0941a = this.b.f11a.f5203a;
                c0941a.f5186h.getInitializerConstant(this.c, this.d);
                return null;
            default:
                G g6 = this.b;
                return g6.f11a.f5203a.f5183a.createNullableLazyValue(new E(g6, this.c, this.d, 0));
        }
    }
}
