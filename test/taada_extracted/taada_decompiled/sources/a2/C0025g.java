            ...
            if (z6) {
                ...
                if (!kotlin.reflect.l.O(type)) {
                    ...
                    if (valueParameterDescriptorI == null || (abstractC0162zG = valueParameterDescriptorI.getType()) == null) {
                        abstractC0162zG = c0946f.f5203a.f5192o.d.g(c3.j.c(c3.i.UNKNOWN_ARRAY_ELEMENT_TYPE_OF_ANNOTATION_ARGUMENT, new String[0]));
                    }
                ...
                if (javaAnnotationArgument instanceof JavaClassObjectAnnotationArgument) {
                    ...
                    if (!kotlin.reflect.l.O(abstractC0162zS)) {
                        ...
                        if (declarationDescriptor instanceof TypeParameterDescriptor) {
                            return new P2.r(L2.b.j(k2.o.f3742a.g()), 0);
                        }
                    }
                }
            }
