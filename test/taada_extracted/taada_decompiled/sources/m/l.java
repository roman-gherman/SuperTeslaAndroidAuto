...
public final class l extends s {
    ...
    public final String toString() {
        return "LogEvent{eventTimeMs=" + this.f4008a + ", eventCode=" + this.b + ", eventUptimeMs=" + this.c + ", sourceExtension=" + Arrays.toString(this.d) + ", sourceExtensionJsonProto3=" + this.e + ", timezoneOffsetSeconds=" + this.f4009f + ", networkConnectionInfo=" + this.f4010g + "}";
    }
}
